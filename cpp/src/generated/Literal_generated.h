...
inline const LiteralImpl (&EnumValuesLiteralImpl())[24] {
...
template<> struct LiteralImplTraits<org::apache::arrow::computeir::flatbuf::ArrayLiteral> {
  static const LiteralImpl enum_value = LiteralImpl::ArrayLiteral;
};
...
inline flatbuffers::Offset<ArrayLiteral> CreateArrayLiteralDirect(
  ...
  return org::apache::arrow::computeir::flatbuf::CreateArrayLiteral(
      _fbb,
      values__);
}
...
struct Literal FLATBUFFERS_FINAL_CLASS : private flatbuffers::Table {
  ...
  const org::apache::arrow::computeir::flatbuf::ArrayLiteral *impl_as_ArrayLiteral() const {
    return impl_type() == org::apache::arrow::computeir::flatbuf::LiteralImpl::ArrayLiteral ? static_cast<const org::apache::arrow::computeir::flatbuf::ArrayLiteral *>(impl()) : nullptr;
  }
...
template<> inline const org::apache::arrow::computeir::flatbuf::ArrayLiteral *Literal::impl_as<org::apache::arrow::computeir::flatbuf::ArrayLiteral>() const {
  return impl_as_ArrayLiteral();
}
...
inline bool VerifyLiteralImpl(flatbuffers::Verifier &verifier, const void *obj, LiteralImpl type) {
  switch (type) {
    ...
    case LiteralImpl::ArrayLiteral: {
      auto ptr = reinterpret_cast<const org::apache::arrow::computeir::flatbuf::ArrayLiteral *>(obj);
      return verifier.VerifyTable(ptr);
    }
