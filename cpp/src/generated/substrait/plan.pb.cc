...
const ::PROTOBUF_NAMESPACE_ID::uint32 TableStruct_substrait_2fplan_2eproto::offsets[] PROTOBUF_SECTION_VARIABLE(protodesc_cold) = {
  ~0u,  // no _has_bits_
...
const ::PROTOBUF_NAMESPACE_ID::internal::DescriptorTable descriptor_table_substrait_2fplan_2eproto = {
  false, false, 524, descriptor_table_protodef_substrait_2fplan_2eproto, "substrait/plan.proto", 
