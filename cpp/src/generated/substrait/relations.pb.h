...
enum ReadRel_LocalFiles_FileOrFiles_FileFormat : int {
  ...
  ReadRel_LocalFiles_FileOrFiles_FileFormat_ReadRel_LocalFiles_FileOrFiles_FileFormat_INT_MIN_SENTINEL_DO_NOT_USE_ = std::numeric_limits<::PROTOBUF_NAMESPACE_ID::int32>::min(),
  ReadRel_LocalFiles_FileOrFiles_FileFormat_ReadRel_LocalFiles_FileOrFiles_FileFormat_INT_MAX_SENTINEL_DO_NOT_USE_ = std::numeric_limits<::PROTOBUF_NAMESPACE_ID::int32>::max()
};
...
constexpr JoinRel_JoinType JoinRel_JoinType_JoinType_MAX = JoinRel_JoinType_JOIN_TYPE_ANTI;
...
class RelCommon_Direct PROTOBUF_FINAL :
    public ::PROTOBUF_NAMESPACE_ID::Message /* @@protoc_insertion_point(class_definition:substrait.RelCommon.Direct) */ {
 public:
...
inline ::substrait::RelCommon_Hint_Stats* RelCommon_Hint::_internal_mutable_stats() {
  ...
  if (stats_ == nullptr) {
    auto* p = CreateMaybeMessage<::substrait::RelCommon_Hint_Stats>(GetArena());
    stats_ = p;
  }
  return stats_;
}
...
inline ::substrait::RelCommon_Hint_RuntimeConstraint* RelCommon_Hint::_internal_mutable_constraint() {
  ...
  if (constraint_ == nullptr) {
    auto* p = CreateMaybeMessage<::substrait::RelCommon_Hint_RuntimeConstraint>(GetArena());
    constraint_ = p;
  }
  return constraint_;
}
...
inline ::substrait::RelCommon_Direct* RelCommon::_internal_mutable_direct() {
  if (!_internal_has_direct()) {
    clear_emit_kind();
    set_has_direct();
    emit_kind_.direct_ = CreateMaybeMessage< ::substrait::RelCommon_Direct >(GetArena());
  }
...
inline ::substrait::RelCommon_Emit* RelCommon::_internal_mutable_emit() {
  if (!_internal_has_emit()) {
    clear_emit_kind();
    set_has_emit();
    emit_kind_.emit_ = CreateMaybeMessage< ::substrait::RelCommon_Emit >(GetArena());
  }
...
inline ::substrait::RelCommon_Hint* RelCommon::_internal_mutable_hint() {
  ...
  if (hint_ == nullptr) {
    auto* p = CreateMaybeMessage<::substrait::RelCommon_Hint>(GetArena());
    hint_ = p;
  }
  return hint_;
}
...
inline ::substrait::RelCommon* ReadRel::_internal_mutable_common() {
  ...
  if (common_ == nullptr) {
    auto* p = CreateMaybeMessage<::substrait::RelCommon>(GetArena());
    common_ = p;
  }
  return common_;
}
...
inline ::substrait::NamedStruct* ReadRel::_internal_mutable_base_schema() {
  ...
  if (base_schema_ == nullptr) {
    auto* p = CreateMaybeMessage<::substrait::NamedStruct>(GetArena());
    base_schema_ = p;
  }
  return base_schema_;
}
...
inline ::substrait::Expression_MaskExpression* ReadRel::_internal_mutable_projection() {
  ...
  if (projection_ == nullptr) {
    auto* p = CreateMaybeMessage<::substrait::Expression_MaskExpression>(GetArena());
    projection_ = p;
  }
  return projection_;
}
...
inline ::substrait::ReadRel_VirtualTable* ReadRel::_internal_mutable_virtual_table() {
  if (!_internal_has_virtual_table()) {
    clear_read_type();
    set_has_virtual_table();
    read_type_.virtual_table_ = CreateMaybeMessage< ::substrait::ReadRel_VirtualTable >(GetArena());
  }
...
inline ::substrait::ReadRel_LocalFiles* ReadRel::_internal_mutable_local_files() {
  if (!_internal_has_local_files()) {
    clear_read_type();
    set_has_local_files();
    read_type_.local_files_ = CreateMaybeMessage< ::substrait::ReadRel_LocalFiles >(GetArena());
  }
...
inline ::substrait::ReadRel_NamedTable* ReadRel::_internal_mutable_named_table() {
  if (!_internal_has_named_table()) {
    clear_read_type();
    set_has_named_table();
    read_type_.named_table_ = CreateMaybeMessage< ::substrait::ReadRel_NamedTable >(GetArena());
  }
...
inline ::substrait::ReadRel_ExtensionTable* ReadRel::_internal_mutable_extension_table() {
  if (!_internal_has_extension_table()) {
    clear_read_type();
    set_has_extension_table();
    read_type_.extension_table_ = CreateMaybeMessage< ::substrait::ReadRel_ExtensionTable >(GetArena());
  }
...
inline ::substrait::AggregateFunction* AggregateRel_Measure::_internal_mutable_measure() {
  ...
  if (measure_ == nullptr) {
    auto* p = CreateMaybeMessage<::substrait::AggregateFunction>(GetArena());
    measure_ = p;
  }
  return measure_;
}
...
inline ::substrait::ReadRel* Rel::_internal_mutable_read() {
  if (!_internal_has_read()) {
    clear_rel_type();
    set_has_read();
    rel_type_.read_ = CreateMaybeMessage< ::substrait::ReadRel >(GetArena());
  }
...
inline ::substrait::FilterRel* Rel::_internal_mutable_filter() {
  if (!_internal_has_filter()) {
    clear_rel_type();
    set_has_filter();
    rel_type_.filter_ = CreateMaybeMessage< ::substrait::FilterRel >(GetArena());
  }
...
inline ::substrait::AggregateRel* Rel::_internal_mutable_aggregate() {
  if (!_internal_has_aggregate()) {
    clear_rel_type();
    set_has_aggregate();
    rel_type_.aggregate_ = CreateMaybeMessage< ::substrait::AggregateRel >(GetArena());
  }
...
inline ::substrait::SortRel* Rel::_internal_mutable_sort() {
  if (!_internal_has_sort()) {
    clear_rel_type();
    set_has_sort();
    rel_type_.sort_ = CreateMaybeMessage< ::substrait::SortRel >(GetArena());
  }
...
inline ::substrait::JoinRel* Rel::_internal_mutable_join() {
  if (!_internal_has_join()) {
    clear_rel_type();
    set_has_join();
    rel_type_.join_ = CreateMaybeMessage< ::substrait::JoinRel >(GetArena());
  }
...
inline ::substrait::ProjectRel* Rel::_internal_mutable_project() {
  if (!_internal_has_project()) {
    clear_rel_type();
    set_has_project();
    rel_type_.project_ = CreateMaybeMessage< ::substrait::ProjectRel >(GetArena());
  }
...
inline ::substrait::SetRel* Rel::_internal_mutable_set() {
  if (!_internal_has_set()) {
    clear_rel_type();
    set_has_set();
    rel_type_.set_ = CreateMaybeMessage< ::substrait::SetRel >(GetArena());
  }
...
inline ::substrait::ExtensionSingleRel* Rel::_internal_mutable_extension_single() {
  if (!_internal_has_extension_single()) {
    clear_rel_type();
    set_has_extension_single();
    rel_type_.extension_single_ = CreateMaybeMessage< ::substrait::ExtensionSingleRel >(GetArena());
  }
...
inline ::substrait::ExtensionLeafRel* Rel::_internal_mutable_extension_leaf() {
  if (!_internal_has_extension_leaf()) {
    clear_rel_type();
    set_has_extension_leaf();
    rel_type_.extension_leaf_ = CreateMaybeMessage< ::substrait::ExtensionLeafRel >(GetArena());
  }
