        ...
        if (ftype == ::apache::thrift::protocol::T_LIST) {
          {
            ...
            this->path_in_schema.resize(_size249);
            uint32_t _i253;
            for (_i253 = 0; _i253 < _size249; ++_i253)
            {
              xfer += iprot->readString(this->path_in_schema[_i253]);
            }
            xfer += iprot->readListEnd();
          }
          isset_path_in_schema = true;
...
uint32_t EncryptionWithColumnKey::write(Protocol_* oprot) const {
  ...
  xfer += oprot->writeFieldBegin("path_in_schema", ::apache::thrift::protocol::T_LIST, 1);
  {
    ...
    for (_iter254 = this->path_in_schema.begin(); _iter254 != this->path_in_schema.end(); ++_iter254)
    {
  ...
  if (this->__isset.encryption_algorithm) {
    xfer += oprot->writeFieldBegin("encryption_algorithm", ::apache::thrift::protocol::T_STRUCT, 3);
        ...
        if (ftype == ::apache::thrift::protocol::T_LIST) {
          {
            ...
            this->columns.resize(_size267);
            uint32_t _i271;
            for (_i271 = 0; _i271 < _size267; ++_i271)
            {
              xfer += this->columns[_i271].read(iprot);
            }
            xfer += iprot->readListEnd();
          }
          isset_columns = true;
        ...
        if (ftype == ::apache::thrift::protocol::T_LIST) {
          {
            ...
            this->sorting_columns.resize(_size272);
            uint32_t _i276;
            for (_i276 = 0; _i276 < _size272; ++_i276)
            {
              xfer += this->sorting_columns[_i276].read(iprot);
            }
            xfer += iprot->readListEnd();
          }
...
uint32_t RowGroup::write(Protocol_* oprot) const {
  ...
  xfer += oprot->writeFieldBegin("columns", ::apache::thrift::protocol::T_LIST, 1);
  {
    ...
    std::vector<ColumnChunk> ::const_iterator _iter277;
    for (_iter277 = this->columns.begin(); _iter277 != this->columns.end(); ++_iter277)
    {
  ...
  if (this->__isset.sorting_columns) {
    xfer += oprot->writeFieldBegin("sorting_columns", ::apache::thrift::protocol::T_LIST, 4);
    {
      ...
      std::vector<SortingColumn> ::const_iterator _iter278;
      for (_iter278 = this->sorting_columns.begin(); _iter278 != this->sorting_columns.end(); ++_iter278)
      {
        ...
        if (ftype == ::apache::thrift::protocol::T_LIST) {
          {
            ...
            this->page_locations.resize(_size295);
            uint32_t _i299;
            for (_i299 = 0; _i299 < _size295; ++_i299)
            {
              xfer += this->page_locations[_i299].read(iprot);
            }
            xfer += iprot->readListEnd();
          }
        ...
        if (ftype == ::apache::thrift::protocol::T_LIST) {
          {
            ...
            this->unencoded_byte_array_data_bytes.resize(_size300);
            uint32_t _i304;
            for (_i304 = 0; _i304 < _size300; ++_i304)
            {
              xfer += iprot->readI64(this->unencoded_byte_array_data_bytes[_i304]);
            }
            xfer += iprot->readListEnd();
          }
          this->__isset.unencoded_byte_array_data_bytes = true;
...
uint32_t OffsetIndex::write(Protocol_* oprot) const {
  ...
  xfer += oprot->writeFieldBegin("page_locations", ::apache::thrift::protocol::T_LIST, 1);
  {
    ...
    std::vector<PageLocation> ::const_iterator _iter305;
    for (_iter305 = this->page_locations.begin(); _iter305 != this->page_locations.end(); ++_iter305)
    {
  ...
  if (this->__isset.unencoded_byte_array_data_bytes) {
    xfer += oprot->writeFieldBegin("unencoded_byte_array_data_bytes", ::apache::thrift::protocol::T_LIST, 2);
    {
      ...
      for (_iter306 = this->unencoded_byte_array_data_bytes.begin(); _iter306 != this->unencoded_byte_array_data_bytes.end(); ++_iter306)
      {
    ...
    switch (fid)
    {
        ...
        if (ftype == ::apache::thrift::protocol::T_LIST) {
          {
            ...
            this->null_pages.resize(_size311);
            uint32_t _i315;
            for (_i315 = 0; _i315 < _size311; ++_i315)
            {
              xfer += iprot->readBool(this->null_pages[_i315]);
            }
            xfer += iprot->readListEnd();
          }
        ...
        if (ftype == ::apache::thrift::protocol::T_LIST) {
          {
            ...
            this->min_values.resize(_size316);
            uint32_t _i320;
            for (_i320 = 0; _i320 < _size316; ++_i320)
            {
              xfer += iprot->readBinary(this->min_values[_i320]);
            }
            xfer += iprot->readListEnd();
          }
        ...
        if (ftype == ::apache::thrift::protocol::T_LIST) {
          {
            ...
            this->max_values.resize(_size321);
            uint32_t _i325;
            for (_i325 = 0; _i325 < _size321; ++_i325)
            {
              xfer += iprot->readBinary(this->max_values[_i325]);
            }
            xfer += iprot->readListEnd();
          }
      ...
      case 4:
        if (ftype == ::apache::thrift::protocol::T_I32) {
          ...
          this->boundary_order = static_cast<BoundaryOrder::type>(ecast326);
        ...
        if (ftype == ::apache::thrift::protocol::T_LIST) {
          {
            ...
            this->null_counts.resize(_size327);
            uint32_t _i331;
            for (_i331 = 0; _i331 < _size327; ++_i331)
            {
              xfer += iprot->readI64(this->null_counts[_i331]);
            }
            xfer += iprot->readListEnd();
          }
        ...
        if (ftype == ::apache::thrift::protocol::T_LIST) {
          {
            ...
            this->repetition_level_histograms.resize(_size332);
            uint32_t _i336;
            for (_i336 = 0; _i336 < _size332; ++_i336)
            {
              xfer += iprot->readI64(this->repetition_level_histograms[_i336]);
            }
            xfer += iprot->readListEnd();
          }
        ...
        if (ftype == ::apache::thrift::protocol::T_LIST) {
          {
            ...
            this->definition_level_histograms.resize(_size337);
            uint32_t _i341;
            for (_i341 = 0; _i341 < _size337; ++_i341)
            {
              xfer += iprot->readI64(this->definition_level_histograms[_i341]);
            }
            xfer += iprot->readListEnd();
          }
...
uint32_t ColumnIndex::write(Protocol_* oprot) const {
  ...
  xfer += oprot->writeFieldBegin("null_pages", ::apache::thrift::protocol::T_LIST, 1);
  {
    ...
    std::vector<bool> ::const_iterator _iter342;
    for (_iter342 = this->null_pages.begin(); _iter342 != this->null_pages.end(); ++_iter342)
    {
      xfer += oprot->writeBool((*_iter342));
    }
    xfer += oprot->writeListEnd();
  }
  xfer += oprot->writeFieldEnd();
  ...
  xfer += oprot->writeFieldBegin("min_values", ::apache::thrift::protocol::T_LIST, 2);
  {
    ...
    for (_iter343 = this->min_values.begin(); _iter343 != this->min_values.end(); ++_iter343)
    {
      xfer += oprot->writeBinary((*_iter343));
    }
    xfer += oprot->writeListEnd();
  }
  xfer += oprot->writeFieldEnd();
  ...
  xfer += oprot->writeFieldBegin("max_values", ::apache::thrift::protocol::T_LIST, 3);
  {
    ...
    for (_iter344 = this->max_values.begin(); _iter344 != this->max_values.end(); ++_iter344)
    {
  ...
  if (this->__isset.null_counts) {
    xfer += oprot->writeFieldBegin("null_counts", ::apache::thrift::protocol::T_LIST, 5);
    {
      ...
      for (_iter345 = this->null_counts.begin(); _iter345 != this->null_counts.end(); ++_iter345)
      {
  ...
  if (this->__isset.repetition_level_histograms) {
    xfer += oprot->writeFieldBegin("repetition_level_histograms", ::apache::thrift::protocol::T_LIST, 6);
    {
      ...
      for (_iter346 = this->repetition_level_histograms.begin(); _iter346 != this->repetition_level_histograms.end(); ++_iter346)
      {
  ...
  if (this->__isset.definition_level_histograms) {
    xfer += oprot->writeFieldBegin("definition_level_histograms", ::apache::thrift::protocol::T_LIST, 7);
    {
      ...
      for (_iter347 = this->definition_level_histograms.begin(); _iter347 != this->definition_level_histograms.end(); ++_iter347)
      {
