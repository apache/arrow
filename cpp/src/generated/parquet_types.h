...
extern const std::map<int, const char*> _Edges_VALUES_TO_NAMES;
...
class GeometryStatistics {
 public:
  ...
  GeometryStatistics(const GeometryStatistics&);
  GeometryStatistics(GeometryStatistics&&) noexcept;
  GeometryStatistics& operator=(const GeometryStatistics&);
  GeometryStatistics& operator=(GeometryStatistics&&) noexcept;
  GeometryStatistics() noexcept {
  }

  virtual ~GeometryStatistics() noexcept;
  /**
  ...
  _GeometryStatistics__isset __isset;
  ...
  bool operator == (const GeometryStatistics & rhs) const
  {
    ...
    if (__isset.geometry_types != rhs.__isset.geometry_types)
      return false;
    else if (__isset.geometry_types && !(geometry_types == rhs.geometry_types))
      return false;
    return true;
  }
  bool operator != (const GeometryStatistics &rhs) const {
  ...
  bool operator < (const GeometryStatistics & ) const;
...
typedef struct _Statistics__isset {
  _Statistics__isset() : max(false), min(false), null_count(false), distinct_count(false), max_value(false), min_value(false), is_max_value_exact(false), is_min_value_exact(false), geometry_stats(false) {}
  bool max :1;
  bool min :1;
  bool null_count :1;
...
class Statistics {
 public:
  ...
  void __set_geometry_stats(const GeometryStatistics& val);
  ...
  bool operator == (const Statistics & rhs) const
  {
    ...
    if (__isset.is_min_value_exact != rhs.__isset.is_min_value_exact)
      ...
      return false;
    if (__isset.geometry_stats != rhs.__isset.geometry_stats)
      return false;
    else if (__isset.geometry_stats && !(geometry_stats == rhs.geometry_stats))
      return false;
    return true;
  }
  bool operator != (const Statistics &rhs) const {
...
class GeometryType {
 public:
  ...
  void __set_encoding(const GeometryEncoding::type val);
...
typedef struct _LogicalType__isset {
  _LogicalType__isset() : STRING(false), MAP(false), LIST(false), ENUM(false), DECIMAL(false), DATE(false), TIME(false), TIMESTAMP(false), INTEGER(false), UNKNOWN(false), JSON(false), BSON(false), UUID(false), FLOAT16(false), GEOMETRY(false) {}
  bool STRING :1;
  bool MAP :1;
  bool LIST :1;
  bool ENUM :1;
...
typedef struct _ColumnIndex__isset {
  _ColumnIndex__isset() : null_counts(false), repetition_level_histograms(false), definition_level_histograms(false), geometry_stats(false) {}
  bool null_counts :1;
...
class ColumnIndex {
 public:
   ...
   */
  std::vector<GeometryStatistics>  geometry_stats;
  ...
  void __set_geometry_stats(const std::vector<GeometryStatistics> & val);
