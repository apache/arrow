...
#ifndef FLATBUFFERS_GENERATED_EXAMPLEEXTENSIONS_ORG_APACHE_ARROW_COMPUTEIR_FLATBUF_EXT_H_
#define FLATBUFFERS_GENERATED_EXAMPLEEXTENSIONS_ORG_APACHE_ARROW_COMPUTEIR_FLATBUF_EXT_H_
...
inline flatbuffers::Offset<Uri> CreateUriDirect(
  ...
  return org::apache::arrow::computeir::flatbuf::ext::CreateUri(
      _fbb,
      schema__,
      userinfo__,
      host__,
...
inline flatbuffers::Offset<Sql_FromOptions> CreateSql_FromOptionsDirect(
  ...
  return org::apache::arrow::computeir::flatbuf::ext::CreateSql_FromOptions(
      _fbb,
      name__);
}
...
inline flatbuffers::Offset<Partitioning> CreatePartitioningDirect(
  ...
  return org::apache::arrow::computeir::flatbuf::ext::CreatePartitioning(
      _fbb,
      flavor__,
      schema);
}
...
inline flatbuffers::Offset<FileFormat> CreateFileFormatDirect(
    ...
    const org::apache::arrow::flatbuf::Buffer *options = 0) {
  auto name__ = name ? _fbb.CreateString(name) : 0;
  return org::apache::arrow::computeir::flatbuf::ext::CreateFileFormat(
      _fbb,
      name__,
      options);
}
...
struct Arrow_FileSystemDatasetScanOptions FLATBUFFERS_FINAL_CLASS : private flatbuffers::Table {
  ...
  /// remote file systems.
  const org::apache::arrow::computeir::flatbuf::ext::Uri *base_dir() const {
    return GetPointer<const org::apache::arrow::computeir::flatbuf::ext::Uri *>(VT_BASE_DIR);
  }
  /// The format of files in this dataset.
  const org::apache::arrow::computeir::flatbuf::ext::FileFormat *format() const {
    return GetPointer<const org::apache::arrow::computeir::flatbuf::ext::FileFormat *>(VT_FORMAT);
  }
  /// A partitioning scheme in use in this dataset.
  const org::apache::arrow::computeir::flatbuf::ext::Partitioning *partitioning() const {
    return GetPointer<const org::apache::arrow::computeir::flatbuf::ext::Partitioning *>(VT_PARTITIONING);
  }
  bool Verify(flatbuffers::Verifier &verifier) const {
    return VerifyTableStart(verifier) &&
...
struct Arrow_FileSystemDatasetScanOptionsBuilder {
  ...
  flatbuffers::FlatBufferBuilder &fbb_;
  flatbuffers::uoffset_t start_;
  void add_base_dir(flatbuffers::Offset<org::apache::arrow::computeir::flatbuf::ext::Uri> base_dir) {
    fbb_.AddOffset(Arrow_FileSystemDatasetScanOptions::VT_BASE_DIR, base_dir);
  }
  void add_format(flatbuffers::Offset<org::apache::arrow::computeir::flatbuf::ext::FileFormat> format) {
    fbb_.AddOffset(Arrow_FileSystemDatasetScanOptions::VT_FORMAT, format);
  }
  void add_partitioning(flatbuffers::Offset<org::apache::arrow::computeir::flatbuf::ext::Partitioning> partitioning) {
...
inline flatbuffers::Offset<Arrow_FileSystemDatasetScanOptions> CreateArrow_FileSystemDatasetScanOptions(
    flatbuffers::FlatBufferBuilder &_fbb,
    flatbuffers::Offset<org::apache::arrow::computeir::flatbuf::ext::Uri> base_dir = 0,
    flatbuffers::Offset<org::apache::arrow::computeir::flatbuf::ext::FileFormat> format = 0,
    flatbuffers::Offset<org::apache::arrow::computeir::flatbuf::ext::Partitioning> partitioning = 0) {
...
inline flatbuffers::Offset<Sql_IntoOptions> CreateSql_IntoOptionsDirect(
    ...
    bool append = true) {
  auto name__ = name ? _fbb.CreateString(name) : 0;
  return org::apache::arrow::computeir::flatbuf::ext::CreateSql_IntoOptions(
      _fbb,
      name__,
      append);
}
...
struct Arrow_StreamOutOptions FLATBUFFERS_FINAL_CLASS : private flatbuffers::Table {
  ...
  const org::apache::arrow::computeir::flatbuf::ext::Uri *destination() const {
    return GetPointer<const org::apache::arrow::computeir::flatbuf::ext::Uri *>(VT_DESTINATION);
  }
  bool Verify(flatbuffers::Verifier &verifier) const {
    return VerifyTableStart(verifier) &&
...
struct Arrow_StreamOutOptionsBuilder {
  ...
  flatbuffers::FlatBufferBuilder &fbb_;
  flatbuffers::uoffset_t start_;
  void add_destination(flatbuffers::Offset<org::apache::arrow::computeir::flatbuf::ext::Uri> destination) {
...
inline flatbuffers::Offset<Arrow_StreamOutOptions> CreateArrow_StreamOutOptions(
    flatbuffers::FlatBufferBuilder &_fbb,
    flatbuffers::Offset<org::apache::arrow::computeir::flatbuf::ext::Uri> destination = 0) {
...
inline flatbuffers::Offset<Arrow_FileSystemDatasetWriteOptions> CreateArrow_FileSystemDatasetWriteOptionsDirect(
  ...
  return org::apache::arrow::computeir::flatbuf::ext::CreateArrow_FileSystemDatasetWriteOptions(
      _fbb,
      base_dir,
      format,
      partitioning,
...
#endif  // FLATBUFFERS_GENERATED_EXAMPLEEXTENSIONS_ORG_APACHE_ARROW_COMPUTEIR_FLATBUF_EXT_H_
