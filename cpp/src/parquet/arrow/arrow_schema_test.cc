...
TEST_F(TestConvertParquetSchema, ParquetAnnotatedFields) {
  ...
  std::vector<FieldConstructionArguments> cases = {
      ...
      {"decimal128(8, 2)", LogicalType::Decimal(8, 2), ParquetType::INT32, -1,
       ::arrow::decimal128(8, 2)},
      {"decimal128(16, 4)", LogicalType::Decimal(16, 4), ParquetType::INT64, -1,
       ::arrow::decimal128(16, 4)},
      {"decimal128(32, 8)", LogicalType::Decimal(32, 8),
       ParquetType::FIXED_LEN_BYTE_ARRAY, 16, ::arrow::decimal128(32, 8)},
...
TEST_F(TestConvertArrowSchema, ArrowFields) {
  ...
  std::vector<FieldConstructionArguments> cases = {
      ...
      {"large_utf8", ::arrow::large_utf8(), LogicalType::String(),
       ParquetType::BYTE_ARRAY, -1},
      {"decimal128(1, 0)", ::arrow::decimal128(1, 0), LogicalType::Decimal(1, 0),
       ParquetType::FIXED_LEN_BYTE_ARRAY, 1},
      {"decimal128(8, 2)", ::arrow::decimal128(8, 2), LogicalType::Decimal(8, 2),
       ParquetType::FIXED_LEN_BYTE_ARRAY, 4},
      {"decimal128(16, 4)", ::arrow::decimal128(16, 4), LogicalType::Decimal(16, 4),
       ParquetType::FIXED_LEN_BYTE_ARRAY, 7},
      {"decimal128(32, 8)", ::arrow::decimal128(32, 8), LogicalType::Decimal(32, 8),
