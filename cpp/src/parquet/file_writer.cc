 ...
 public:
  ...
  ColumnWriter* NextColumn() override {
    ...
    std::unique_ptr<PageWriter> pager = PageWriter::Open(
        ...
        meta_encryptor, data_encryptor, properties_->data_page_checksum_enabled());
  ...
  void InitColumns() {
    for (int i = 0; i < num_columns(); i++) {
      ...
      std::unique_ptr<PageWriter> pager = PageWriter::Open(
          ...
          buffered_row_group_, meta_encryptor,
          data_encryptor, properties_->data_page_checksum_enabled());
