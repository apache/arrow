 ...
 public:
  class PARQUET_EXPORT Builder {
   public:
    ...
    // Wrap keys locally - master keys are fetched from the KMS server and used to encrypt
    // other keys (DEKs or KEKs).
    ...
    // separate files in the same folder, which enables key rotation for immutable Parquet
    // files.
    Builder* internal_key_material(bool internal_key_material);

    // Length of data encryption keys (DEKs), randomly generated by parquet key management
    // tools. Can be 128, 192 or 256 bits.
