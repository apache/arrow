...
struct PARQUET_EXPORT ExternalEncryptionConfiguration {
  ...
  // === New fields for external configuration ===

  /// KMS host to connect to
  std::string host;

  /// Path to the trusted certificate authority
  std::string certificate_authority_location;

  /// Path to the client certificate for mutual TLS
  std::string client_certificate_location;

  /// Path to the client private key
  std::string client_key_location;

  /// Max number of pooled KMS connections
  int32_t connection_pool_size = 10;
