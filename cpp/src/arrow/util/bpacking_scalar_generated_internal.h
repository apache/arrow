...
inline const uint8_t* unpack1_32(const uint8_t* in, uint32_t* out){
  ...
  const auto w0 = bit_util::FromLittleEndian(util::SafeLoadAs<uint32_t>(in));
  in += 4;
  out[0] = (w0) & mask;
  out[1] = (w0 >> 1) & mask;
  out[2] = (w0 >> 2) & mask;
...
inline const uint8_t* unpack2_32(const uint8_t* in, uint32_t* out){
  ...
  const auto w0 = bit_util::FromLittleEndian(util::SafeLoadAs<uint32_t>(in));
  in += 4;
  const auto w1 = bit_util::FromLittleEndian(util::SafeLoadAs<uint32_t>(in));
  in += 4;
  out[0] = (w0) & mask;
  out[1] = (w0 >> 2) & mask;
  out[2] = (w0 >> 4) & mask;
...
inline const uint8_t* unpack3_32(const uint8_t* in, uint32_t* out){
  ...
  const auto w1 = bit_util::FromLittleEndian(util::SafeLoadAs<uint32_t>(in));
  in += 4;
  const auto w2 = bit_util::FromLittleEndian(util::SafeLoadAs<uint32_t>(in));
  in += 4;
  out[0] = (w0) & mask;
  out[1] = (w0 >> 3) & mask;
  out[2] = (w0 >> 6) & mask;
...
inline const uint8_t* unpack4_32(const uint8_t* in, uint32_t* out){
  ...
  const auto w2 = bit_util::FromLittleEndian(util::SafeLoadAs<uint32_t>(in));
  in += 4;
  const auto w3 = bit_util::FromLittleEndian(util::SafeLoadAs<uint32_t>(in));
  in += 4;
  out[0] = (w0) & mask;
  out[1] = (w0 >> 4) & mask;
  out[2] = (w0 >> 8) & mask;
...
inline const uint8_t* unpack5_32(const uint8_t* in, uint32_t* out){
  ...
  const auto w3 = bit_util::FromLittleEndian(util::SafeLoadAs<uint32_t>(in));
  in += 4;
  const auto w4 = bit_util::FromLittleEndian(util::SafeLoadAs<uint32_t>(in));
  in += 4;
  out[0] = (w0) & mask;
  out[1] = (w0 >> 5) & mask;
  out[2] = (w0 >> 10) & mask;
...
inline const uint8_t* unpack6_32(const uint8_t* in, uint32_t* out){
  ...
  const auto w4 = bit_util::FromLittleEndian(util::SafeLoadAs<uint32_t>(in));
  in += 4;
  const auto w5 = bit_util::FromLittleEndian(util::SafeLoadAs<uint32_t>(in));
  in += 4;
  out[0] = (w0) & mask;
  out[1] = (w0 >> 6) & mask;
  out[2] = (w0 >> 12) & mask;
...
inline const uint8_t* unpack7_32(const uint8_t* in, uint32_t* out){
  ...
  const auto w5 = bit_util::FromLittleEndian(util::SafeLoadAs<uint32_t>(in));
  in += 4;
  const auto w6 = bit_util::FromLittleEndian(util::SafeLoadAs<uint32_t>(in));
  in += 4;
  out[0] = (w0) & mask;
  out[1] = (w0 >> 7) & mask;
  out[2] = (w0 >> 14) & mask;
...
inline const uint8_t* unpack8_32(const uint8_t* in, uint32_t* out){
  ...
  const auto w6 = bit_util::FromLittleEndian(util::SafeLoadAs<uint32_t>(in));
  in += 4;
  const auto w7 = bit_util::FromLittleEndian(util::SafeLoadAs<uint32_t>(in));
  in += 4;
  out[0] = (w0) & mask;
  out[1] = (w0 >> 8) & mask;
  out[2] = (w0 >> 16) & mask;
...
inline const uint8_t* unpack9_32(const uint8_t* in, uint32_t* out){
  ...
  const auto w7 = bit_util::FromLittleEndian(util::SafeLoadAs<uint32_t>(in));
  in += 4;
  const auto w8 = bit_util::FromLittleEndian(util::SafeLoadAs<uint32_t>(in));
  in += 4;
  out[0] = (w0) & mask;
  out[1] = (w0 >> 9) & mask;
  out[2] = (w0 >> 18) & mask;
...
inline const uint8_t* unpack10_32(const uint8_t* in, uint32_t* out){
  ...
  const auto w8 = bit_util::FromLittleEndian(util::SafeLoadAs<uint32_t>(in));
  in += 4;
  const auto w9 = bit_util::FromLittleEndian(util::SafeLoadAs<uint32_t>(in));
  in += 4;
  out[0] = (w0) & mask;
  out[1] = (w0 >> 10) & mask;
  out[2] = (w0 >> 20) & mask;
...
inline const uint8_t* unpack11_32(const uint8_t* in, uint32_t* out){
  ...
  const auto w9 = bit_util::FromLittleEndian(util::SafeLoadAs<uint32_t>(in));
  in += 4;
  const auto w10 = bit_util::FromLittleEndian(util::SafeLoadAs<uint32_t>(in));
  in += 4;
  out[0] = (w0) & mask;
  out[1] = (w0 >> 11) & mask;
...
inline const uint8_t* unpack12_32(const uint8_t* in, uint32_t* out){
  ...
  const auto w10 = bit_util::FromLittleEndian(util::SafeLoadAs<uint32_t>(in));
  in += 4;
  const auto w11 = bit_util::FromLittleEndian(util::SafeLoadAs<uint32_t>(in));
  in += 4;
  out[0] = (w0) & mask;
  out[1] = (w0 >> 12) & mask;
...
inline const uint8_t* unpack13_32(const uint8_t* in, uint32_t* out){
  ...
  const auto w11 = bit_util::FromLittleEndian(util::SafeLoadAs<uint32_t>(in));
  in += 4;
  const auto w12 = bit_util::FromLittleEndian(util::SafeLoadAs<uint32_t>(in));
  in += 4;
  out[0] = (w0) & mask;
  out[1] = (w0 >> 13) & mask;
...
inline const uint8_t* unpack14_32(const uint8_t* in, uint32_t* out){
  ...
  const auto w12 = bit_util::FromLittleEndian(util::SafeLoadAs<uint32_t>(in));
  in += 4;
  const auto w13 = bit_util::FromLittleEndian(util::SafeLoadAs<uint32_t>(in));
  in += 4;
  out[0] = (w0) & mask;
  out[1] = (w0 >> 14) & mask;
...
inline const uint8_t* unpack15_32(const uint8_t* in, uint32_t* out){
  ...
  const auto w13 = bit_util::FromLittleEndian(util::SafeLoadAs<uint32_t>(in));
  in += 4;
  const auto w14 = bit_util::FromLittleEndian(util::SafeLoadAs<uint32_t>(in));
  in += 4;
  out[0] = (w0) & mask;
  out[1] = (w0 >> 15) & mask;
...
inline const uint8_t* unpack16_32(const uint8_t* in, uint32_t* out){
  ...
  const auto w14 = bit_util::FromLittleEndian(util::SafeLoadAs<uint32_t>(in));
  in += 4;
  const auto w15 = bit_util::FromLittleEndian(util::SafeLoadAs<uint32_t>(in));
  in += 4;
  out[0] = (w0) & mask;
  out[1] = w0 >> 16;
  out[2] = (w1) & mask;
...
inline const uint8_t* unpack17_32(const uint8_t* in, uint32_t* out){
  ...
  const auto w15 = bit_util::FromLittleEndian(util::SafeLoadAs<uint32_t>(in));
  in += 4;
  const auto w16 = bit_util::FromLittleEndian(util::SafeLoadAs<uint32_t>(in));
  in += 4;
  out[0] = (w0) & mask;
...
inline const uint8_t* unpack18_32(const uint8_t* in, uint32_t* out){
  ...
  const auto w16 = bit_util::FromLittleEndian(util::SafeLoadAs<uint32_t>(in));
  in += 4;
  const auto w17 = bit_util::FromLittleEndian(util::SafeLoadAs<uint32_t>(in));
  in += 4;
  out[0] = (w0) & mask;
...
inline const uint8_t* unpack19_32(const uint8_t* in, uint32_t* out){
  ...
  const auto w17 = bit_util::FromLittleEndian(util::SafeLoadAs<uint32_t>(in));
  in += 4;
  const auto w18 = bit_util::FromLittleEndian(util::SafeLoadAs<uint32_t>(in));
  in += 4;
  out[0] = (w0) & mask;
...
inline const uint8_t* unpack20_32(const uint8_t* in, uint32_t* out){
  ...
  const auto w18 = bit_util::FromLittleEndian(util::SafeLoadAs<uint32_t>(in));
  in += 4;
  const auto w19 = bit_util::FromLittleEndian(util::SafeLoadAs<uint32_t>(in));
  in += 4;
  out[0] = (w0) & mask;
...
inline const uint8_t* unpack21_32(const uint8_t* in, uint32_t* out){
  ...
  const auto w19 = bit_util::FromLittleEndian(util::SafeLoadAs<uint32_t>(in));
  in += 4;
  const auto w20 = bit_util::FromLittleEndian(util::SafeLoadAs<uint32_t>(in));
  in += 4;
  out[0] = (w0) & mask;
...
inline const uint8_t* unpack22_32(const uint8_t* in, uint32_t* out){
  ...
  const auto w20 = bit_util::FromLittleEndian(util::SafeLoadAs<uint32_t>(in));
  in += 4;
  const auto w21 = bit_util::FromLittleEndian(util::SafeLoadAs<uint32_t>(in));
  in += 4;
  out[0] = (w0) & mask;
...
inline const uint8_t* unpack23_32(const uint8_t* in, uint32_t* out){
  ...
  const auto w21 = bit_util::FromLittleEndian(util::SafeLoadAs<uint32_t>(in));
  in += 4;
  const auto w22 = bit_util::FromLittleEndian(util::SafeLoadAs<uint32_t>(in));
  in += 4;
  out[0] = (w0) & mask;
...
inline const uint8_t* unpack24_32(const uint8_t* in, uint32_t* out){
  ...
  const auto w22 = bit_util::FromLittleEndian(util::SafeLoadAs<uint32_t>(in));
  in += 4;
  const auto w23 = bit_util::FromLittleEndian(util::SafeLoadAs<uint32_t>(in));
  in += 4;
  out[0] = (w0) & mask;
...
inline const uint8_t* unpack25_32(const uint8_t* in, uint32_t* out){
  ...
  const auto w23 = bit_util::FromLittleEndian(util::SafeLoadAs<uint32_t>(in));
  in += 4;
  const auto w24 = bit_util::FromLittleEndian(util::SafeLoadAs<uint32_t>(in));
  in += 4;
  out[0] = (w0) & mask;
...
inline const uint8_t* unpack26_32(const uint8_t* in, uint32_t* out){
  ...
  const auto w24 = bit_util::FromLittleEndian(util::SafeLoadAs<uint32_t>(in));
  in += 4;
  const auto w25 = bit_util::FromLittleEndian(util::SafeLoadAs<uint32_t>(in));
  in += 4;
  out[0] = (w0) & mask;
...
inline const uint8_t* unpack27_32(const uint8_t* in, uint32_t* out){
  ...
  const auto w25 = bit_util::FromLittleEndian(util::SafeLoadAs<uint32_t>(in));
  in += 4;
  const auto w26 = bit_util::FromLittleEndian(util::SafeLoadAs<uint32_t>(in));
  in += 4;
  out[0] = (w0) & mask;
...
inline const uint8_t* unpack28_32(const uint8_t* in, uint32_t* out){
  ...
  const auto w26 = bit_util::FromLittleEndian(util::SafeLoadAs<uint32_t>(in));
  in += 4;
  const auto w27 = bit_util::FromLittleEndian(util::SafeLoadAs<uint32_t>(in));
  in += 4;
  out[0] = (w0) & mask;
...
inline const uint8_t* unpack29_32(const uint8_t* in, uint32_t* out){
  ...
  const auto w27 = bit_util::FromLittleEndian(util::SafeLoadAs<uint32_t>(in));
  in += 4;
  const auto w28 = bit_util::FromLittleEndian(util::SafeLoadAs<uint32_t>(in));
  in += 4;
  out[0] = (w0) & mask;
...
inline const uint8_t* unpack30_32(const uint8_t* in, uint32_t* out){
  ...
  const auto w28 = bit_util::FromLittleEndian(util::SafeLoadAs<uint32_t>(in));
  in += 4;
  const auto w29 = bit_util::FromLittleEndian(util::SafeLoadAs<uint32_t>(in));
  in += 4;
  out[0] = (w0) & mask;
...
inline const uint8_t* unpack31_32(const uint8_t* in, uint32_t* out){
  ...
  const auto w29 = bit_util::FromLittleEndian(util::SafeLoadAs<uint32_t>(in));
  in += 4;
  const auto w30 = bit_util::FromLittleEndian(util::SafeLoadAs<uint32_t>(in));
  in += 4;
  out[0] = (w0) & mask;
...
inline const uint8_t* unpack32_32(const uint8_t* in, uint32_t* out){
  for(int k = 0; k < 32; k += 1) {
    auto w = util::SafeLoadAs<uint32_t>(in);
    out[k] = bit_util::FromLittleEndian(w);
    in += 4;
  }
  return in;
}
...
inline const uint8_t* unpack1_64(const uint8_t* in, uint64_t* out){
  ...
  auto w0 = static_cast<uint64_t>(util::SafeLoadAs<uint32_t>(in));
  w0 = bit_util::FromLittleEndian(w0);
  in += 4;
  out[0] = (w0) & mask;
  out[1] = (w0 >> 1) & mask;
  out[2] = (w0 >> 2) & mask;
...
inline const uint8_t* unpack2_64(const uint8_t* in, uint64_t* out){
  ...
  const auto w0 = bit_util::FromLittleEndian(util::SafeLoadAs<uint64_t>(in));
  in += 8;
  out[0] = (w0) & mask;
  out[1] = (w0 >> 2) & mask;
  out[2] = (w0 >> 4) & mask;
...
inline const uint8_t* unpack3_64(const uint8_t* in, uint64_t* out){
  ...
  const auto w0 = bit_util::FromLittleEndian(util::SafeLoadAs<uint64_t>(in));
  in += 8;
  auto w1 = static_cast<uint64_t>(util::SafeLoadAs<uint32_t>(in));
  w1 = bit_util::FromLittleEndian(w1);
  in += 4;
  out[0] = (w0) & mask;
  out[1] = (w0 >> 3) & mask;
  out[2] = (w0 >> 6) & mask;
...
inline const uint8_t* unpack4_64(const uint8_t* in, uint64_t* out){
  ...
  const auto w0 = bit_util::FromLittleEndian(util::SafeLoadAs<uint64_t>(in));
  in += 8;
  const auto w1 = bit_util::FromLittleEndian(util::SafeLoadAs<uint64_t>(in));
  in += 8;
  out[0] = (w0) & mask;
  out[1] = (w0 >> 4) & mask;
  out[2] = (w0 >> 8) & mask;
...
inline const uint8_t* unpack5_64(const uint8_t* in, uint64_t* out){
  ...
  const auto w1 = bit_util::FromLittleEndian(util::SafeLoadAs<uint64_t>(in));
  in += 8;
  auto w2 = static_cast<uint64_t>(util::SafeLoadAs<uint32_t>(in));
  w2 = bit_util::FromLittleEndian(w2);
  in += 4;
  out[0] = (w0) & mask;
  out[1] = (w0 >> 5) & mask;
  out[2] = (w0 >> 10) & mask;
...
inline const uint8_t* unpack6_64(const uint8_t* in, uint64_t* out){
  ...
  const auto w1 = bit_util::FromLittleEndian(util::SafeLoadAs<uint64_t>(in));
  in += 8;
  const auto w2 = bit_util::FromLittleEndian(util::SafeLoadAs<uint64_t>(in));
  in += 8;
  out[0] = (w0) & mask;
  out[1] = (w0 >> 6) & mask;
  out[2] = (w0 >> 12) & mask;
...
inline const uint8_t* unpack7_64(const uint8_t* in, uint64_t* out){
  ...
  const auto w2 = bit_util::FromLittleEndian(util::SafeLoadAs<uint64_t>(in));
  in += 8;
  auto w3 = static_cast<uint64_t>(util::SafeLoadAs<uint32_t>(in));
  w3 = bit_util::FromLittleEndian(w3);
  in += 4;
  out[0] = (w0) & mask;
  out[1] = (w0 >> 7) & mask;
  out[2] = (w0 >> 14) & mask;
...
inline const uint8_t* unpack8_64(const uint8_t* in, uint64_t* out){
  ...
  const auto w2 = bit_util::FromLittleEndian(util::SafeLoadAs<uint64_t>(in));
  in += 8;
  const auto w3 = bit_util::FromLittleEndian(util::SafeLoadAs<uint64_t>(in));
  in += 8;
  out[0] = (w0) & mask;
  out[1] = (w0 >> 8) & mask;
  out[2] = (w0 >> 16) & mask;
...
inline const uint8_t* unpack9_64(const uint8_t* in, uint64_t* out){
  ...
  const auto w3 = bit_util::FromLittleEndian(util::SafeLoadAs<uint64_t>(in));
  in += 8;
  auto w4 = static_cast<uint64_t>(util::SafeLoadAs<uint32_t>(in));
  w4 = bit_util::FromLittleEndian(w4);
  in += 4;
  out[0] = (w0) & mask;
  out[1] = (w0 >> 9) & mask;
  out[2] = (w0 >> 18) & mask;
...
inline const uint8_t* unpack10_64(const uint8_t* in, uint64_t* out){
  ...
  const auto w3 = bit_util::FromLittleEndian(util::SafeLoadAs<uint64_t>(in));
  in += 8;
  const auto w4 = bit_util::FromLittleEndian(util::SafeLoadAs<uint64_t>(in));
  in += 8;
  out[0] = (w0) & mask;
  out[1] = (w0 >> 10) & mask;
  out[2] = (w0 >> 20) & mask;
...
inline const uint8_t* unpack11_64(const uint8_t* in, uint64_t* out){
  ...
  const auto w4 = bit_util::FromLittleEndian(util::SafeLoadAs<uint64_t>(in));
  in += 8;
  auto w5 = static_cast<uint64_t>(util::SafeLoadAs<uint32_t>(in));
  w5 = bit_util::FromLittleEndian(w5);
  in += 4;
  out[0] = (w0) & mask;
  out[1] = (w0 >> 11) & mask;
  out[2] = (w0 >> 22) & mask;
...
inline const uint8_t* unpack12_64(const uint8_t* in, uint64_t* out){
  ...
  const auto w4 = bit_util::FromLittleEndian(util::SafeLoadAs<uint64_t>(in));
  in += 8;
  const auto w5 = bit_util::FromLittleEndian(util::SafeLoadAs<uint64_t>(in));
  in += 8;
  out[0] = (w0) & mask;
  out[1] = (w0 >> 12) & mask;
  out[2] = (w0 >> 24) & mask;
...
inline const uint8_t* unpack13_64(const uint8_t* in, uint64_t* out){
  ...
  const auto w5 = bit_util::FromLittleEndian(util::SafeLoadAs<uint64_t>(in));
  in += 8;
  auto w6 = static_cast<uint64_t>(util::SafeLoadAs<uint32_t>(in));
  w6 = bit_util::FromLittleEndian(w6);
  in += 4;
  out[0] = (w0) & mask;
  out[1] = (w0 >> 13) & mask;
  out[2] = (w0 >> 26) & mask;
...
inline const uint8_t* unpack14_64(const uint8_t* in, uint64_t* out){
  ...
  const auto w5 = bit_util::FromLittleEndian(util::SafeLoadAs<uint64_t>(in));
  in += 8;
  const auto w6 = bit_util::FromLittleEndian(util::SafeLoadAs<uint64_t>(in));
  in += 8;
  out[0] = (w0) & mask;
  out[1] = (w0 >> 14) & mask;
  out[2] = (w0 >> 28) & mask;
...
inline const uint8_t* unpack15_64(const uint8_t* in, uint64_t* out){
  ...
  const auto w6 = bit_util::FromLittleEndian(util::SafeLoadAs<uint64_t>(in));
  in += 8;
  auto w7 = static_cast<uint64_t>(util::SafeLoadAs<uint32_t>(in));
  w7 = bit_util::FromLittleEndian(w7);
  in += 4;
  out[0] = (w0) & mask;
  out[1] = (w0 >> 15) & mask;
  out[2] = (w0 >> 30) & mask;
...
inline const uint8_t* unpack16_64(const uint8_t* in, uint64_t* out){
  ...
  const auto w6 = bit_util::FromLittleEndian(util::SafeLoadAs<uint64_t>(in));
  in += 8;
  const auto w7 = bit_util::FromLittleEndian(util::SafeLoadAs<uint64_t>(in));
  in += 8;
  out[0] = (w0) & mask;
  out[1] = (w0 >> 16) & mask;
  out[2] = (w0 >> 32) & mask;
...
inline const uint8_t* unpack17_64(const uint8_t* in, uint64_t* out){
  ...
  const auto w7 = bit_util::FromLittleEndian(util::SafeLoadAs<uint64_t>(in));
  in += 8;
  auto w8 = static_cast<uint64_t>(util::SafeLoadAs<uint32_t>(in));
  w8 = bit_util::FromLittleEndian(w8);
  in += 4;
  out[0] = (w0) & mask;
  out[1] = (w0 >> 17) & mask;
  out[2] = (w0 >> 34) & mask;
...
inline const uint8_t* unpack18_64(const uint8_t* in, uint64_t* out){
  ...
  const auto w7 = bit_util::FromLittleEndian(util::SafeLoadAs<uint64_t>(in));
  in += 8;
  const auto w8 = bit_util::FromLittleEndian(util::SafeLoadAs<uint64_t>(in));
  in += 8;
  out[0] = (w0) & mask;
  out[1] = (w0 >> 18) & mask;
  out[2] = (w0 >> 36) & mask;
...
inline const uint8_t* unpack19_64(const uint8_t* in, uint64_t* out){
  ...
  const auto w8 = bit_util::FromLittleEndian(util::SafeLoadAs<uint64_t>(in));
  in += 8;
  auto w9 = static_cast<uint64_t>(util::SafeLoadAs<uint32_t>(in));
  w9 = bit_util::FromLittleEndian(w9);
  in += 4;
  out[0] = (w0) & mask;
  out[1] = (w0 >> 19) & mask;
  out[2] = (w0 >> 38) & mask;
...
inline const uint8_t* unpack20_64(const uint8_t* in, uint64_t* out){
  ...
  const auto w8 = bit_util::FromLittleEndian(util::SafeLoadAs<uint64_t>(in));
  in += 8;
  const auto w9 = bit_util::FromLittleEndian(util::SafeLoadAs<uint64_t>(in));
  in += 8;
  out[0] = (w0) & mask;
  out[1] = (w0 >> 20) & mask;
  out[2] = (w0 >> 40) & mask;
...
inline const uint8_t* unpack21_64(const uint8_t* in, uint64_t* out){
  ...
  const auto w9 = bit_util::FromLittleEndian(util::SafeLoadAs<uint64_t>(in));
  in += 8;
  auto w10 = static_cast<uint64_t>(util::SafeLoadAs<uint32_t>(in));
  w10 = bit_util::FromLittleEndian(w10);
  in += 4;
  out[0] = (w0) & mask;
  out[1] = (w0 >> 21) & mask;
  out[2] = (w0 >> 42) & mask;
...
inline const uint8_t* unpack22_64(const uint8_t* in, uint64_t* out){
  ...
  const auto w9 = bit_util::FromLittleEndian(util::SafeLoadAs<uint64_t>(in));
  in += 8;
  const auto w10 = bit_util::FromLittleEndian(util::SafeLoadAs<uint64_t>(in));
  in += 8;
  out[0] = (w0) & mask;
  out[1] = (w0 >> 22) & mask;
...
inline const uint8_t* unpack23_64(const uint8_t* in, uint64_t* out){
  ...
  const auto w10 = bit_util::FromLittleEndian(util::SafeLoadAs<uint64_t>(in));
  in += 8;
  auto w11 = static_cast<uint64_t>(util::SafeLoadAs<uint32_t>(in));
  w11 = bit_util::FromLittleEndian(w11);
  in += 4;
  out[0] = (w0) & mask;
  out[1] = (w0 >> 23) & mask;
...
inline const uint8_t* unpack24_64(const uint8_t* in, uint64_t* out){
  ...
  const auto w10 = bit_util::FromLittleEndian(util::SafeLoadAs<uint64_t>(in));
  in += 8;
  const auto w11 = bit_util::FromLittleEndian(util::SafeLoadAs<uint64_t>(in));
  in += 8;
  out[0] = (w0) & mask;
  out[1] = (w0 >> 24) & mask;
...
inline const uint8_t* unpack25_64(const uint8_t* in, uint64_t* out){
  ...
  const auto w11 = bit_util::FromLittleEndian(util::SafeLoadAs<uint64_t>(in));
  in += 8;
  auto w12 = static_cast<uint64_t>(util::SafeLoadAs<uint32_t>(in));
  w12 = bit_util::FromLittleEndian(w12);
  in += 4;
  out[0] = (w0) & mask;
  out[1] = (w0 >> 25) & mask;
...
inline const uint8_t* unpack26_64(const uint8_t* in, uint64_t* out){
  ...
  const auto w11 = bit_util::FromLittleEndian(util::SafeLoadAs<uint64_t>(in));
  in += 8;
  const auto w12 = bit_util::FromLittleEndian(util::SafeLoadAs<uint64_t>(in));
  in += 8;
  out[0] = (w0) & mask;
  out[1] = (w0 >> 26) & mask;
...
inline const uint8_t* unpack27_64(const uint8_t* in, uint64_t* out){
  ...
  const auto w12 = bit_util::FromLittleEndian(util::SafeLoadAs<uint64_t>(in));
  in += 8;
  auto w13 = static_cast<uint64_t>(util::SafeLoadAs<uint32_t>(in));
  w13 = bit_util::FromLittleEndian(w13);
  in += 4;
  out[0] = (w0) & mask;
  out[1] = (w0 >> 27) & mask;
...
inline const uint8_t* unpack28_64(const uint8_t* in, uint64_t* out){
  ...
  const auto w12 = bit_util::FromLittleEndian(util::SafeLoadAs<uint64_t>(in));
  in += 8;
  const auto w13 = bit_util::FromLittleEndian(util::SafeLoadAs<uint64_t>(in));
  in += 8;
  out[0] = (w0) & mask;
  out[1] = (w0 >> 28) & mask;
...
inline const uint8_t* unpack29_64(const uint8_t* in, uint64_t* out){
  ...
  const auto w13 = bit_util::FromLittleEndian(util::SafeLoadAs<uint64_t>(in));
  in += 8;
  auto w14 = static_cast<uint64_t>(util::SafeLoadAs<uint32_t>(in));
  w14 = bit_util::FromLittleEndian(w14);
  in += 4;
  out[0] = (w0) & mask;
  out[1] = (w0 >> 29) & mask;
...
inline const uint8_t* unpack30_64(const uint8_t* in, uint64_t* out){
  ...
  const auto w13 = bit_util::FromLittleEndian(util::SafeLoadAs<uint64_t>(in));
  in += 8;
  const auto w14 = bit_util::FromLittleEndian(util::SafeLoadAs<uint64_t>(in));
  in += 8;
  out[0] = (w0) & mask;
  out[1] = (w0 >> 30) & mask;
...
inline const uint8_t* unpack31_64(const uint8_t* in, uint64_t* out){
  ...
  const auto w14 = bit_util::FromLittleEndian(util::SafeLoadAs<uint64_t>(in));
  in += 8;
  auto w15 = static_cast<uint64_t>(util::SafeLoadAs<uint32_t>(in));
  w15 = bit_util::FromLittleEndian(w15);
  in += 4;
  out[0] = (w0) & mask;
  out[1] = (w0 >> 31) & mask;
...
inline const uint8_t* unpack32_64(const uint8_t* in, uint64_t* out){
  ...
  const auto w14 = bit_util::FromLittleEndian(util::SafeLoadAs<uint64_t>(in));
  in += 8;
  const auto w15 = bit_util::FromLittleEndian(util::SafeLoadAs<uint64_t>(in));
  in += 8;
  out[0] = (w0) & mask;
  out[1] = w0 >> 32;
  out[2] = (w1) & mask;
...
inline const uint8_t* unpack33_64(const uint8_t* in, uint64_t* out){
  ...
  const auto w15 = bit_util::FromLittleEndian(util::SafeLoadAs<uint64_t>(in));
  in += 8;
  auto w16 = static_cast<uint64_t>(util::SafeLoadAs<uint32_t>(in));
  w16 = bit_util::FromLittleEndian(w16);
  in += 4;
  out[0] = (w0) & mask;
...
inline const uint8_t* unpack34_64(const uint8_t* in, uint64_t* out){
  ...
  const auto w15 = bit_util::FromLittleEndian(util::SafeLoadAs<uint64_t>(in));
  in += 8;
  const auto w16 = bit_util::FromLittleEndian(util::SafeLoadAs<uint64_t>(in));
  in += 8;
  out[0] = (w0) & mask;
...
inline const uint8_t* unpack35_64(const uint8_t* in, uint64_t* out){
  ...
  const auto w16 = bit_util::FromLittleEndian(util::SafeLoadAs<uint64_t>(in));
  in += 8;
  auto w17 = static_cast<uint64_t>(util::SafeLoadAs<uint32_t>(in));
  w17 = bit_util::FromLittleEndian(w17);
  in += 4;
  out[0] = (w0) & mask;
...
inline const uint8_t* unpack36_64(const uint8_t* in, uint64_t* out){
  ...
  const auto w16 = bit_util::FromLittleEndian(util::SafeLoadAs<uint64_t>(in));
  in += 8;
  const auto w17 = bit_util::FromLittleEndian(util::SafeLoadAs<uint64_t>(in));
  in += 8;
  out[0] = (w0) & mask;
...
inline const uint8_t* unpack37_64(const uint8_t* in, uint64_t* out){
  ...
  const auto w17 = bit_util::FromLittleEndian(util::SafeLoadAs<uint64_t>(in));
  in += 8;
  auto w18 = static_cast<uint64_t>(util::SafeLoadAs<uint32_t>(in));
  w18 = bit_util::FromLittleEndian(w18);
  in += 4;
  out[0] = (w0) & mask;
...
inline const uint8_t* unpack38_64(const uint8_t* in, uint64_t* out){
  ...
  const auto w17 = bit_util::FromLittleEndian(util::SafeLoadAs<uint64_t>(in));
  in += 8;
  const auto w18 = bit_util::FromLittleEndian(util::SafeLoadAs<uint64_t>(in));
  in += 8;
  out[0] = (w0) & mask;
...
inline const uint8_t* unpack39_64(const uint8_t* in, uint64_t* out){
  ...
  const auto w18 = bit_util::FromLittleEndian(util::SafeLoadAs<uint64_t>(in));
  in += 8;
  auto w19 = static_cast<uint64_t>(util::SafeLoadAs<uint32_t>(in));
  w19 = bit_util::FromLittleEndian(w19);
  in += 4;
  out[0] = (w0) & mask;
...
inline const uint8_t* unpack40_64(const uint8_t* in, uint64_t* out){
  ...
  const auto w18 = bit_util::FromLittleEndian(util::SafeLoadAs<uint64_t>(in));
  in += 8;
  const auto w19 = bit_util::FromLittleEndian(util::SafeLoadAs<uint64_t>(in));
  in += 8;
  out[0] = (w0) & mask;
...
inline const uint8_t* unpack41_64(const uint8_t* in, uint64_t* out){
  ...
  const auto w19 = bit_util::FromLittleEndian(util::SafeLoadAs<uint64_t>(in));
  in += 8;
  auto w20 = static_cast<uint64_t>(util::SafeLoadAs<uint32_t>(in));
  w20 = bit_util::FromLittleEndian(w20);
  in += 4;
  out[0] = (w0) & mask;
...
inline const uint8_t* unpack42_64(const uint8_t* in, uint64_t* out){
  ...
  const auto w19 = bit_util::FromLittleEndian(util::SafeLoadAs<uint64_t>(in));
  in += 8;
  const auto w20 = bit_util::FromLittleEndian(util::SafeLoadAs<uint64_t>(in));
  in += 8;
  out[0] = (w0) & mask;
...
inline const uint8_t* unpack43_64(const uint8_t* in, uint64_t* out){
  ...
  const auto w20 = bit_util::FromLittleEndian(util::SafeLoadAs<uint64_t>(in));
  in += 8;
  auto w21 = static_cast<uint64_t>(util::SafeLoadAs<uint32_t>(in));
  w21 = bit_util::FromLittleEndian(w21);
  in += 4;
  out[0] = (w0) & mask;
...
inline const uint8_t* unpack44_64(const uint8_t* in, uint64_t* out){
  ...
  const auto w20 = bit_util::FromLittleEndian(util::SafeLoadAs<uint64_t>(in));
  in += 8;
  const auto w21 = bit_util::FromLittleEndian(util::SafeLoadAs<uint64_t>(in));
  in += 8;
  out[0] = (w0) & mask;
...
inline const uint8_t* unpack45_64(const uint8_t* in, uint64_t* out){
  ...
  const auto w21 = bit_util::FromLittleEndian(util::SafeLoadAs<uint64_t>(in));
  in += 8;
  auto w22 = static_cast<uint64_t>(util::SafeLoadAs<uint32_t>(in));
  w22 = bit_util::FromLittleEndian(w22);
  in += 4;
  out[0] = (w0) & mask;
...
inline const uint8_t* unpack46_64(const uint8_t* in, uint64_t* out){
  ...
  const auto w21 = bit_util::FromLittleEndian(util::SafeLoadAs<uint64_t>(in));
  in += 8;
  const auto w22 = bit_util::FromLittleEndian(util::SafeLoadAs<uint64_t>(in));
  in += 8;
  out[0] = (w0) & mask;
...
inline const uint8_t* unpack47_64(const uint8_t* in, uint64_t* out){
  ...
  const auto w22 = bit_util::FromLittleEndian(util::SafeLoadAs<uint64_t>(in));
  in += 8;
  auto w23 = static_cast<uint64_t>(util::SafeLoadAs<uint32_t>(in));
  w23 = bit_util::FromLittleEndian(w23);
  in += 4;
  out[0] = (w0) & mask;
...
inline const uint8_t* unpack48_64(const uint8_t* in, uint64_t* out){
  ...
  const auto w22 = bit_util::FromLittleEndian(util::SafeLoadAs<uint64_t>(in));
  in += 8;
  const auto w23 = bit_util::FromLittleEndian(util::SafeLoadAs<uint64_t>(in));
  in += 8;
  out[0] = (w0) & mask;
...
inline const uint8_t* unpack49_64(const uint8_t* in, uint64_t* out){
  ...
  const auto w23 = bit_util::FromLittleEndian(util::SafeLoadAs<uint64_t>(in));
  in += 8;
  auto w24 = static_cast<uint64_t>(util::SafeLoadAs<uint32_t>(in));
  w24 = bit_util::FromLittleEndian(w24);
  in += 4;
  out[0] = (w0) & mask;
...
inline const uint8_t* unpack50_64(const uint8_t* in, uint64_t* out){
  ...
  const auto w23 = bit_util::FromLittleEndian(util::SafeLoadAs<uint64_t>(in));
  in += 8;
  const auto w24 = bit_util::FromLittleEndian(util::SafeLoadAs<uint64_t>(in));
  in += 8;
  out[0] = (w0) & mask;
...
inline const uint8_t* unpack51_64(const uint8_t* in, uint64_t* out){
  ...
  const auto w24 = bit_util::FromLittleEndian(util::SafeLoadAs<uint64_t>(in));
  in += 8;
  auto w25 = static_cast<uint64_t>(util::SafeLoadAs<uint32_t>(in));
  w25 = bit_util::FromLittleEndian(w25);
  in += 4;
  out[0] = (w0) & mask;
...
inline const uint8_t* unpack52_64(const uint8_t* in, uint64_t* out){
  ...
  const auto w24 = bit_util::FromLittleEndian(util::SafeLoadAs<uint64_t>(in));
  in += 8;
  const auto w25 = bit_util::FromLittleEndian(util::SafeLoadAs<uint64_t>(in));
  in += 8;
  out[0] = (w0) & mask;
...
inline const uint8_t* unpack53_64(const uint8_t* in, uint64_t* out){
  ...
  const auto w25 = bit_util::FromLittleEndian(util::SafeLoadAs<uint64_t>(in));
  in += 8;
  auto w26 = static_cast<uint64_t>(util::SafeLoadAs<uint32_t>(in));
  w26 = bit_util::FromLittleEndian(w26);
  in += 4;
  out[0] = (w0) & mask;
...
inline const uint8_t* unpack54_64(const uint8_t* in, uint64_t* out){
  ...
  const auto w25 = bit_util::FromLittleEndian(util::SafeLoadAs<uint64_t>(in));
  in += 8;
  const auto w26 = bit_util::FromLittleEndian(util::SafeLoadAs<uint64_t>(in));
  in += 8;
  out[0] = (w0) & mask;
...
inline const uint8_t* unpack55_64(const uint8_t* in, uint64_t* out){
  ...
  const auto w26 = bit_util::FromLittleEndian(util::SafeLoadAs<uint64_t>(in));
  in += 8;
  auto w27 = static_cast<uint64_t>(util::SafeLoadAs<uint32_t>(in));
  w27 = bit_util::FromLittleEndian(w27);
  in += 4;
  out[0] = (w0) & mask;
...
inline const uint8_t* unpack56_64(const uint8_t* in, uint64_t* out){
  ...
  const auto w26 = bit_util::FromLittleEndian(util::SafeLoadAs<uint64_t>(in));
  in += 8;
  const auto w27 = bit_util::FromLittleEndian(util::SafeLoadAs<uint64_t>(in));
  in += 8;
  out[0] = (w0) & mask;
...
inline const uint8_t* unpack57_64(const uint8_t* in, uint64_t* out){
  ...
  const auto w27 = bit_util::FromLittleEndian(util::SafeLoadAs<uint64_t>(in));
  in += 8;
  auto w28 = static_cast<uint64_t>(util::SafeLoadAs<uint32_t>(in));
  w28 = bit_util::FromLittleEndian(w28);
  in += 4;
  out[0] = (w0) & mask;
...
inline const uint8_t* unpack58_64(const uint8_t* in, uint64_t* out){
  ...
  const auto w27 = bit_util::FromLittleEndian(util::SafeLoadAs<uint64_t>(in));
  in += 8;
  const auto w28 = bit_util::FromLittleEndian(util::SafeLoadAs<uint64_t>(in));
  in += 8;
  out[0] = (w0) & mask;
...
inline const uint8_t* unpack59_64(const uint8_t* in, uint64_t* out){
  ...
  const auto w28 = bit_util::FromLittleEndian(util::SafeLoadAs<uint64_t>(in));
  in += 8;
  auto w29 = static_cast<uint64_t>(util::SafeLoadAs<uint32_t>(in));
  w29 = bit_util::FromLittleEndian(w29);
  in += 4;
  out[0] = (w0) & mask;
...
inline const uint8_t* unpack60_64(const uint8_t* in, uint64_t* out){
  ...
  const auto w28 = bit_util::FromLittleEndian(util::SafeLoadAs<uint64_t>(in));
  in += 8;
  const auto w29 = bit_util::FromLittleEndian(util::SafeLoadAs<uint64_t>(in));
  in += 8;
  out[0] = (w0) & mask;
...
inline const uint8_t* unpack61_64(const uint8_t* in, uint64_t* out){
  ...
  const auto w29 = bit_util::FromLittleEndian(util::SafeLoadAs<uint64_t>(in));
  in += 8;
  auto w30 = static_cast<uint64_t>(util::SafeLoadAs<uint32_t>(in));
  w30 = bit_util::FromLittleEndian(w30);
  in += 4;
  out[0] = (w0) & mask;
...
inline const uint8_t* unpack62_64(const uint8_t* in, uint64_t* out){
  ...
  const auto w29 = bit_util::FromLittleEndian(util::SafeLoadAs<uint64_t>(in));
  in += 8;
  const auto w30 = bit_util::FromLittleEndian(util::SafeLoadAs<uint64_t>(in));
  in += 8;
  out[0] = (w0) & mask;
...
inline const uint8_t* unpack63_64(const uint8_t* in, uint64_t* out){
  ...
  const auto w30 = bit_util::FromLittleEndian(util::SafeLoadAs<uint64_t>(in));
  in += 8;
  auto w31 = static_cast<uint64_t>(util::SafeLoadAs<uint32_t>(in));
  w31 = bit_util::FromLittleEndian(w31);
  in += 4;
  out[0] = (w0) & mask;
...
inline const uint8_t* unpack64_64(const uint8_t* in, uint64_t* out){
  for(int k = 0; k < 32; k += 1) {
    auto w = util::SafeLoadAs<uint64_t>(in);
    out[k] = bit_util::FromLittleEndian(w);
    in += 8;
  }
  return in;
