...
Result<std::shared_ptr<ArrayData>> RunEndEncodeArray(
  ...
  switch (run_end_type->id()) {
    case Type::INT16:
      return RunEndEncodeDispatchValueType<Int16Type>(span, pool);
    case Type::INT32:
      return RunEndEncodeDispatchValueType<Int32Type>(span, pool);
    case Type::INT64:
      return RunEndEncodeDispatchValueType<Int64Type>(span, pool);
    default:
