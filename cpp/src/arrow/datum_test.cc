...
TEST(Datum, EstimateBufferSize) {
  ...
  ASSERT_EQ(4, arr_datum.EstimateBufferSize());
  ASSERT_EQ(4, chunked_datum.EstimateBufferSize());
  ASSERT_EQ(4, rb_datum.EstimateBufferSize());
  ASSERT_EQ(4, tab_datum.EstimateBufferSize());
}
