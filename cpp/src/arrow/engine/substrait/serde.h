...
/// \brief Deserialize a single-relation Substrait Plan message to an execution plan.
///
...
/// \brief Deserialize a Substrait Type message to the corresponding Arrow type.
///
...
/// \brief Serialize an Arrow type to a Substrait Type message.
///
...
/// \brief Deserialize a Substrait NamedStruct message to an Arrow schema.
///
...
/// \brief Serialize an Arrow schema to a Substrait NamedStruct message.
///
...
/// \brief Deserialize a Substrait Expression message to a compute expression.
///
/// \param[in] buf a buffer containing the protobuf serialization of a Substrait
/// Expression message.
/// \param[in] ext_set the extension mapping to use, normally provided by the
...
/// \brief Serialize an Arrow compute expression to a Substrait Expression message.
///
...
/// \brief Deserialize a Substrait Rel (relation) message to an ExecNode declaration.
///
/// \param[in] buf a buffer containing the protobuf serialization of a Substrait
/// Rel message.
/// \param[in] ext_set the extension mapping to use, normally provided by the
...
/// \brief Check whether two protobuf serializations of a particular Substrait message
/// type are equivalent.
///
...
/// \brief Convert a JSON serialization of a Substrait message to its binary
/// serialization.
///
...
/// \brief Convert a binary protobuf serialization of a Substrait message to JSON.
///
/// \param[in] type_name the name of the Substrait message type to convert.
/// \param[in] buf the buffer containing the binary protobuf serialization of the
/// message.
