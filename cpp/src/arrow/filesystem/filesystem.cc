...
Result<std::vector<FileStats>> SubTreeFileSystem::GetTargetStats(const FileSelector& select) {
...
Result<std::vector<FileStats>> SlowFileSystem::GetTargetStats(const FileSelector& selector) {
  latencies_->Sleep();
