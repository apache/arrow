...
#include "arrow/extension-type.h"           // IYWU pragma: export
#include "arrow/memory-pool.h"              // IYWU pragma: export
#include "arrow/pretty-print.h"             // IYWU pragma: export
#include "arrow/record-batch.h"             // IYWU pragma: export
#include "arrow/status.h"                   // IYWU pragma: export
#include "arrow/table.h"                    // IYWU pragma: export
#include "arrow/table-builder.h"            // IYWU pragma: export
...
#include "arrow/util/key-value-metadata.h"  // IWYU pragma: export
