...
ARRAY_VISITOR_DEFAULT(ComplexFloatArray)
ARRAY_VISITOR_DEFAULT(ComplexDoubleArray)
...
TYPE_VISITOR_DEFAULT(ComplexFloatType)
TYPE_VISITOR_DEFAULT(ComplexDoubleType)
...
SCALAR_VISITOR_DEFAULT(ComplexFloatScalar)
SCALAR_VISITOR_DEFAULT(ComplexDoubleScalar)
