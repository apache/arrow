...
Status MakeDates(std::shared_ptr<RecordBatch>* out) {
  ...
  std::vector<int64_t> date64_values = {86400000, 172800000, 259200000,
                                        1489272000000, 345600000, 432000000,
                                        518400000};
...
Status MakeTimes(std::shared_ptr<RecordBatch>* out) {
  ...
  std::vector<int32_t> t32_values = {14896, 14897, 14892,
                                     1489272000, 14893, 14895};
