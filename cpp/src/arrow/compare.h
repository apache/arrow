...
/// has the same effect as using \ref arrow::ArrayApproxEquals.
///
...
///
/// Setting \ref arrow::EqualOptions::use_atol to true
/// has the same effect as using \ref arrow::ArrayRangeApproxEquals.
///
/// Note that arrow::ArrayStatistics is not included in the comparison.
...
///
/// Setting \ref arrow::EqualOptions::use_atol to true
/// has the same effect as using \ref arrow::ScalarApproxEquals.
///
