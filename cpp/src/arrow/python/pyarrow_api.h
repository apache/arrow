...
static PyObject *(*__pyx_api_f_7pyarrow_3lib_pyarrow_wrap_sparse_split_coo_tensor)(std::shared_ptr< arrow::SparseSplitCOOTensor>  const &) = 0;
#define pyarrow_wrap_sparse_split_coo_tensor __pyx_api_f_7pyarrow_3lib_pyarrow_wrap_sparse_split_coo_tensor
...
static std::shared_ptr< arrow::SparseSplitCOOTensor>  (*__pyx_api_f_7pyarrow_3lib_pyarrow_unwrap_sparse_split_coo_tensor)(PyObject *) = 0;
#define pyarrow_unwrap_sparse_split_coo_tensor __pyx_api_f_7pyarrow_3lib_pyarrow_unwrap_sparse_split_coo_tensor
...
static int (*__pyx_api_f_7pyarrow_3lib_pyarrow_is_sparse_split_coo_tensor)(PyObject *) = 0;
#define pyarrow_is_sparse_split_coo_tensor __pyx_api_f_7pyarrow_3lib_pyarrow_is_sparse_split_coo_tensor
...
static int import_pyarrow__lib(void) {
  ...
  if (__Pyx_ImportFunction(module, "pyarrow_wrap_sparse_split_coo_tensor", (void (**)(void))&__pyx_api_f_7pyarrow_3lib_pyarrow_wrap_sparse_split_coo_tensor, "PyObject *(std::shared_ptr< arrow::SparseSplitCOOTensor>  const &)") < 0) goto bad;
  ...
  if (__Pyx_ImportFunction(module, "pyarrow_unwrap_sparse_split_coo_tensor", (void (**)(void))&__pyx_api_f_7pyarrow_3lib_pyarrow_unwrap_sparse_split_coo_tensor, "std::shared_ptr< arrow::SparseSplitCOOTensor>  (PyObject *)") < 0) goto bad;
  ...
  if (__Pyx_ImportFunction(module, "pyarrow_is_sparse_split_coo_tensor", (void (**)(void))&__pyx_api_f_7pyarrow_3lib_pyarrow_is_sparse_split_coo_tensor, "int (PyObject *)") < 0) goto bad;
