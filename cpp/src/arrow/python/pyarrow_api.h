...
static PyObject *(*__pyx_api_f_7pyarrow_3lib_pyarrow_wrap_table)(PyObject *, std::shared_ptr< arrow::Table>  const &) = 0;
...
static int import_pyarrow__lib(void) {
  ...
  if (__Pyx_ImportFunction(module, "pyarrow_wrap_table", (void (**)(void))&__pyx_api_f_7pyarrow_3lib_pyarrow_wrap_table, "PyObject *(PyObject *, std::shared_ptr< arrow::Table>  const &)") < 0) goto bad;
