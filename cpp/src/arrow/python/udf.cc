...
//   Status st;
//   auto func = std::make_shared<cp::ScalarFunction>(this->func_name_, this->arity_, &this->func_doc_);
//   Py_XINCREF(this->function_);
//   PyObject* function = this->function_;
//   // lambda function 
...
//   cp::ScalarKernel kernel(this->in_types_, this->out_type_, call_back_lambda);
