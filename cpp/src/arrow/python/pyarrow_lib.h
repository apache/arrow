...
__PYX_EXTERN_C PyObject *__pyx_f_7pyarrow_3lib_pyarrow_wrap_sparse_split_coo_tensor(std::shared_ptr< arrow::SparseSplitCOOTensor>  const &);
...
__PYX_EXTERN_C std::shared_ptr< arrow::SparseSplitCOOTensor>  __pyx_f_7pyarrow_3lib_pyarrow_unwrap_sparse_split_coo_tensor(PyObject *);
