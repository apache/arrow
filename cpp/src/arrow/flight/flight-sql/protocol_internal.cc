...
#include "arrow/flight/flight-sql/protocol_internal.h"
...
#include "arrow/flight/flight-sql/FlightSql.grpc.pb.cc"  // NOLINT
#include "arrow/flight/flight-sql/FlightSql.pb.cc"       // NOLINT
