...
/// \return the cache.
inline sql_info_id_to_result_t GetSqlInfoIdToResult() {
  return {{flight_sql_pb::SqlInfo::FLIGHT_SQL_SERVER_NAME, std::string("db_name")},
          {flight_sql_pb::SqlInfo::FLIGHT_SQL_SERVER_VERSION, std::string("sqlite 3")},
          {flight_sql_pb::SqlInfo::FLIGHT_SQL_SERVER_ARROW_VERSION,
           std::string("7.0.0-SNAPSHOT" /* Only an example */)},
          {flight_sql_pb::SqlInfo::FLIGHT_SQL_SERVER_READ_ONLY, false},
          {flight_sql_pb::SqlInfo::SQL_DDL_CATALOG,
           false /* SQLite 3 does not support catalogs */},
          {flight_sql_pb::SqlInfo::SQL_DDL_SCHEMA,
           false /* SQLite 3 does not support schemas */},
          {flight_sql_pb::SqlInfo::SQL_DDL_TABLE, true},
          {flight_sql_pb::SqlInfo::SQL_IDENTIFIER_CASE,
           int64_t(flight_sql_pb::SqlSupportedCaseSensitivity::
                       SQL_CASE_SENSITIVITY_CASE_INSENSITIVE)},
          {flight_sql_pb::SqlInfo::SQL_IDENTIFIER_QUOTE_CHAR, std::string("\"")},
          {flight_sql_pb::SqlInfo::SQL_QUOTED_IDENTIFIER_CASE,
           int64_t(flight_sql_pb::SqlSupportedCaseSensitivity::
                       SQL_CASE_SENSITIVITY_CASE_INSENSITIVE)},
          {flight_sql_pb::SqlInfo::SQL_ALL_TABLES_ARE_SELECTABLE, true},
          {flight_sql_pb::SqlInfo::SQL_NULL_ORDERING,
           int64_t(flight_sql_pb::SqlNullOrdering::SQL_NULLS_SORTED_AT_START)},
          {flight_sql_pb::SqlInfo::SQL_KEYWORDS, string_list_t({"ABORT",
                                                                "ACTION",
                                                                "ADD",
                                                                "AFTER",
                                                                "ALL",
          ...
          {flight_sql_pb::SqlInfo::SQL_NUMERIC_FUNCTIONS,
           string_list_t({"acos",  "acosh", "asin",    "asinh", "atan",  "atan2",
          ...
          {flight_sql_pb::SqlInfo::SQL_STRING_FUNCTIONS,
           string_list_t({"SUBSTR", "TRIM", "LTRIM", "RTRIM", "LENGTH", "REPLACE",
                          "UPPER", "LOWER", "INSTR"})},
