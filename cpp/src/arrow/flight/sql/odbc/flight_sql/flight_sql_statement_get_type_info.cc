...
std::shared_ptr<Schema> GetTypeInfo_V2_Schema() {
  return schema({
      field("TYPE_NAME", utf8(), false),    field("DATA_TYPE", int16(), false),
      field("PRECISION", int32()),          field("LITERAL_PREFIX", utf8()),
      field("LITERAL_SUFFIX", utf8()),      field("CREATE_PARAMS", utf8()),
      field("NULLABLE", int16(), false),    field("CASE_SENSITIVE", int16(), false),
      field("SEARCHABLE", int16(), false),  field("UNSIGNED_ATTRIBUTE", int16()),
      field("MONEY", int16(), false),       field("AUTO_INCREMENT", int16()),
      field("LOCAL_TYPE_NAME", utf8()),     field("MINIMUM_SCALE", int16()),
      field("MAXIMUM_SCALE", int16()),      field("SQL_DATA_TYPE", int16(), false),
      field("SQL_DATETIME_SUB", int16()),   field("NUM_PREC_RADIX", int32()),
      field("INTERVAL_PRECISION", int16()),
  });
}
