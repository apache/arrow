...
class TestCallScalarFunction : public TestComputeInternals {
 protected:
  ...
  void AddCopyFunctions() {
    ...
    // (preallocated) output
    auto func =
        std::make_shared<ScalarFunction>("test_copy", Arity::Unary(), FunctionDoc{});
  ...
  void AddStatefulFunction() {
    ...
    auto func =
        std::make_shared<ScalarFunction>("test_stateful", Arity::Unary(), FunctionDoc{});
