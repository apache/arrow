...
TEST(Cast, StringToInt) {
  for (auto string_type : {utf8(), large_utf8()}) {
    for (auto signed_type : {int8(), int16(), int32(), int64()}) {
      CheckCast(ArrayFromJSON(string_type, R"(["0", null, "127", "-1", "0", "0x0", "0x7F"])"),
    ...
    CheckCast(ArrayFromJSON(
                  string_type, R"(["9223372036854775807", null, "-9223372036854775808", "0", 
    ...
    for (auto unsigned_type : {uint8(), uint16(), uint32(), uint64()}) {
      CheckCast(ArrayFromJSON(string_type, R"(["0", null, "127", "255", "0", "0X0", "0xff", "0x7f])"),
    ...
    CheckCast(ArrayFromJSON(
                  string_type, R"(["9223372036854775807", null, "18446744073709551615", "0", 
