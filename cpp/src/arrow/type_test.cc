...
TEST(TypesTest, DecimalTraits) {
  static_assert(std::same_as<TypeTraits<Decimal32Type>::CType, Decimal32>);
  static_assert(std::same_as<CTypeTraits<Decimal32>::ArrowType, Decimal32Type>);

  static_assert(std::same_as<TypeTraits<Decimal64Type>::CType, Decimal64>);
  static_assert(std::same_as<CTypeTraits<Decimal64>::ArrowType, Decimal64Type>);

  static_assert(std::same_as<TypeTraits<Decimal128Type>::CType, Decimal128>);
  static_assert(std::same_as<CTypeTraits<Decimal128>::ArrowType, Decimal128Type>);

  static_assert(std::same_as<TypeTraits<Decimal256Type>::CType, Decimal256>);
  static_assert(std::same_as<CTypeTraits<Decimal256>::ArrowType, Decimal256Type>);
}
