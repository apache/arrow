...
struct CompareVisitor {
  ...
  Status Visit(const Decimal16Type&) { return CompareValues<Decimal16Type>(); }
  Status Visit(const Decimal32Type&) { return CompareValues<Decimal32Type>(); }
  Status Visit(const Decimal64Type&) { return CompareValues<Decimal64Type>(); }
