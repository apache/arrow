...
static void BM_BufferedOutputStreamSmallWritesToNull(
  ...
  ABORT_NOT_OK(io::BufferedOutputStream::Create(file, kBufferSize, default_memory_pool(),
                                                &buffered_file));
...
static void BM_BufferedOutputStreamSmallWritesToPipe(
  ...
  ABORT_NOT_OK(io::BufferedOutputStream::Create(stream, kBufferSize, default_memory_pool(),
                                                &buffered_stream));
