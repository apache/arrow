...
TEST_F(TestProjector, TestConvertFromInt) {
  ...
  auto array_a = MakeArrowArrayBinary(
      {{0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00},
       {0x00, 0x00, static_cast<const char>(0x88), static_cast<const char>(0xB8), 0x00,
        0x00, 0x00, 0x00},
       {0x00, 0x0E, static_cast<const char>(0xDC), 0x1C},
       {0x07, 0x5B, static_cast<const char>(0xCD), 0x15, 0x00, 0x00},
       {0x00, static_cast<const char>(0xAB), static_cast<const char>(0xCD),
        static_cast<const char>(0xEF)}},
      {true, true, true, true, true});
