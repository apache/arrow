...
TEST_F(TestBooleanExpr, SimpleAnd) {
  ...
  auto a_gt_0 = TreeExprBuilder::MakeFunction("greater_than",
                                              {node_a, literal_0}, boolean());
  auto b_gt_0 = TreeExprBuilder::MakeFunction("greater_than",
                                              {node_b, literal_0}, boolean());
  ...
  exp = MakeArrowArrayBool({false, false, false, false },
  ...
  arrayb = MakeArrowArrayInt32({-2, -2, 2, 2}, {true, false, true, false});
  exp = MakeArrowArrayBool({false, false, true, false },
...
TEST_F(TestBooleanExpr, SimpleOr) {
  ...
  auto arraya = MakeArrowArrayInt32({2, 2, 2, 2}, { true, true, true, true});
  auto arrayb = MakeArrowArrayInt32({-2, -2, 2, 2}, {true, false, true, false});
  auto exp = MakeArrowArrayBool({ true, true, true, true },
                                { true, true, true, true });
  auto in_batch = arrow::RecordBatch::Make(schema, num_records, {arraya, arrayb});
...
TEST_F(TestBooleanExpr, AndThree) {
  ...
  auto b_gt_0 = TreeExprBuilder::MakeFunction("greater_than",
                                              {node_b, literal_0}, boolean());
  auto c_gt_0 = TreeExprBuilder::MakeFunction("greater_than",
                                              {node_c, literal_0}, boolean());
...
TEST_F(TestBooleanExpr, BooleanAndInsideIf) {
  ...
  auto a_gt_1 = TreeExprBuilder::MakeFunction("greater_than",
                                              {node_a, literal_1}, boolean());
  auto a_gt_2 = TreeExprBuilder::MakeFunction("greater_than",
                                              {node_a, literal_2}, boolean());
  auto a_gt_3 = TreeExprBuilder::MakeFunction("greater_than",
                                              {node_a, literal_3}, boolean());
  auto b_gt_1 = TreeExprBuilder::MakeFunction("greater_than",
                                              {node_b, literal_1}, boolean());
  auto b_gt_2 = TreeExprBuilder::MakeFunction("greater_than",
                                              {node_b, literal_2}, boolean());
  auto b_gt_3 = TreeExprBuilder::MakeFunction("greater_than",
                                              {node_b, literal_3}, boolean());
...
TEST_F(TestBooleanExpr, IfInsideBooleanAnd) {
  ...
  auto literal_2 = TreeExprBuilder::MakeLiteral((int32_t)2);
  auto literal_3 = TreeExprBuilder::MakeLiteral((int32_t)3);
  auto a_gt_b = TreeExprBuilder::MakeFunction("greater_than",
                                              {node_a, node_b}, boolean());
  auto a_gt_2 = TreeExprBuilder::MakeFunction("greater_than",
                                              {node_a, literal_2}, boolean());
  auto a_gt_3 = TreeExprBuilder::MakeFunction("greater_than",
                                              {node_a, literal_3}, boolean());
