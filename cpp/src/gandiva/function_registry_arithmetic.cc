...
#define UNARY_CAST_TO_FLOAT64(name) \
  UNARY_SAFE_NULL_IF_NULL(castFLOAT8, ({}), name, float64)

#define UNARY_CAST_TO_FLOAT32(name) \
  UNARY_SAFE_NULL_IF_NULL(castFLOAT4, ({}), name, float32)
