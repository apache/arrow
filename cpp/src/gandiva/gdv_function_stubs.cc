...
#define SHA128_HASH_FUNCTION(TYPE)                                                    \
  ...
  const char *gdv_fn_sha128_##TYPE(int64_t context, gdv_##TYPE value,                 \
    ...
    if (!validity) {                                                                  \
      return gandiva::HashUtils::HashUsingSha128(context, NULLPTR,                    \
                                                 0, out_length);                      \
    }                                                                                 \
...
const char* gdv_fn_sha128_decimal128(int64_t context, int64_t x_high, uint64_t x_low,
  ...
  const auto &decimal_128 = gandiva::BasicDecimal128(x_high, x_low);
  return gandiva::HashUtils::HashUsingSha128(context, decimal_128.ToBytes().data(),
                                             16, out_length);
}
...
void ExportedStubFunctions::AddMappings(Engine* engine) const {
  ...
  engine->AddGlobalMappingForFunc("gdv_fn_castFLOAT8_utf8", types->double_type(), args,
    ...
    engine->AddGlobalMappingForFunc("gdv_fn_sha128_int8",
                                    types->i8_ptr_type() /*return_type*/, args,
                                    reinterpret_cast<void *>(gdv_fn_sha128_int8));
    ...
    engine->AddGlobalMappingForFunc("gdv_fn_sha128_int16",
                                    types->i8_ptr_type() /*return_type*/, args,
                                    reinterpret_cast<void *>(gdv_fn_sha128_int16));
    ...
    engine->AddGlobalMappingForFunc("gdv_fn_sha128_int32",
                                    types->i8_ptr_type() /*return_type*/, args,
                                    reinterpret_cast<void *>(gdv_fn_sha128_int32));
    ...
    engine->AddGlobalMappingForFunc("gdv_fn_sha128_int64",
                                    types->i8_ptr_type() /*return_type*/, args,
                                    reinterpret_cast<void *>(gdv_fn_sha128_int64));
    ...
    engine->AddGlobalMappingForFunc("gdv_fn_sha128_uint8",
                                    types->i8_ptr_type() /*return_type*/, args,
                                    reinterpret_cast<void *>(gdv_fn_sha128_uint8));

    // gdv_fn_sha128_uint16
    args = {
            types->i64_type(),       // context
            types->i16_type(),      // value
            types->i1_type(),        // validity
    ...
    engine->AddGlobalMappingForFunc("gdv_fn_sha128_uint16",
                                    types->i8_ptr_type() /*return_type*/, args,
                                    reinterpret_cast<void *>(gdv_fn_sha128_uint16));

    // gdv_fn_sha128_uint32
    args = {
            types->i64_type(),       // context
            types->i32_type(),      // value
            types->i1_type(),        // validity
    ...
    engine->AddGlobalMappingForFunc("gdv_fn_sha128_uint32",
                                    types->i8_ptr_type() /*return_type*/, args,
                                    reinterpret_cast<void *>(gdv_fn_sha128_uint32));

    // gdv_fn_sha128_uint64
    args = {
            types->i64_type(),       // context
            types->i64_type(),      // value
            types->i1_type(),        // validity
    ...
    engine->AddGlobalMappingForFunc("gdv_fn_sha128_uint64",
                                    types->i8_ptr_type() /*return_type*/, args,
                                    reinterpret_cast<void *>(gdv_fn_sha128_uint64));

    // gdv_fn_sha128_float32
    args = {
            types->i64_type(),      // context
    ...
    engine->AddGlobalMappingForFunc("gdv_fn_sha128_float32",
                                    types->i8_ptr_type() /*return_type*/, args,
                                    reinterpret_cast<void *>(gdv_fn_sha128_float32));
    ...
    engine->AddGlobalMappingForFunc("gdv_fn_sha128_float64",
                                    types->i8_ptr_type() /*return_type*/, args,
                                    reinterpret_cast<void *>(gdv_fn_sha128_float64));

    // gdv_fn_sha128_boolean
    args = {
            types->i64_type(),       // context
            types->i1_type(),    // value
            types->i1_type(),        // validity
    ...
    engine->AddGlobalMappingForFunc("gdv_fn_sha128_boolean",
                                    types->i8_ptr_type() /*return_type*/, args,
                                    reinterpret_cast<void *>(gdv_fn_sha128_boolean));

    // gdv_fn_sha128_date64
    args = {
            types->i64_type(),       // context
            types->i64_type(),    // value
            types->i1_type(),        // validity
    ...
    engine->AddGlobalMappingForFunc("gdv_fn_sha128_date64",
                                    types->i8_ptr_type() /*return_type*/, args,
                                    reinterpret_cast<void *>(gdv_fn_sha128_date64));

    // gdv_fn_sha128_date32
    args = {
            types->i64_type(),       // context
            types->i32_type(),    // value
            types->i1_type(),        // validity
    ...
    engine->AddGlobalMappingForFunc("gdv_fn_sha128_date32",
                                    types->i8_ptr_type() /*return_type*/, args,
                                    reinterpret_cast<void *>(gdv_fn_sha128_date32));

    // gdv_fn_sha128_time32
    args = {
            types->i64_type(),       // context
            types->i32_type(),    // value
            types->i1_type(),        // validity
    ...
    engine->AddGlobalMappingForFunc("gdv_fn_sha128_time32",
                                    types->i8_ptr_type() /*return_type*/, args,
                                    reinterpret_cast<void *>(gdv_fn_sha128_time32));

    // gdv_fn_sha128_timestamp
    args = {
            types->i64_type(),       // context
            types->i64_type(),    // value
            types->i1_type(),        // validity
    ...
    engine->AddGlobalMappingForFunc("gdv_fn_sha128_timestamp",
                                    types->i8_ptr_type() /*return_type*/, args,
                                    reinterpret_cast<void *>(gdv_fn_sha128_timestamp));
    ...
    engine->AddGlobalMappingForFunc("gdv_fn_sha128_utf8",
                                    types->i8_ptr_type() /*return_type*/, args,
                                    reinterpret_cast<void *>(gdv_fn_sha128_utf8));

    // gdv_fn_hash_sha128_from_binary
    args = {
            types->i64_type(),      // context
            types->i8_ptr_type(),   // const char*
            types->i32_type(),      // value_length
    ...
    engine->AddGlobalMappingForFunc("gdv_fn_sha128_binary",
                                    types->i8_ptr_type() /*return_type*/, args,
                                    reinterpret_cast<void *>(gdv_fn_sha128_binary));
  ...
  engine->AddGlobalMappingForFunc("gdv_fn_sha128_decimal128",
                                  types->i8_ptr_type() /*return_type*/, args,
                                  reinterpret_cast<void *>(gdv_fn_sha128_decimal128));
