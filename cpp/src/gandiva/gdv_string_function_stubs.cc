...
void ExportedStringFunctions::AddMappings(Engine* engine) const {
  ...
  engine->AddGlobalMappingForFunc("gdv_fn_encode", types->i8_ptr_type() /*return_type*/,
                                  args, reinterpret_cast<void*>(gdv_fn_encode));
  ...
  engine->AddGlobalMappingForFunc("gdv_fn_decode", types->i8_ptr_type() /*return_type*/,
                                  args, reinterpret_cast<void*>(gdv_fn_decode));
