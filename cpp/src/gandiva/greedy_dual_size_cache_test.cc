...
TEST_F(TestGreedyDualSizeCache, TestEvict) {
  ...
  cache_.insert(GreedyDualSizeCacheKey(2), ValueCacheObject<std::string>("bye", 10));
  cache_.insert(GreedyDualSizeCacheKey(3), ValueCacheObject<std::string>("bye", 20));
  cache_.insert(GreedyDualSizeCacheKey(4), ValueCacheObject<std::string>("bye", 15));
  cache_.insert(GreedyDualSizeCacheKey(1), ValueCacheObject<std::string>("bye", 1));
  ...
  ASSERT_EQ(cache_.get(GreedyDualSizeCacheKey(1))->module, "bye");
  ASSERT_EQ(cache_.get(GreedyDualSizeCacheKey(4))->module, "bye");
}
...
TEST_F(TestGreedyDualSizeCache, TestGreedyDualSizeBehavior) {
  ...
  cache_.insert(GreedyDualSizeCacheKey(1), ValueCacheObject<std::string>("bye", 40));
  cache_.insert(GreedyDualSizeCacheKey(2), ValueCacheObject<std::string>("bye", 20));
  cache_.insert(GreedyDualSizeCacheKey(3), ValueCacheObject<std::string>("bye", 30));
  ...
  ASSERT_EQ(cache_.get(GreedyDualSizeCacheKey(3))->module, "bye");
  ...
  ASSERT_EQ(cache_.get(GreedyDualSizeCacheKey(2))->module, "bye");
  cache_.insert(GreedyDualSizeCacheKey(1), ValueCacheObject<std::string>("bye", 20));
