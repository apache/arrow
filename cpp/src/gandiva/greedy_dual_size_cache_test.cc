...
TEST_F(TestGreedyDualSizeCache, TestEvict) {
  ...
  cache_.InsertObjectCode(GreedyDualSizeCacheKey(1),
                          ValueCacheObject<std::string>("1", 1, 1));
  cache_.InsertObjectCode(GreedyDualSizeCacheKey(2),
                          ValueCacheObject<std::string>("2", 10, 10));
  cache_.InsertObjectCode(GreedyDualSizeCacheKey(3),
                          ValueCacheObject<std::string>("3", 20, 20));
  cache_.InsertObjectCode(GreedyDualSizeCacheKey(4),
                          ValueCacheObject<std::string>("4", 15, 15));
  cache_.InsertObjectCode(GreedyDualSizeCacheKey(1),
                          ValueCacheObject<std::string>("5", 1, 1));
...
TEST_F(TestGreedyDualSizeCache, TestGreedyDualSizeBehavior) {
  ...
  cache_.InsertObjectCode(GreedyDualSizeCacheKey(1),
                          ValueCacheObject<std::string>("1", 40, 40));
  cache_.InsertObjectCode(GreedyDualSizeCacheKey(2),
                          ValueCacheObject<std::string>("2", 20, 20));
  cache_.InsertObjectCode(GreedyDualSizeCacheKey(3),
                          ValueCacheObject<std::string>("3", 30, 30));
  ...
  cache_.InsertObjectCode(GreedyDualSizeCacheKey(1),
                          ValueCacheObject<std::string>("1", 20, 20));
