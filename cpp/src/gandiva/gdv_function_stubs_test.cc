...
TEST(TestGdvFnStubs, TestConcatWs) {
  ...
  const char* out = gdv_fn_concat_ws_utf8_utf8(ctx_ptr, separator, sep_len, word1,
                                               word1_len, word2, word2_len, &out_len);
  ...
  out = gdv_fn_concat_ws_utf8_utf8_utf8(ctx_ptr, separator, sep_len, word1, word1_len,
                                        word2, word2_len, word3, word3_len, &out_len);
  ...
  out = gdv_fn_concat_ws_utf8_utf8_utf8_utf8(ctx_ptr, separator, sep_len, word1,
                                             word1_len, word2, word2_len, word3,
                                             word3_len, word4, word4_len, &out_len);
  ...
  out = gdv_fn_concat_ws_utf8_utf8_utf8_utf8_utf8(
      ctx_ptr, separator, sep_len, word1, word1_len, word2, word2_len, word3, word3_len,
