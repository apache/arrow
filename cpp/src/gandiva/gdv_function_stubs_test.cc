...
TEST(TestGdvFnStubs, TestEltFunction) {
  ...
  auto out_string =
      gdv_fn_elt_int32_utf8_utf8(ctx_ptr, 1, true, word1, word1_len, true, word2,
  ...
  out_string = gdv_fn_elt_int32_utf8_utf8(ctx_ptr, 2, true, word1, word1_len, true, word2,
                                          word2_len, true, &out_vality, &out_len);
  ...
  word2 = "world";
  word2_len = static_cast<int32_t>(strlen(word2));
  out_string = gdv_fn_elt_int32_utf8_utf8(ctx_ptr, 4, true, word1, word1_len, true, word2,
                                          word2_len, true, &out_vality, &out_len);
  ...
  word2 = "yeah";
  word2_len = static_cast<int32_t>(strlen(word2));
  out_string = gdv_fn_elt_int32_utf8_utf8(ctx_ptr, 0, true, word1, word1_len, true, word2,
                                          word2_len, true, &out_vality, &out_len);
  EXPECT_EQ("", std::string(out_string, out_len));
  EXPECT_EQ(out_vality, false);
  ...
  out_string = gdv_fn_elt_int32_utf8_utf8_utf8(ctx_ptr, 3, true, word1, word1_len, true,
                                               word2, word2_len, true, word3, word3_len,
  ...
  out_string = gdv_fn_elt_int32_utf8_utf8_utf8_utf8(
