...
void add_large_decimal128_decimal128(int64_t x_high, uint64_t x_low, int32_t x_precision,
  ...
  gandiva::DecimalBasicScalar128 x(x_high, x_low, x_precision, x_scale);
  gandiva::DecimalBasicScalar128 y(y_high, y_low, y_precision, y_scale);

  arrow::DecimalBasic128 out = gandiva::decimalops::Add(x, y, out_precision, out_scale);
