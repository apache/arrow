...
TEST(TestStringOps, TestConvertUtf8) {
  ...
  const char* a_str = convert_fromUTF8_binary(
      ctx_ptr, a.data(), a_in_out_len, &a_in_out_len);
  ...
  const char* b_str = convert_fromUTF8_binary(
      ctx_ptr, b.data(), b_in_out_len, &b_in_out_len);
