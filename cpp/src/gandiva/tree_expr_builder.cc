...
NodePtr TreeExprBuilder::MakeNull(DataTypePtr data_type) {
  ...
  switch (data_type->id()) {
    ...
    case arrow::Type::FLOAT:
      return std::make_shared<LiteralNode>(data_type, LiteralHolder(static_cast<float>(0)), true);
    case arrow::Type::DOUBLE:
      return std::make_shared<LiteralNode>(data_type, LiteralHolder(static_cast<double>(0)), true);
