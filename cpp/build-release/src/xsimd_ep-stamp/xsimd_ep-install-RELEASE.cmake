...
set(stdout_log "/Users/simon/Desktop/arrow/arrowSF/cpp/build-release/src/xsimd_ep-stamp/xsimd_ep-install-out.log")
set(stderr_log "/Users/simon/Desktop/arrow/arrowSF/cpp/build-release/src/xsimd_ep-stamp/xsimd_ep-install-err.log")
execute_process(
  COMMAND ${command}
...
if(result)
  ...
  if (${log_merged})
    ...
    set(msg "${msg}\nSee also\n  /Users/simon/Desktop/arrow/arrowSF/cpp/build-release/src/xsimd_ep-stamp/xsimd_ep-install-*.log")
  endif()
  ...
  if(NOT "Unix Makefiles" MATCHES "Ninja")
    set(msg "xsimd_ep install command succeeded.  See also /Users/simon/Desktop/arrow/arrowSF/cpp/build-release/src/xsimd_ep-stamp/xsimd_ep-install-*.log")
    message(STATUS "${msg}")
  endif()
endif()
