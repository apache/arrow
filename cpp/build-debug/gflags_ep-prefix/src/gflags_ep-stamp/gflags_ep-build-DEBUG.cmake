...
set(stdout_log "/Users/simon/Desktop/arrow/arrowSF/cpp/build-debug/gflags_ep-prefix/src/gflags_ep-stamp/gflags_ep-build-out.log")
set(stderr_log "/Users/simon/Desktop/arrow/arrowSF/cpp/build-debug/gflags_ep-prefix/src/gflags_ep-stamp/gflags_ep-build-err.log")
execute_process(
  COMMAND ${command}
...
if(result)
  ...
  if (${log_merged})
    ...
    set(msg "${msg}\nSee also\n  /Users/simon/Desktop/arrow/arrowSF/cpp/build-debug/gflags_ep-prefix/src/gflags_ep-stamp/gflags_ep-build-*.log")
  endif()
  ...
  if(NOT "Unix Makefiles" MATCHES "Ninja")
    set(msg "gflags_ep build command succeeded.  See also /Users/simon/Desktop/arrow/arrowSF/cpp/build-debug/gflags_ep-prefix/src/gflags_ep-stamp/gflags_ep-build-*.log")
    message(STATUS "${msg}")
  endif()
endif()
