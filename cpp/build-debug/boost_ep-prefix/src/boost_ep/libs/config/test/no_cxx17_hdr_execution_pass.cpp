...
// Test file for macro BOOST_NO_CXX17_HDR_EXECUTION
// This file should compile, if it does not then
// BOOST_NO_CXX17_HDR_EXECUTION should be defined.
// See file boost_no_cxx17_hdr_execution.ipp for details
...
int main( int, char *[] )
{
   return boost_no_cxx17_hdr_execution::test();
}
