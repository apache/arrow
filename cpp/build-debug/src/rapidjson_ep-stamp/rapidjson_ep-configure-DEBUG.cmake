...
if(result)
  ...
  if (${log_merged})
    ...
    set(msg "${msg}\nSee also\n  /Users/simon/Desktop/arrow/arrowSF/cpp/build-debug/src/rapidjson_ep-stamp/rapidjson_ep-configure-*.log")
  endif()
  ...
  if(NOT "Unix Makefiles" MATCHES "Ninja")
    set(msg "rapidjson_ep configure command succeeded.  See also /Users/simon/Desktop/arrow/arrowSF/cpp/build-debug/src/rapidjson_ep-stamp/rapidjson_ep-configure-*.log")
    message(STATUS "${msg}")
  endif()
endif()
