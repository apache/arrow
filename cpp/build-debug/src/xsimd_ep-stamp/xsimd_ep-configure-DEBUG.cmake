...
if(result)
  ...
  if (${log_merged})
    ...
    set(msg "${msg}\nSee also\n  /Users/simon/Desktop/arrow/arrowSF/cpp/build-debug/src/xsimd_ep-stamp/xsimd_ep-configure-*.log")
  endif()
  ...
  if(NOT "Unix Makefiles" MATCHES "Ninja")
    set(msg "xsimd_ep configure command succeeded.  See also /Users/simon/Desktop/arrow/arrowSF/cpp/build-debug/src/xsimd_ep-stamp/xsimd_ep-configure-*.log")
    message(STATUS "${msg}")
  endif()
endif()
