...
set(stdout_log "/Users/simon/Desktop/arrow/arrowSF/cpp/build-debug/src/xsimd_ep-stamp/xsimd_ep-build-out.log")
set(stderr_log "/Users/simon/Desktop/arrow/arrowSF/cpp/build-debug/src/xsimd_ep-stamp/xsimd_ep-build-err.log")
execute_process(
  COMMAND ${command}
...
if(result)
  ...
  if (${log_merged})
    ...
    set(msg "${msg}\nSee also\n  /Users/simon/Desktop/arrow/arrowSF/cpp/build-debug/src/xsimd_ep-stamp/xsimd_ep-build-*.log")
  endif()
  ...
  if(NOT "Unix Makefiles" MATCHES "Ninja")
    set(msg "xsimd_ep build command succeeded.  See also /Users/simon/Desktop/arrow/arrowSF/cpp/build-debug/src/xsimd_ep-stamp/xsimd_ep-build-*.log")
    message(STATUS "${msg}")
  endif()
endif()
