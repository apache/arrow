...
$IMPALA_HOME/bin/impala-shell.sh -q "SET COMPRESSION_CODEC=NONE;INSERT INTO TABLE  export_all_types_table_u_10k SELECT * FROM all_types_table_u_10M ORDER BY boolean_field,int32_field,int64_field,int96_field,float_field,double_field,ba_field LIMIT 10000 OFFSET 0;"
$IMPALA_HOME/bin/impala-shell.sh -q "SET COMPRESSION_CODEC=NONE;INSERT INTO TABLE  export_all_types_table_u_100k SELECT * FROM all_types_table_u_10M ORDER BY boolean_field,int32_field,int64_field,int96_field,float_field,double_field,ba_field LIMIT 100000 OFFSET 0;"
$IMPALA_HOME/bin/impala-shell.sh -q "SET COMPRESSION_CODEC=NONE;INSERT INTO TABLE  export_all_types_table_u_1M SELECT * FROM all_types_table_u_10M ORDER BY boolean_field,int32_field,int64_field,int96_field,float_field,double_field,ba_field LIMIT 1000000 OFFSET 0;"
$IMPALA_HOME/bin/impala-shell.sh -q "SET COMPRESSION_CODEC=NONE;INSERT INTO TABLE  export_all_types_table_u_10M SELECT * FROM all_types_table_u_10M ORDER BY boolean_field,int32_field,int64_field,int96_field,float_field,double_field,ba_field LIMIT 10000000 OFFSET 0;"
