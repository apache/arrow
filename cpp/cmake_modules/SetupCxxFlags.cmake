...
# We let the user override those flags by passing CMAKE_C_FLAGS and CMAKE_CXX_FLAGS.
message(
  "Configured for ${CMAKE_BUILD_TYPE} build (set with cmake -DCMAKE_BUILD_TYPE={release,debug,...})"
  )
if("${CMAKE_BUILD_TYPE}" STREQUAL "DEBUG")
  set(CMAKE_C_FLAGS "${C_FLAGS_DEBUG} ${CMAKE_C_FLAGS}")
  set(CMAKE_CXX_FLAGS "${CXX_FLAGS_DEBUG} ${CMAKE_CXX_FLAGS}")
elseif("${CMAKE_BUILD_TYPE}" STREQUAL "RELWITHDEBINFO")

elseif("${CMAKE_BUILD_TYPE}" STREQUAL "FASTDEBUG")
  set(CMAKE_C_FLAGS "${C_FLAGS_FASTDEBUG} ${CMAKE_C_FLAGS} ")
  set(CMAKE_CXX_FLAGS "${CXX_FLAGS_FASTDEBUG} ${CMAKE_CXX_FLAGS}")
elseif("${CMAKE_BUILD_TYPE}" STREQUAL "RELEASE")
  set(CMAKE_C_FLAGS "${C_FLAGS_RELEASE} ${CMAKE_C_FLAGS}")
  set(CMAKE_CXX_FLAGS "${CXX_FLAGS_RELEASE} ${CMAKE_CXX_FLAGS}")
elseif("${CMAKE_BUILD_TYPE}" STREQUAL "PROFILE_GEN")
  set(CMAKE_C_FLAGS "${C_FLAGS_PROFILE_GEN} ${CMAKE_C_FLAGS}")
  set(CMAKE_CXX_FLAGS "${CXX_FLAGS_PROFILE_GEN} ${CMAKE_CXX_FLAGS}")
elseif("${CMAKE_BUILD_TYPE}" STREQUAL "PROFILE_BUILD")
  set(CMAKE_C_FLAGS "${C_FLAGS_PROFILE_BUILD} ${CMAKE_C_FLAGS}")
  set(CMAKE_CXX_FLAGS "${CXX_FLAGS_PROFILE_BUILD} ${CMAKE_CXX_FLAGS}")
else()
