...
find_clang_tool(
  ...
  "LLVM version ${ARROW_CLANG_TOOLS_VERSION_MAJOR}\\.${ARROW_CLANG_TOOLS_VERSION_MINOR}")
if(CLANG_TIDY_BIN)
...
find_clang_tool(
  ...
  "^clang-format version ${ARROW_CLANG_TOOLS_VERSION_MAJOR}\\.${ARROW_CLANG_TOOLS_VERSION_MINOR}"
  )
if(CLANG_FORMAT_BIN)
