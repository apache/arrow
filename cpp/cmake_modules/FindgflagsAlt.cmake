...
if(gflags_ROOT)
  find_library(gflags_LIB NAMES gflags PATHS ${gflags_ROOT} PATH_SUFFIXES ${LIB_PATH_SUFFIXES} NO_DEFAULT_PATH)
  ...
  find_path(GFLAGS_INCLUDE_DIR NAMES gflags/gflags.h PATH_SUFFIXES ${INCLUDE_PATH_SUFFIXES})
endif()
