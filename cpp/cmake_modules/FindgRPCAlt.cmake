...
set(gRPCAlt_CMAKE_PREFIX_PATH "${CMAKE_PREFIX_PATH}")
if(APPLE)
  find_program(BREW brew)
  if(BREW)
    execute_process(COMMAND ${BREW} --prefix "grpc@1.54"
                    OUTPUT_VARIABLE GRPC_BREW_PREFIX
                    OUTPUT_STRIP_TRAILING_WHITESPACE)
    if(GRPC_BREW_PREFIX)
      list(PREPEND CMAKE_PREFIX_PATH ${GRPC_BREW_PREFIX})
    endif()
  endif()
endif()
find_package(gRPC ${find_package_args})
set(CMAKE_PREFIX_PATH "${gRPCAlt_CMAKE_PREFIX_PATH}")
if(gRPC_FOUND)
