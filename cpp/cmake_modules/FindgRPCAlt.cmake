...
find_package_handle_standard_args(gRPCAlt
  REQUIRED_VARS GRPC_INCLUDE_DIR GRPC_GPR_LIB GRPC_GRPC_LIB GRPC_GRPCPP_LIB GRPC_CPP_PLUGIN)
...
if (gRPCAlt_FOUND)
  ...
  set_target_properties(gRPC::grpc PROPERTIES
    IMPORTED_LOCATION "${GRPC_GRPC_LIB}"
    INTERFACE_INCLUDE_DIRECTORIES "${GRPC_INCLUDE_DIR}"
  )

  add_library(gRPC::grpc++ UNKNOWN IMPORTED)
  set_target_properties(gRPC::grpc++ PROPERTIES
    IMPORTED_LOCATION "${GRPC_GRPCPP_LIB}"
    INTERFACE_INCLUDE_DIRECTORIES "${GRPC_INCLUDE_DIR}"
  )
  ...
  if (GRPC_ADDRESS_SORTING_LIB)
    ...
    set_target_properties(gRPC::address_sorting PROPERTIES
      IMPORTED_LOCATION "${GRPC_ADDRESS_SORTING_LIB}"
      INTERFACE_INCLUDE_DIRECTORIES "${GRPC_INCLUDE_DIR}"
    )
 endif()
