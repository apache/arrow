...
macro(prepare_fetchcontent)
  ...
  set(CMAKE_COMPILE_WARNING_AS_ERROR FALSE CACHE BOOL "" FORCE)
  set(CMAKE_EXPORT_NO_PACKAGE_REGISTRY TRUE CACHE BOOL "" FORCE)
  set(CMAKE_LIBRARY_OUTPUT_DIRECTORY "" CACHE PATH "" FORCE)
  set(CMAKE_MACOSX_RPATH ${ARROW_INSTALL_NAME_RPATH} CACHE BOOL "" FORCE)
  # We set CMAKE_POLICY_VERSION_MINIMUM temporarily due to failures with CMake 4
  # We should remove it once we have updated the dependencies:
  # https://github.com/apache/arrow/issues/45985
