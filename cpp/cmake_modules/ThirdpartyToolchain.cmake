...
if(ARROW_DEPENDENCY_SOURCE STREQUAL "VCPKG")
  ...
  include_directories(SYSTEM "${_VCPKG_INSTALLED_DIR}/${VCPKG_TARGET_TRIPLET}/lib")
...
if(ARROW_VCPKG)
  if(NOT DEFINED OPENSSL_INCLUDE_DIR)
    set(OPENSSL_INCLUDE_DIR "${_VCPKG_INSTALLED_DIR}/${VCPKG_TARGET_TRIPLET}/include" CACHE STRING "")
  endif()
  if(NOT DEFINED OPENSSL_ROOT_DIR)
    set(OPENSSL_ROOT_DIR "${_VCPKG_INSTALLED_DIR}/${VCPKG_TARGET_TRIPLET}" CACHE STRING "")
  endif()
  if(NOT DEFINED OPENSSL_LIBRARIES)
    set(OPENSSL_LIBRARIES "${_VCPKG_INSTALLED_DIR}/${VCPKG_TARGET_TRIPLET}/lib" CACHE STRING "")
  endif()
