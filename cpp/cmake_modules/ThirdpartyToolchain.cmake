...
if (DEFINED ENV{ARROW_DOUBLE_CONVERSION_URL})
  set(ARROW_DOUBLE_CONVERSION_URL "$ENV{ARROW_DOUBLE_CONVERSION_URL}")
else()
  set(ARROW_DOUBLE_CONVERSION_URL "https://github.com/google/double-conversion/archive/${DOUBLE_CONVERSION_VERSION}.tar.gz")
endif()
...
if("${DOUBLE_CONVERSION_HOME}" STREQUAL "")
  ...
  ExternalProject_Add(double-conversion_ep
    ...
    URL ${ARROW_DOUBLE_CONVERSION_URL}
