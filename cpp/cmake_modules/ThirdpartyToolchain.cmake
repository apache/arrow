...
# Lz4
  ...
  if("${LZ4_HOME}" STREQUAL "")
    ...
    if (MSVC)
      ...
      if(MSVC_TOOLSET_VERSION VERSION_LESS_EQUAL "140")
  	...
  	set(LZ4_BUILD_COMMAND BUILD_COMMAND msbuild.exe /m /p:Configuration=${CMAKE_BUILD_TYPE} /p:Platform=x64 /p:PlatformToolset=v140
        ...
        set(LZ4_STATIC_LIB "${LZ4_BUILD_DIR}/visual/VS2017/bin/x64_${CMAKE_BUILD_TYPE}/liblz4_static.lib")
	set(LZ4_BUILD_COMMAND BUILD_COMMAND msbuild.exe /m /p:Configuration=${CMAKE_BUILD_TYPE} /p:Platform=x64 /p:PlatformToolset=v141
                                          ${LZ4_RUNTIME_LIBRARY_LINKAGE} /t:Build ${LZ4_BUILD_DIR}/visual/VS2017/lz4.sln)
      endif()
    else()
