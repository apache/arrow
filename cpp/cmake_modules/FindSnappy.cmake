...
if(ARROW_SNAPPY_USE_SHARED)
  ...
  if(MSVC)
    set(SNAPPY_SATIC_LIB_NAME_BASE "${SNAPPY_STATIC_LIB_NAME_BASE}${SNAPPY_MSVC_STATIC_LIB_SUFFIX_DEFAULT}")
  endif()
  set(SNAPPY_LIB_NAMES "${CMAKE_STATIC_LIBRARY_PREFIX}${SNAPPY_SATIC_LIB_NAME_BASE}{CMAKE_STATIC_LIBRARY_SUFFIX}")
endif()
