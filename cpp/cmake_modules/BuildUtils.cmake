...
function(ADD_ARROW_LIB LIB_NAME)
  ...
  if(USE_OBJLIB)
    ...
    target_compile_options(${LIB_NAME}_objlib PRIVATE ${LIBARROW_CXX_FLAGS})
  ...
  if(BUILD_SHARED)
    ...
    target_compile_options(${LIB_NAME}_shared PRIVATE ${LIBARROW_CXX_FLAGS})
  ...
  if(BUILD_STATIC)
    ...
    target_compile_options(${LIB_NAME}_static PRIVATE ${LIBARROW_CXX_FLAGS})
