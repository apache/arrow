...
if [ "${have_flight}" = "yes" ]; then
  ...
  ruby -r gi "p GI.load('ArrowFlight')"
  echo "::endgroup::"
fi
...
ruby -r gi "p GI.load('ArrowDataset')"
echo "::endgroup::"
