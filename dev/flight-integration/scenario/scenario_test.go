...
func (s *ScenarioSuite) closeConn() error { return s.conn.Close() }

func (s *ScenarioSuite) resetConn() error {
	var err error
...
func TestScenarios(t *testing.T) {
	suite.Run(t, &ScenarioSuite{})
}

func (s *ScenarioSuite) TestSingleScenario() {
	...
	// 	},
	// )
	// defer scenario.UnregisterScenario("mock_scenario")
...
func (s *ScenarioSuite) TestMultipleScenariosNoDisconnect() {
	srv := integration.NewIntegrationServer(
		scenario.Scenario{
			Name: "mock_scenario1",
			Steps: []scenario.ScenarioStep{
...
func (s *ScenarioSuite) TestMultipleScenariosWithDisconnect() {
	srv := integration.NewIntegrationServer(
		scenario.Scenario{
			Name: "mock_scenario1",
			Steps: []scenario.ScenarioStep{
...
func (s *ScenarioSuite) TestMultipleScenariosWithError() {
	srv := integration.NewIntegrationServer(
		scenario.Scenario{
			Name: "mock_scenario1",
			Steps: []scenario.ScenarioStep{
