...
- [ ] The PR's title follows [existing conventions of the repository](https://arrow.apache.org/docs/developers/overview.html#pull-request-and-review)
- [ ] My code follows the general style and conventions of the codebase
  ([C++](https://arrow.apache.org/docs/developers/cpp/development.html), [Python](https://arrow.apache.org/docs/developers/python/development.html))
