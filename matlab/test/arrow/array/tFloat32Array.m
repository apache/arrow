...
% Tests for arrow.array.Float32rray
    ...
    properties
        ...
        ArrowArrayConstructor = @arrow.array.Float32Array.fromMATLAB
    ...
    methods(Test)
        function InfValues(testCase)
            A1 = testCase.ArrowArrayConstructor(single([Inf -Inf]));
            data = single(A1);
        ...
        function ValidBasic(testCase)
            ...
            arrowArray = testCase.ArrowArrayConstructor(matlabArray);
        ...
        function InferNulls(testCase)
            ...
            arrowArray1 = testCase.ArrowArrayConstructor(matlabArray, InferNulls=true);
            ...
            arrowArray2 = testCase.ArrowArrayConstructor(matlabArray, InferNulls=false);
        ...
        function LogicalValidNVPair(testCase)
            ...
            arrowArray = testCase.ArrowArrayConstructor(matlabArray, Valid=[false; true; true]);
        ...
        function NumericlValidNVPair(testCase)
            ...
            arrowArray = testCase.ArrowArrayConstructor(matlabArray, Valid=[1 3]);
