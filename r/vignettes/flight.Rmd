...
Flight allows for highly efficient data transfer as it removes the need for deserialization during data transfer, allows for parallel data streaming, and is highly optimized to take advantage of Arrow's columnar format.
...
See [the dataset vignette](./dataset.html) for more information on working with Arrow Dataset objects and via a dplyr interface.
