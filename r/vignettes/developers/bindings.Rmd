...
tests.  This is fine - add them to the ones you wrote originally, and run them 
all.  If they pass, you're done! Submit a PR.  If you've modified the C++ code in the 
