...
To see what nightlies are available, you can visit the [nightly build server](https://nightlies.apache.org/arrow/r/libarrow/bin). Version numbers in that repository correspond to dates. See the [distro map](https://raw.githubusercontent.com/apache/arrow/master/r/tools/distro-map.csv) for compatibility between binaries and OSs.
...
To see what nightlies are available, you can visit the [nightly build server](https://nightlies.apache.org/arrow/r/libarrow/bin/windows).
