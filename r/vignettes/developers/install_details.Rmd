...
This setup is much more common for arrow developers, who may be needing to make changes to both the R package and libarrow source code.  See the [developer setup docs](./setup.html) for more information.
