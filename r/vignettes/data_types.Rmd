...
- To learn more how data types are specified through `schema()` metadata, see `vignette("metadata", package = "arrow")`.
- For additional details on data types, see `help("data-type", package = "arrow")`.
