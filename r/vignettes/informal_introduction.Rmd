...
- Apache Arrow offers implementations of this _Columnar Format_ in several languages (see [here]() for the list). In particular, there is one implementation in `C++`:  the library called `libarrow`.
