...
The `arrow` R package builds on top of the Arrow C++ library, and C++ is an object oriented language. As a consequence, the core logic of the Arrow C++ library is encapsulated in classes and methods. In the `arrow` R package these are implemented as [`R6`](https://r6.r-lib.org) classes that all adopt "UpperCamelCase" naming conventions. Some examples of these include:
...
All the examples used in this vignette rely on this high-level interface.

To learn more, see `vignette("package_conventions", package = "arrow")`.
...
To learn more about the different data object classes in `arrow`, see `vignette("data_objects", package = "arrow")`.
...
To learn more about data types in Arrow and how they are mapped to R data types, see `vignette("data_types", package = "arrow")`.
...
To learn more about reading and writing individual data files, see `vignette("read_write", package = "arrow")`.
...
To learn more about Arrow Datasets, see `vignette("dataset", package = "arrow")`.
...
To learn more about analyzing Arrow data, see `vignette("data_wrangling", package = "arrow")`.
...
To learn more about the suport for cloud services in `arrow`, see `vignette("cloud_storage", package = "arrow")`.
...
To learn more about passing Arrow data between R and Python, see `vignette("python", package = "arrow")`.
...
For an overview of the development process and a list of related articles for developers, see `vignette("developer_overview", package = "arrow")`.
