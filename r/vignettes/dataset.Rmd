...
Suppose you attempt to call unsupported __dplyr__ verbs or unimplemented functions
in your query on an Arrow Dataset. In that case, the __arrow__ package raises an error. However,
