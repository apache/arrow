...
```{r, eval = FALSE}
arrow::fs_copy("s3://ursa-labs-taxi-data", "nyc-taxi")
```
...
Perhaps, though, `payment_type == 1` is the only data we care about for our
current work, and we just want to drop the rest and have a smaller working set.
