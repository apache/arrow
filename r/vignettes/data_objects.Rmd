...
Metadata objects play an important role in making sure data are represented correctly. To learn more about the metadata classes, see the [metadata article](./metadata.html).
...
- To learn more about the different data types that can be represented in Arrow, see the article on [data types](./data_types.html).
