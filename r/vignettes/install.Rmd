...
automatically when it installs. This section outlines the logic of how that
...
Alternatively, if you've built the Arrow C++ libraries locally from source
...
```
R_DOCKER_ORG=rhub R_DOCKER_IMAGE=ubuntu-gcc-release R_DOCKER_TAG=latest docker-compose build r-hub
R_DOCKER_ORG=rhub R_DOCKER_IMAGE=ubuntu-gcc-release R_DOCKER_TAG=latest docker-compose run r-hub
```
