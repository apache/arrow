...
BEGIN_CPP11
	...
	return cpp11::as_sexp(ExecNode_Write(final_node, schema, file_write_options, filesystem, base_dir, partitioning, basename_template, existing_data_behavior, max_partitions, max_open_files, max_rows_per_file, min_rows_per_group, max_rows_per_group));
END_CPP11
}
#else
extern "C" SEXP _arrow_ExecNode_Write(SEXP final_node_sexp, SEXP schema_sexp, SEXP file_write_options_sexp, SEXP filesystem_sexp, SEXP base_dir_sexp, SEXP partitioning_sexp, SEXP basename_template_sexp, SEXP existing_data_behavior_sexp, SEXP max_partitions_sexp, SEXP max_open_files_sexp, SEXP max_rows_per_file_sexp, SEXP min_rows_per_group_sexp, SEXP max_rows_per_group_sexp){
	Rf_error("Cannot call ExecNode_Write(). See https://arrow.apache.org/docs/r/articles/install.html for help installing Arrow C++ libraries. ");
}
#endif
...
extern "C" SEXP _arrow_ExecPlan_DoWrite(SEXP plan_sexp){
BEGIN_CPP11
	arrow::r::Input<const std::shared_ptr<acero::ExecPlan>&>::type plan(plan_sexp);
	ExecPlan_DoWrite(plan);
	return R_NilValue;
END_CPP11
}
#else
extern "C" SEXP _arrow_ExecPlan_DoWrite(SEXP plan_sexp){
	Rf_error("Cannot call ExecPlan_DoWrite(). See https://arrow.apache.org/docs/r/articles/install.html for help installing Arrow C++ libraries. ");
}
#endif
...
static const R_CallMethodDef CallEntries[] = {
		...
		{ "_arrow_ExecNode_Write", (DL_FUNC) &_arrow_ExecNode_Write, 13}, 
		{ "_arrow_ExecPlan_DoWrite", (DL_FUNC) &_arrow_ExecPlan_DoWrite, 1}, 
