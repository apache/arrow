...
// compute-exec.cpp
std::string ExecPlan_ToString(const std::shared_ptr<compute::ExecPlan>& plan, const std::shared_ptr<compute::ExecNode>& final_node, cpp11::list sort_options, int64_t head);
extern "C" SEXP _arrow_ExecPlan_ToString(SEXP plan_sexp, SEXP final_node_sexp, SEXP sort_options_sexp, SEXP head_sexp){
BEGIN_CPP11
	arrow::r::Input<const std::shared_ptr<compute::ExecPlan>&>::type plan(plan_sexp);
	arrow::r::Input<const std::shared_ptr<compute::ExecNode>&>::type final_node(final_node_sexp);
	arrow::r::Input<cpp11::list>::type sort_options(sort_options_sexp);
	arrow::r::Input<int64_t>::type head(head_sexp);
	return cpp11::as_sexp(ExecPlan_ToString(plan, final_node, sort_options, head));
END_CPP11
}
// compute-exec.cpp
...
static const R_CallMethodDef CallEntries[] = {
		...
		{ "_arrow_ExecPlan_ToString", (DL_FUNC) &_arrow_ExecPlan_ToString, 4}, 
