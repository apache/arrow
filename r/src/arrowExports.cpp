...
// compute-exec.cpp
std::shared_ptr<compute::ExecNode> ExecNode_Aggregate(const std::shared_ptr<compute::ExecNode>& input, cpp11::list options, std::vector<std::string> out_field_names, std::vector<std::string> key_names);
extern "C" SEXP _arrow_ExecNode_Aggregate(SEXP input_sexp, SEXP options_sexp, SEXP out_field_names_sexp, SEXP key_names_sexp){
BEGIN_CPP11
	arrow::r::Input<const std::shared_ptr<compute::ExecNode>&>::type input(input_sexp);
	...
	return cpp11::as_sexp(ExecNode_Aggregate(input, options, out_field_names, key_names));
END_CPP11
}
// compute-exec.cpp
...
static const R_CallMethodDef CallEntries[] = {
		...
		{ "_arrow_ExecNode_Aggregate", (DL_FUNC) &_arrow_ExecNode_Aggregate, 4}, 
