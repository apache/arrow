...
// dataset.cpp
#if defined(ARROW_R_WITH_DATASET)
void dataset___Dataset__Write(const std::shared_ptr<ds::FileWriteOptions>& file_write_options, const std::shared_ptr<fs::FileSystem>& filesystem, std::string base_dir, const std::shared_ptr<ds::Partitioning>& partitioning, std::string basename_template, const std::shared_ptr<ds::Scanner>& scanner, arrow::dataset::ExistingDataBehavior existing_data_behavior, const std::shared_ptr<ds::Scanner>& scanner, int max_partitions);
extern "C" SEXP _arrow_dataset___Dataset__Write(SEXP file_write_options_sexp, SEXP filesystem_sexp, SEXP base_dir_sexp, SEXP partitioning_sexp, SEXP basename_template_sexp, SEXP scanner_sexp, SEXP existing_data_behavior_sexp, SEXP scanner_sexp, SEXP max_partitions_sexp){
BEGIN_CPP11
	...
	dataset___Dataset__Write(file_write_options, filesystem, base_dir, partitioning, basename_template, scanner, existing_data_behavior, scanner, max_partitions);
	return R_NilValue;
END_CPP11
}
#else
...
static const R_CallMethodDef CallEntries[] = {
		...
		{ "_arrow_dataset___Dataset__Write", (DL_FUNC) &_arrow_dataset___Dataset__Write, 9}, 
