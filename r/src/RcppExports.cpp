...
RcppExport SEXP _arrow_float16() {
  BEGIN_RCPP
  Rcpp::RObject rcpp_result_gen;
  Rcpp::RNGScope rcpp_rngScope_gen;
...
RcppExport SEXP _arrow_float32() {
  BEGIN_RCPP
  Rcpp::RObject rcpp_result_gen;
  Rcpp::RNGScope rcpp_rngScope_gen;
...
RcppExport SEXP _arrow_float64() {
  BEGIN_RCPP
  Rcpp::RObject rcpp_result_gen;
  Rcpp::RNGScope rcpp_rngScope_gen;
...
RcppExport SEXP _arrow_boolean() {
  BEGIN_RCPP
  Rcpp::RObject rcpp_result_gen;
  Rcpp::RNGScope rcpp_rngScope_gen;
...
RcppExport SEXP _arrow_decimal_type(SEXP precisionSEXP, SEXP scaleSEXP) {
  BEGIN_RCPP
  Rcpp::RObject rcpp_result_gen;
  Rcpp::RNGScope rcpp_rngScope_gen;
...
RcppExport SEXP _arrow_fixed_size_binary(SEXP byte_widthSEXP) {
  BEGIN_RCPP
  Rcpp::RObject rcpp_result_gen;
  Rcpp::RNGScope rcpp_rngScope_gen;
...
RcppExport SEXP _arrow_timestamp1(SEXP unitSEXP) {
  BEGIN_RCPP
  Rcpp::RObject rcpp_result_gen;
  Rcpp::RNGScope rcpp_rngScope_gen;
...
RcppExport SEXP _arrow_timestamp2(SEXP unitSEXP, SEXP timezoneSEXP) {
  BEGIN_RCPP
  Rcpp::RObject rcpp_result_gen;
  Rcpp::RNGScope rcpp_rngScope_gen;
  Rcpp::traits::input_parameter<arrow::TimeUnit::type>::type unit(unitSEXP);
...
RcppExport SEXP _arrow_time32_(SEXP unitSEXP) {
  BEGIN_RCPP
  Rcpp::RObject rcpp_result_gen;
  Rcpp::RNGScope rcpp_rngScope_gen;
  Rcpp::traits::input_parameter<arrow::TimeUnit::type>::type unit(unitSEXP);
...
RcppExport SEXP _arrow_time64_(SEXP unitSEXP) {
  BEGIN_RCPP
  Rcpp::RObject rcpp_result_gen;
  Rcpp::RNGScope rcpp_rngScope_gen;
  Rcpp::traits::input_parameter<arrow::TimeUnit::type>::type unit(unitSEXP);
...
static const R_CallMethodDef CallEntries[] = {
    ...
    {"_arrow_int8", (DL_FUNC)&_arrow_int8, 0},
    {"_arrow_int16", (DL_FUNC)&_arrow_int16, 0},
    {"_arrow_int32", (DL_FUNC)&_arrow_int32, 0},
    {"_arrow_int64", (DL_FUNC)&_arrow_int64, 0},
    {"_arrow_uint8", (DL_FUNC)&_arrow_uint8, 0},
    {"_arrow_uint16", (DL_FUNC)&_arrow_uint16, 0},
    {"_arrow_uint32", (DL_FUNC)&_arrow_uint32, 0},
    {"_arrow_uint64", (DL_FUNC)&_arrow_uint64, 0},
    {"_arrow_float16", (DL_FUNC)&_arrow_float16, 0},
    {"_arrow_float32", (DL_FUNC)&_arrow_float32, 0},
    {"_arrow_float64", (DL_FUNC)&_arrow_float64, 0},
    {"_arrow_boolean", (DL_FUNC)&_arrow_boolean, 0},
    {"_arrow_utf8", (DL_FUNC)&_arrow_utf8, 0},
    {"_arrow_date32", (DL_FUNC)&_arrow_date32, 0},
    {"_arrow_date64", (DL_FUNC)&_arrow_date64, 0},
    {"_arrow_null", (DL_FUNC)&_arrow_null, 0},
    {"_arrow_decimal_type", (DL_FUNC)&_arrow_decimal_type, 2},
    {"_arrow_fixed_size_binary", (DL_FUNC)&_arrow_fixed_size_binary, 1},
    {"_arrow_timestamp1", (DL_FUNC)&_arrow_timestamp1, 1},
    {"_arrow_timestamp2", (DL_FUNC)&_arrow_timestamp2, 2},
    {"_arrow_time32_", (DL_FUNC)&_arrow_time32_, 1},
    {"_arrow_time64_", (DL_FUNC)&_arrow_time64_, 1},
