...
// read_record_batch_
std::shared_ptr<arrow::RecordBatch> read_record_batch_(const std::shared_ptr<arrow::io::RandomAccessFile>& stream);
RcppExport SEXP _arrow_read_record_batch_(SEXP streamSEXP) {
BEGIN_RCPP
    Rcpp::RObject rcpp_result_gen;
    Rcpp::RNGScope rcpp_rngScope_gen;
    Rcpp::traits::input_parameter< const std::shared_ptr<arrow::io::RandomAccessFile>& >::type stream(streamSEXP);
    rcpp_result_gen = Rcpp::wrap(read_record_batch_(stream));
    return rcpp_result_gen;
END_RCPP
}
