...
// io___FileInterface__Close
void io___FileInterface__Close(const std::shared_ptr<arrow::io::FileInterface>& x);
RcppExport SEXP _arrow_io___FileInterface__Close(SEXP xSEXP) {
BEGIN_RCPP
    Rcpp::RNGScope rcpp_rngScope_gen;
    Rcpp::traits::input_parameter< const std::shared_ptr<arrow::io::FileInterface>& >::type x(xSEXP);
    io___FileInterface__Close(x);
    return R_NilValue;
END_RCPP
}
...
static const R_CallMethodDef CallEntries[] = {
    ...
    {"_arrow_io___FileInterface__Close", (DL_FUNC) &_arrow_io___FileInterface__Close, 1},
