...
// [[arrow::export]]
ds::ExpressionPtr dataset___expr__greater(const ds::ExpressionPtr& lhs,
                                          const ds::ExpressionPtr& rhs) {
  return arrow::dataset::greater(lhs, rhs);
}

// [[arrow::export]]
ds::ExpressionPtr dataset___expr__greater_equal(const ds::ExpressionPtr& lhs,
                                                const ds::ExpressionPtr& rhs) {
  return arrow::dataset::greater_equal(lhs, rhs);
}

// [[arrow::export]]
ds::ExpressionPtr dataset___expr__less(const ds::ExpressionPtr& lhs,
                                       const ds::ExpressionPtr& rhs) {
  return arrow::dataset::less(lhs, rhs);
}

// [[arrow::export]]
ds::ExpressionPtr dataset___expr__less_equal(const ds::ExpressionPtr& lhs,
                                             const ds::ExpressionPtr& rhs) {
  return arrow::dataset::less_equal(lhs, rhs);
}

// [[arrow::export]]
ds::ExpressionPtr dataset___expr__and(const ds::ExpressionPtr& lhs,
                                      const ds::ExpressionPtr& rhs) {
  return arrow::dataset::and_(lhs, rhs);
}

// [[arrow::export]]
ds::ExpressionPtr dataset___expr__or(const ds::ExpressionPtr& lhs,
                                     const ds::ExpressionPtr& rhs) {
