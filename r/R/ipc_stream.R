...
#' @examples
#' # The default format is "stream" so these two lines do the same thing
#' write_to_raw(mtcars)
#' write_to_raw(mtcars, format = "stream")
#' 
#' write_to_raw(mtcars, format = "file")
#' 
#' cars_table <- Table$create(mtcars)
#' write_to_raw(cars_table)
#' @export
