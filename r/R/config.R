...
#' Manage experimental R code evaluation from within Arrow
#'
#' @export
...
#' @rdname use_run_with_captured_r
#' @param run_with_captured_r Use TRUE to enable R code evaluation from within
#'   arrow
#' @export
