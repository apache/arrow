...
#' \code{\link[dplyr:collect]{collect()}} first. It must also be added before
#' any aggregation or join. See Examples.
#'
...
#'   collect()
#'
#' # To refer to the new column in a later step of the same query (for
#' # example, to extract partition values from the path), call compute() or
#' # collect() first
#' open_dataset("nyc-taxi") |>
#'   mutate(file = add_filename()) |>
#'   compute() |>
