...
test_that("time32 types work as expected", {
  ...
  x <- time32(TimeUnit$MICRO)
  expect_equal(x$id(), 19L)
  expect_equal(x$name(), "time32")
  expect_equal(x$ToString(), "time32[us]")
  expect_true(x == x)
  expect_false(x == null())
  expect_equal(x$num_children(), 0L)
  expect_equal(x$children(), list())
  ...
  x <- time32(TimeUnit$NANO)
  expect_equal(x$id(), 19L)
  expect_equal(x$name(), "time32")
  expect_equal(x$ToString(), "time32[ns]")
  expect_true(x == x)
  expect_false(x == null())
  expect_equal(x$num_children(), 0L)
  expect_equal(x$children(), list())
...
test_that("time64 types work as expected", {
  x <- time64(TimeUnit$SECOND)
  expect_equal(x$id(), 20L)
  expect_equal(x$name(), "time64")
  expect_equal(x$ToString(), "time64[s]")
  expect_true(x == x)
  expect_false(x == null())
  expect_equal(x$num_children(), 0L)
  expect_equal(x$children(), list())
  ...
  x <- time64(TimeUnit$MILLI)
  expect_equal(x$id(), 20L)
  expect_equal(x$name(), "time64")
  expect_equal(x$ToString(), "time64[ms]")
  expect_true(x == x)
  expect_false(x == null())
  expect_equal(x$num_children(), 0L)
  expect_equal(x$children(), list())
