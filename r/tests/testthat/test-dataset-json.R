...
example_data1_json <- '[{"int":1,"dbl":1.1,"dbl2":5,"lgl":true,"false":false,"chr":"a","fct":"a"},{"int":2,"dbl":2.1,"dbl2":5,"false":false,"chr":"b","fct":"b"},{"int":3,"dbl":3.1,"dbl2":5,"lgl":true,"false":false,"chr":"c","fct":"c"},{"dbl":4.1,"dbl2":5,"lgl":false,"false":false,"chr":"d","fct":"d"},{"int":5,"dbl":5.1,"dbl2":5,"lgl":true,"false":false,"chr":"e"}]'

example_data2_json <- '[{"int":6,"dbl":6.1,"dbl2":5,"false":false},{"int":7,"dbl":7.1,"dbl2":5,"false":false,"chr":"g","fct":"g"},{"int":8,"dbl":8.1,"dbl2":5,"lgl":false,"false":false,"chr":"h","fct":"h"},{"int":9,"dbl2":5,"lgl":false,"false":false,"chr":"i","fct":"i"},{"int":10,"dbl":10.1,"dbl2":5,"false":false,"chr":"j","fct":"j"}]'

dir.create(json_dir)
writeLines(example_data1_json, file.path(json_dir, "file1.json"))
writeLines(example_data2_json, file.path(json_dir, "file2.json"))

test_that("JSON dataset", {
  ds <- open_dataset(json_dir, format = "json")

  # TODO: update all code below, which is copied from CSV tests
