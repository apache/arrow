...
#   glue_collapse_data(args, "SEXP {name}_sexp")
# }
#
# real_params <- function(args){
#   glue_collapse_data(args, "{type} {name}")
# }
#
# input_params <- function(args) {
#   glue_collapse_data(args, "Rcpp::traits::input_parameter<{type}>::type {name}({name}_sexp);", sep = "\n", last = "\n")
# }
...
writeLines(con = "src/generated.cpp", glue::glue('
...
writeLines(con = "R/generated.R", glue::glue('
# Generated by using data-raw/codegen.R -> do not edit by hand
