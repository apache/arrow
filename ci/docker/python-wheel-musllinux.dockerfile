...
RUN apk add --no-cache git flex curl autoconf zip wget cmake alpine-sdk libc6-compat libstdc++ gcompat linux-headers

# A system Python is required for ninja and vcpkg in this Dockerfile.
# On musllinux_1_2, python 3.11.6 is installed.
