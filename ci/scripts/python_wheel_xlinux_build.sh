...
cmake \
    ...
    -DARROW_PACKAGE_KIND="python-wheel-${LINUX_WHEEL_NAME}linux${LINUX_WHEEL_VERSION}" \
...
echo "=== (${PYTHON_VERSION}) Tag the wheel with ${LINUX_WHEEL_NAME}linux${LINUX_WHEEL_VERSION} ==="
