...
${R_BIN} -e "options(warn=2); install.packages('remotes'); remotes::install_github('r-lib/rcmdcheck'); remotes::install_cran(c('glue', 'sys')); remotes::install_deps(INSTALL_opts = '"${INSTALL_ARGS}"')"
