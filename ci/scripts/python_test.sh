...
# TODO: implement optional components in Meson
: ${PYARROW_TEST_ACERO:=${ARROW_ACERO:-OFF}}
: ${PYARROW_TEST_AZURE:=${ARROW_AZURE:-OFF}}
: ${PYARROW_TEST_CUDA:=${ARROW_CUDA:-OFF}}
: ${PYARROW_TEST_DATASET:=${ARROW_DATASET:-OFF}}
: ${PYARROW_TEST_FLIGHT:=${ARROW_FLIGHT:-OFF}}
: ${PYARROW_TEST_GANDIVA:=${ARROW_GANDIVA:-OFF}}
: ${PYARROW_TEST_GCS:=${ARROW_GCS:-OFF}}
: ${PYARROW_TEST_HDFS:=${ARROW_HDFS:-OFF}}
: ${PYARROW_TEST_ORC:=${ARROW_ORC:-OFF}}
: ${PYARROW_TEST_PARQUET:=${ARROW_PARQUET:-OFF}}
: ${PYARROW_TEST_PARQUET_ENCRYPTION:=${PARQUET_REQUIRE_ENCRYPTION:-OFF}}
: ${PYARROW_TEST_S3:=${ARROW_S3:-OFF}}
