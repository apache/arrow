...
func (monthTraits) CastFromBytes(b []byte) []MonthInterval {
	return unsafe.Slice((*MonthInterval)(unsafe.Pointer(unsafe.SliceData(b))), cap(b)/MonthIntervalSizeBytes)[:len(b)/MonthIntervalSizeBytes]
}

// CastToBytes reinterprets the slice b to a slice of bytes.
func (monthTraits) CastToBytes(b []MonthInterval) []byte {
	return unsafe.Slice((*byte)(unsafe.Pointer(unsafe.SliceData(b))), cap(b)*MonthIntervalSizeBytes)[:len(b)*MonthIntervalSizeBytes]
}
...
func (daytimeTraits) CastFromBytes(b []byte) []DayTimeInterval {
	return unsafe.Slice((*DayTimeInterval)(unsafe.Pointer(unsafe.SliceData(b))), cap(b)/DayTimeIntervalSizeBytes)[:len(b)/DayTimeIntervalSizeBytes]
}

// CastToBytes reinterprets the slice b to a slice of bytes.
func (daytimeTraits) CastToBytes(b []DayTimeInterval) []byte {
	return unsafe.Slice((*byte)(unsafe.Pointer(unsafe.SliceData(b))), cap(b)*DayTimeIntervalSizeBytes)[:len(b)*DayTimeIntervalSizeBytes]
}
...
func (monthDayNanoTraits) CastFromBytes(b []byte) []MonthDayNanoInterval {
	return unsafe.Slice((*MonthDayNanoInterval)(unsafe.Pointer(unsafe.SliceData(b))), cap(b)/MonthDayNanoIntervalSizeBytes)[:len(b)/MonthDayNanoIntervalSizeBytes]
}

// CastToBytes reinterprets the slice b to a slice of bytes.
func (monthDayNanoTraits) CastToBytes(b []MonthDayNanoInterval) []byte {
	return unsafe.Slice((*byte)(unsafe.Pointer(unsafe.SliceData(b))), cap(b)*MonthDayNanoIntervalSizeBytes)[:len(b)*MonthDayNanoIntervalSizeBytes]
}
