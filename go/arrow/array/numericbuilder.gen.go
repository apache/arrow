...
func (b *Uint32Builder) AppendValueFromString(s string) error {
	...
	v, err := strconv.ParseUint(s, 10, 4)
	if err != nil {
		b.AppendNull()
		return err
	}
...
func (b *Uint16Builder) AppendValueFromString(s string) error {
	...
	v, err := strconv.ParseUint(s, 10, 2)
	if err != nil {
		b.AppendNull()
		return err
	}
...
func (b *Uint8Builder) AppendValueFromString(s string) error {
	...
	v, err := strconv.ParseUint(s, 10, 1)
	if err != nil {
		b.AppendNull()
		return err
	}
