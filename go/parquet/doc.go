...
//   go get -u github.com/apache/arrow/go/v9/parquet
//   go install github.com/apache/arrow/go/v9/parquet/cmd/parquet_reader@latest
//   go install github.com/apache/arrow/go/v9/parquet/cmd/parquet_schema@latest
//
// Modules
//
