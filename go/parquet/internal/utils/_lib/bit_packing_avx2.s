...
# %bb.7:
	...
	add	r15, 96
	xor	ecx, ecx
	vpbroadcastq	ymm0, qword ptr [rip + .LCPI0_136] # ymm0 = [4294967297,4294967297,4294967297,4294967297]
	vmovdqa	ymm1, ymmword ptr [rip + .LCPI0_135] # ymm1 = [0,1,2,3,4,5,6,7]
	...
	vmovdqa	ymm4, ymmword ptr [rip + .LCPI0_137] # ymm4 = [24,25,26,27,28,29,30,31]
	.p2align	4, 0x90
...
.LBB0_55:                               # =>This Inner Loop Header: Depth=1
	...
	mov	esi, r10d
	shld	esi, ecx, 14
	movzx	r11d, word ptr [rbx - 30]
	mov	eax, ecx
	shl	eax, 16
	vmovd	xmm5, edi
	vpinsrd	xmm5, xmm5, r12d, 1
...
# %bb.30:
	...
	add	r15, 96
	add	rbx, 32
	vpbroadcastq	ymm0, qword ptr [rip + .LCPI0_106] # ymm0 = [2194728288767,2194728288767,2194728288767,2194728288767]
	vmovdqa	ymm1, ymmword ptr [rip + .LCPI0_105] # ymm1 = [0,9,18,0,4,13,22,0]
	vmovdqa	ymm2, ymmword ptr [rip + .LCPI0_107] # ymm2 = [8,17,0,3,12,21,0,7]
	vmovdqa	ymm3, ymmword ptr [rip + .LCPI0_108] # ymm3 = [16,0,2,11,20,0,6,15]
	vmovdqa	ymm4, ymmword ptr [rip + .LCPI0_109] # ymm4 = [0,1,10,19,0,5,14,23]
	.p2align	4, 0x90
...
# %bb.18:
	...
	add	r15, 96
	add	rbx, 16
	vpbroadcastq	ymm0, qword ptr [rip + .LCPI0_121] # ymm0 = [133143986207,133143986207,133143986207,133143986207]
	vmovdqa	ymm1, ymmword ptr [rip + .LCPI0_120] # ymm1 = [0,5,10,15,20,25,0,3]
	vmovdqa	ymm2, ymmword ptr [rip + .LCPI0_122] # ymm2 = [8,13,18,23,0,1,6,11]
	vmovdqa	ymm3, ymmword ptr [rip + .LCPI0_123] # ymm3 = [16,21,26,0,4,9,14,19]
	vmovdqa	ymm4, ymmword ptr [rip + .LCPI0_124] # ymm4 = [24,0,2,7,12,17,22,27]
	.p2align	4, 0x90
...
# %bb.41:
	...
	add	r15, 96
	add	rbx, 48
	vpbroadcastq	ymm0, qword ptr [rip + .LCPI0_91] # ymm0 = [35180077129727,35180077129727,35180077129727,35180077129727]
	vmovdqa	ymm1, ymmword ptr [rip + .LCPI0_90] # ymm1 = [0,13,0,7,0,1,14,0]
	vmovdqa	ymm2, ymmword ptr [rip + .LCPI0_92] # ymm2 = [8,0,2,15,0,9,0,3]
	vmovdqa	ymm3, ymmword ptr [rip + .LCPI0_93] # ymm3 = [16,0,10,0,4,17,0,11]
	vmovdqa	ymm4, ymmword ptr [rip + .LCPI0_94] # ymm4 = [0,5,18,0,12,0,6,19]
	.p2align	4, 0x90
...
# %bb.12:
	mov	eax, eax
	add	r15, 96
	vpbroadcastq	ymm0, qword ptr [rip + .LCPI0_128] # ymm0 = [30064771079,30064771079,30064771079,30064771079]
	vmovdqa	ymm1, ymmword ptr [rip + .LCPI0_127] # ymm1 = [0,3,6,9,12,15,18,21]
	vmovdqa	ymm2, ymmword ptr [rip + .LCPI0_129] # ymm2 = [24,27,0,1,4,7,10,13]
	vmovdqa	ymm3, ymmword ptr [rip + .LCPI0_130] # ymm3 = [16,19,22,25,28,0,2,5]
	vmovdqa	ymm4, ymmword ptr [rip + .LCPI0_131] # ymm4 = [8,11,14,17,20,23,26,29]
	.p2align	4, 0x90
...
# %bb.35:
	...
	add	r15, 96
	add	rbx, 40
	vpbroadcastq	ymm0, qword ptr [rip + .LCPI0_98] # ymm0 = [8791798056959,8791798056959,8791798056959,8791798056959]
	vmovdqa	ymm1, ymmword ptr [rip + .LCPI0_97] # ymm1 = [0,11,0,1,12,0,2,13]
	vmovdqa	ymm2, ymmword ptr [rip + .LCPI0_99] # ymm2 = [0,3,14,0,4,15,0,5]
	vmovdqa	ymm3, ymmword ptr [rip + .LCPI0_100] # ymm3 = [16,0,6,17,0,7,18,0]
	vmovdqa	ymm4, ymmword ptr [rip + .LCPI0_101] # ymm4 = [8,19,0,9,20,0,10,21]
	.p2align	4, 0x90
...
# %bb.23:
	...
	add	r15, 96
	add	rbx, 24
	vpbroadcastq	ymm0, qword ptr [rip + .LCPI0_113] # ymm0 = [545460846719,545460846719,545460846719,545460846719]
	vmovdqa	ymm1, ymmword ptr [rip + .LCPI0_112] # ymm1 = [0,7,14,21,0,3,10,17]
	vmovdqa	ymm2, ymmword ptr [rip + .LCPI0_114] # ymm2 = [24,0,6,13,20,0,2,9]
	vmovdqa	ymm3, ymmword ptr [rip + .LCPI0_115] # ymm3 = [16,23,0,5,12,19,0,1]
	vmovdqa	ymm4, ymmword ptr [rip + .LCPI0_116] # ymm4 = [8,15,22,0,4,11,18,25]
	.p2align	4, 0x90
...
# %bb.46:
	...
	add	r15, 96
	add	rbx, 56
	vpbroadcastq	ymm0, qword ptr [rip + .LCPI0_83] # ymm0 = [140733193420799,140733193420799,140733193420799,140733193420799]
	vmovdqa	ymm1, ymmword ptr [rip + .LCPI0_82] # ymm1 = [0,15,0,13,0,11,0,9]
	vmovdqa	ymm2, ymmword ptr [rip + .LCPI0_84] # ymm2 = [0,7,0,5,0,3,0,1]
	vmovdqa	ymm3, ymmword ptr [rip + .LCPI0_85] # ymm3 = [16,0,14,0,12,0,10,0]
	vmovdqa	ymm4, ymmword ptr [rip + .LCPI0_86] # ymm4 = [8,0,6,0,4,0,2,17]
	.p2align	4, 0x90
...
# %bb.121:
	mov	eax, eax
	xor	ecx, ecx
	vmovdqa	ymm0, ymmword ptr [rip + .LCPI0_80] # ymm0 = [0,0,1,1,2,2,3,3]
	vpbroadcastq	ymm1, qword ptr [rip + .LCPI0_81] # ymm1 = [68719476736,68719476736,68719476736,68719476736]
	vpxor	xmm2, xmm2, xmm2
	.p2align	4, 0x90
.LBB0_122:                              # =>This Inner Loop Header: Depth=1
	vmovdqu	xmm3, xmmword ptr [rbx + rcx]
	vpermd	ymm3, ymm0, ymm3
	vpsrlvd	ymm3, ymm3, ymm1
	vpblendw	ymm3, ymm3, ymm2, 170 # ymm3 = ymm3[0],ymm2[1],ymm3[2],ymm2[3],ymm3[4],ymm2[5],ymm3[6],ymm2[7],ymm3[8],ymm2[9],ymm3[10],ymm2[11],ymm3[12],ymm2[13],ymm3[14],ymm2[15]
	vmovdqu	ymmword ptr [r15 + 2*rcx], ymm3
	vmovdqu	xmm3, xmmword ptr [rbx + rcx + 16]
	vpermd	ymm3, ymm0, ymm3
	vpsrlvd	ymm3, ymm3, ymm1
	vpblendw	ymm3, ymm3, ymm2, 170 # ymm3 = ymm3[0],ymm2[1],ymm3[2],ymm2[3],ymm3[4],ymm2[5],ymm3[6],ymm2[7],ymm3[8],ymm2[9],ymm3[10],ymm2[11],ymm3[12],ymm2[13],ymm3[14],ymm2[15]
	vmovdqu	ymmword ptr [r15 + 2*rcx + 32], ymm3
	vmovdqu	xmm3, xmmword ptr [rbx + rcx + 32]
	vpermd	ymm3, ymm0, ymm3
	vpsrlvd	ymm3, ymm3, ymm1
	vpblendw	ymm3, ymm3, ymm2, 170 # ymm3 = ymm3[0],ymm2[1],ymm3[2],ymm2[3],ymm3[4],ymm2[5],ymm3[6],ymm2[7],ymm3[8],ymm2[9],ymm3[10],ymm2[11],ymm3[12],ymm2[13],ymm3[14],ymm2[15]
	vmovdqu	ymmword ptr [r15 + 2*rcx + 64], ymm3
	vmovdqu	xmm3, xmmword ptr [rbx + rcx + 48]
	vpermd	ymm3, ymm0, ymm3
	vpsrlvd	ymm3, ymm3, ymm1
	vpblendw	ymm3, ymm3, ymm2, 170 # ymm3 = ymm3[0],ymm2[1],ymm3[2],ymm2[3],ymm3[4],ymm2[5],ymm3[6],ymm2[7],ymm3[8],ymm2[9],ymm3[10],ymm2[11],ymm3[12],ymm2[13],ymm3[14],ymm2[15]
	vmovdqu	ymmword ptr [r15 + 2*rcx + 96], ymm3
	add	rcx, 64
	add	rax, -1
	jne	.LBB0_122
	jmp	.LBB0_147
...
# %bb.133:
	mov	eax, eax
	xor	ecx, ecx
	vbroadcasti128	ymm0, xmmword ptr [rip + .LCPI0_110] # ymm0 = [0,8,16,24,0,8,16,24]
                                        # ymm0 = mem[0,1,0,1]
	vpbroadcastd	ymm1, dword ptr [rip + .LCPI0_111] # ymm1 = [255,255,255,255,255,255,255,255]
	.p2align	4, 0x90
...
# %bb.139:
	mov	eax, eax
	xor	ecx, ecx
	vmovdqa	ymm0, ymmword ptr [rip + .LCPI0_125] # ymm0 = [0,4,8,12,16,20,24,28]
	vpbroadcastq	ymm1, qword ptr [rip + .LCPI0_126] # ymm1 = [64424509455,64424509455,64424509455,64424509455]
	.p2align	4, 0x90
...
# %bb.127:
	...
	add	r15, 96
	add	rbx, 44
	vmovdqa	ymm0, ymmword ptr [rip + .LCPI0_95] # ymm0 = [0,12,0,4,16,0,8,20]
	vpbroadcastq	ymm1, qword ptr [rip + .LCPI0_96] # ymm1 = [17587891081215,17587891081215,17587891081215,17587891081215]
	.p2align	4, 0x90
...
# %bb.142:
	...
	add	r15, 96
	xor	ecx, ecx
	vmovdqa	ymm0, ymmword ptr [rip + .LCPI0_132] # ymm0 = [0,2,4,6,8,10,12,14]
	vpbroadcastq	ymm1, qword ptr [rip + .LCPI0_133] # ymm1 = [12884901891,12884901891,12884901891,12884901891]
	vmovdqa	ymm2, ymmword ptr [rip + .LCPI0_134] # ymm2 = [16,18,20,22,24,26,28,30]
	.p2align	4, 0x90
...
.LBB0_119:                              # =>This Inner Loop Header: Depth=1
	...
	mov	esi, r10d
	shld	esi, ecx, 12
	movzx	r11d, word ptr [rbx - 50]
	mov	eax, ecx
	shl	eax, 16
	vmovd	xmm3, edi
	vpinsrd	xmm3, xmm3, r12d, 1
	vpinsrd	xmm3, xmm3, edx, 2
	vpinsrd	xmm3, xmm3, r9d, 3
	or	eax, r11d
	vmovd	xmm4, eax
...
# %bb.130:
	...
	add	r15, 96
	add	rbx, 36
	vmovdqa	ymm0, ymmword ptr [rip + .LCPI0_102] # ymm0 = [0,10,20,0,8,18,0,6]
	vpbroadcastq	ymm1, qword ptr [rip + .LCPI0_103] # ymm1 = [4393751544831,4393751544831,4393751544831,4393751544831]
	vmovdqa	ymm2, ymmword ptr [rip + .LCPI0_104] # ymm2 = [16,0,4,14,0,2,12,22]
	.p2align	4, 0x90
...
# %bb.136:
	...
	add	r15, 96
	add	rbx, 20
	vmovdqa	ymm0, ymmword ptr [rip + .LCPI0_117] # ymm0 = [0,6,12,18,24,0,4,10]
	vpbroadcastq	ymm1, qword ptr [rip + .LCPI0_118] # ymm1 = [270582939711,270582939711,270582939711,270582939711]
	vmovdqa	ymm2, ymmword ptr [rip + .LCPI0_119] # ymm2 = [16,22,0,2,8,14,20,26]
	.p2align	4, 0x90
...
# %bb.124:
	...
	add	r15, 96
	add	rbx, 52
	vmovdqa	ymm0, ymmword ptr [rip + .LCPI0_87] # ymm0 = [0,14,0,10,0,6,0,2]
	vpbroadcastq	ymm1, qword ptr [rip + .LCPI0_88] # ymm1 = [70364449226751,70364449226751,70364449226751,70364449226751]
	vmovdqa	ymm2, ymmword ptr [rip + .LCPI0_89] # ymm2 = [16,0,12,0,8,0,4,18]
	.p2align	4, 0x90
