...
final class CDataTests: XCTestCase {
    func makeSchema() -> Arrow.ArrowSchema {
        ...
        return schemaBuilder
            ...
            .addField("colTimestamptsu", type: ArrowTypeTimestamp(.microseconds), isNullable: false)
            .addField("colTimestamptsm", type: ArrowTypeTimestamp(.milliseconds), isNullable: false)
            .addField("colTimestamptss", type: ArrowTypeTimestamp(.seconds), isNullable: false)
