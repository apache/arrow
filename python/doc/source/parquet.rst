...
- The ``account key`` can be found under ``Settings Access keys`` in the Microsoft Azure portal for a given container
   - Choose either one of the two default keys issued by Microsoft, or one you created yourself
