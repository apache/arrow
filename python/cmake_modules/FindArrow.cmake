...
if (ARROW_INCLUDE_DIR AND ARROW_LIBS)
  ...
  if (MSVC)
    ...
    set(ARROW_JEMALLOC_STATIC_LIB ${ARROW_JEMALLOC__LIB_PATH})
    ...
    set(ARROW_JEMALLOC_SHARED_LIB ${ARROW_LIBS}/${CMAKE_SHARED_LIBRARY_PREFIX}$${ARROW_JEMALLOC_LIB_NAME}${CMAKE_SHARED_LIBRARY_SUFFIX})
    set(ARROW_PYTHON_SHARED_LIB ${ARROW_LIBS}/${CMAKE_SHARED_LIBRARY_PREFIX}$${ARROW_PYTHON_LIB_NAME}${CMAKE_SHARED_LIBRARY_SUFFIX})
  endif()
