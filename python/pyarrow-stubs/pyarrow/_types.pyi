...
class Schema(_Weakrefable):
    def __len__(self) -> int: ...
    def __getitem__(self, key: str | int) -> Field[Any]: ...
    ...
    @property
    def pandas_metadata(self) -> dict[bytes, bytes]: ...
    @property
    def names(self) -> list[str]: ...
    @property
    ...
    def field_by_name(self, name: str) -> Field[Any]: ...
    def get_field_index(self, name: str) -> int: ...
    def get_all_field_indices(self, name: str) -> list[int]: ...
...
@overload
def list_(
    value_type: _DataTypeT | Field[_DataTypeT], list_size: Literal[-1] | None = None
) -> ListType[_DataTypeT]: ...
@overload
def list_(
...
def map_(
    key_type: _K | Field[_K] | _FieldTypeInput,
    item_type: _ValueT | Field[_ValueT] | _FieldTypeInput,
