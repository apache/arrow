...
def main():
    ...
    cmd_get_descriptor.add_argument(
        "-p", "--path", type=str, action="append", help="The path for the descriptor."
    )
    cmd_get_descriptor.add_argument(
    ...
    commands = {"list": list_flights, "do": do_action, "get": get_flight}
    ...
    client = pyarrow.flight.FlightClient.connect(
