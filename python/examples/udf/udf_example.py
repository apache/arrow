...
#                                        ["value"], "None")
# register_function(func_name_1, arity_1, doc_1, in_types_1, out_type_1, add_constant) 
...
# a2_2 = pc.call_function(func_name_3, [pa.array([1, 2]), pa.array([10, 20])])
...
doc_5 = get_function_doc("scalar add function", "test scalar add function",
                                       ["scalar_value"], "None")
register_function(func_name_5, arity_5, doc_5, in_types_5, out_type_5, unary_scalar_function) 
