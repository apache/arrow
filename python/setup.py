        ...
        with changed_dir(self.build_temp):
            ...
            if len(self.cmake_cxxflags) > 0:
                cmake_options.append(
                    "-DPYARROW_CXXFLAGS={0}".format(self.cmake_cxxflags)
                )
            ...
            if self.bundle_arrow_cpp:
                ...
                if "ARROW_HOME" in os.environ and sys.platform != "win32":
                    pkg_config = pjoin(os.environ["ARROW_HOME"], "lib", "pkgconfig")
                ...
                if sys.platform == "win32":
                    if self.with_flight:
                        ...
                        for lib_name in [
                            ...
                            move_shared_libs(
                                build_prefix, build_lib, lib_name, implib_required=False
                            )
