...
from pyarrow.lib import ChunkedArray, RecordBatch, Table, concat_arrays, concat_tables
...
def _plasma_store_entry_point():
    ...
    plasma_store_executable = _os.path.join(pyarrow.__path__[0], "plasma-store-server")
