...
cdef class _Tabular(_PandasConvertible):
    ...
    def join(self, right_table, keys, right_keys=None, join_type="left outer",
             ...
             use_threads=True):
        """
        Perform a join between this table or record batch and another one.
        ...
        Parameters
        ----------
        right_table : Table or RecordBatch
            The table or record batch to join to the current one, acting as the right table
    ...
    def join_asof(self, right_table, on, by, tolerance, right_on=None, right_by=None):
        """
        Perform an asof join between this table or record batch and another one.
