...
cdef extern from "arrow/type_traits.h" namespace "arrow":
    ...
    c_bool c_is_signed_integer "is_signed_integer"(Type type_id)
    c_bool c_is_unsigned_integer "is_unsigned_integer"(Type type_id)
    c_bool c_is_floating "is_floating"(Type type_id)
    c_bool c_is_numeric "is_numeric"(Type type_id)
    c_bool c_is_decimal "is_decimal"(Type type_id)
    c_bool c_is_run_end "is_run_end_type"(Type type_id)
    c_bool c_is_primitive "is_primitive"(Type type_id)
    c_bool c_is_base_binary_like "is_base_binary_like"(Type type_id)
    c_bool c_is_binary_like "is_binary_like"(Type type_id)
    c_bool c_is_large_binary_like "is_large_binary_like"(Type type_id)
    c_bool c_is_binary "is_binary"(Type type_id)
    c_bool c_is_string "is_string"(Type type_id)
    c_bool c_is_temporal "is_temporal"(Type type_id)
    c_bool c_is_time "is_time"(Type type_id)
    c_bool c_is_date "is_date"(Type type_id)
    c_bool c_is_interval "is_interval"(Type type_id)
    c_bool c_is_dictionary "is_dictionary"(Type type_id)
    c_bool c_is_fixed_size_binary "is_fixed_size_binary"(Type type_id)
    c_bool c_is_fixed_width "is_fixed_width"(Type type_id)
    c_bool c_is_var_length_list "is_var_length_list"(Type type_id)
    c_bool c_is_list "is_list"(Type type_id)
    c_bool c_is_list_like "is_list_like"(Type type_id)
    c_bool c_is_var_length_list_like "is_var_length_list_like"(Type type_id)
    c_bool c_is_list_view "is_list_view"(Type type_id)
    c_bool c_is_nested "is_nested"(Type type_id)
    c_bool c_is_union "is_union"(Type type_id)
    int c_bit_width "bit_width"(Type type_id)
    int c_offset_bit_width "offset_bit_width"(Type type_id)
