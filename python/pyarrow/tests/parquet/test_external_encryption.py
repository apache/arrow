...
def test_external_file_encryption_properties_rejects_column_in_two_places():
    """Ensure a column cannot be defined in both column_keys and per_column_encryption."""
    config = ppe.ExternalEncryptionConfiguration(
        footer_key="footer_key",
...
def test_external_file_encryption_properties_valid():
    """Check class name and module because ExternalFileEncryptionProperties is not visible."""
    external_encryption_properties = get_external_encryption_properties()

    assert external_encryption_properties.__class__.__name__ == "ExternalFileEncryptionProperties"
...
def test_external_file_decryption_properties_valid():
    """Check class name and module because ExternalFileDecryptionProperties is not visible."""

    external_decryption_properties = get_external_decryption_properties()

    assert external_decryption_properties.__class__.__name__ == "ExternalFileDecryptionProperties"
