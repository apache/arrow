...
class TestScalars(unittest.TestCase):
    ...
    def test_large_list(self):
        arr = pa.array([[123, None], None, [456], []], type=pa.large_list(pa.int16()))
    ...
    def test_timestamp(self):
        ...
        for i, unit in enumerate(units):
            ...
            expected = (
                pd.Timestamp("2000-01-01 12:34:56").tz_localize("utc").tz_convert(tz)
            )
    ...
    def test_dictionary(self):
        ...
        v = pa.DictionaryArray.from_arrays(categorical.codes, categorical.categories)
