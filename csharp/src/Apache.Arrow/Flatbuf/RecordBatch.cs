...
internal struct RecordBatch : IFlatbufferObject
{
...
#if ENABLE_SPAN_T
  public Span<long> GetVariadicBufferCountsBytes() { return __p.__vector_as_span<long>(12, 8); }
#else
  public ArraySegment<byte>? GetVariadicBufferCountsBytes() { return __p.__vector_as_arraysegment(12); }
#endif
  public long[] GetVariadicBufferCountsArray() { return __p.__vector_as_array<long>(12); }
  ...
  public static Offset<RecordBatch> CreateRecordBatch(FlatBufferBuilder builder,
      ...
      VectorOffset variadicBufferCountsOffset = default(VectorOffset)) {
  ...
  public static void AddVariadicBufferCounts(FlatBufferBuilder builder, VectorOffset variadicBufferCountsOffset) { builder.AddOffset(4, variadicBufferCountsOffset.Value, 0); }
  public static VectorOffset CreateVariadicBufferCountsVector(FlatBufferBuilder builder, long[] data) { builder.StartVector(8, data.Length, 8); for (int i = data.Length - 1; i >= 0; i--) builder.AddLong(data[i]); return builder.EndVector(); }
  public static VectorOffset CreateVariadicBufferCountsVectorBlock(FlatBufferBuilder builder, long[] data) { builder.StartVector(8, data.Length, 8); builder.Add(data); return builder.EndVector(); }
  public static VectorOffset CreateVariadicBufferCountsVectorBlock(FlatBufferBuilder builder, ArraySegment<long> data) { builder.StartVector(8, data.Count, 8); builder.Add(data); return builder.EndVector(); }
  public static VectorOffset CreateVariadicBufferCountsVectorBlock(FlatBufferBuilder builder, IntPtr dataPtr, int sizeInBytes) { builder.StartVector(1, sizeInBytes, 1); builder.Add<long>(dataPtr, sizeInBytes); return builder.EndVector(); }
...
static internal class RecordBatchVerify
{
  static public bool Verify(Google.FlatBuffers.Verifier verifier, uint tablePos)
  {
    return verifier.VerifyTableStart(tablePos)
      ...
      && verifier.VerifyVectorOfData(tablePos, 12 /*VariadicBufferCounts*/, 8 /*long*/, false)
