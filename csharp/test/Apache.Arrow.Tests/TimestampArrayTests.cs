...
namespace Apache.Arrow.Tests
{
    public class TimestampArrayTests
    {
        public class IEnumerableArray
        {
            ...
            {
                // Build test array
                TimestampArray array = new TimestampArray.Builder(TimeUnit.Second)
            ...
            {
                // Build test array
                TimestampArray array = new TimestampArray.Builder(TimeUnit.Millisecond)
                    .Append(DateTimeOffset.FromUnixTimeMilliseconds(1)).AppendNull().Append(DateTimeOffset.FromUnixTimeSeconds(-1))
                    .Build();
            ...
            {
                // Build test array
                TimestampArray array = new TimestampArray.Builder(TimeUnit.Microsecond)
                    .Append(DateTimeOffset.FromUnixTimeMilliseconds(1)).AppendNull().Append(DateTimeOffset.FromUnixTimeSeconds(-1))
                    .Build();
            ...
            {
                // Build test array
                TimestampArray array = new TimestampArray.Builder(TimeUnit.Nanosecond)
                    .Append(DateTimeOffset.FromUnixTimeMilliseconds(1)).AppendNull().Append(DateTimeOffset.FromUnixTimeSeconds(-1))
                    .Build();
