...
mod tests {
    ...
    fn test_cast_i32_to_list_f64_nullable_sliced() {
        ...
        let b = cast(
            &array,
            &DataType::List(Box::new(DataTypeContext::new(DataType::Float64, true))),
        )
        .unwrap();
        assert_eq!(4, b.len());
        assert_eq!(1, b.null_count());
    ...
    fn test_cast_list_i32_to_list_u16() {
        ...
        let cast_array = cast(
            &list_array,
            &DataType::List(Box::new(DataTypeContext::new(DataType::UInt16, true))),
        )
        .unwrap();
    ...
    fn make_large_list_array() -> LargeListArray {
        ...
        // Construct a list array from the above two
        let list_data_type =
            DataType::LargeList(Box::new(DataTypeContext::new(DataType::Int32, true)));
        let list_data = ArrayData::builder(list_data_type)
            .len(3)
            .add_buffer(value_offsets)
            .add_child_data(value_data)
    ...
    fn make_fixed_size_list_array() -> FixedSizeListArray {
        ...
        let list_data_type = DataType::FixedSizeList(
            Box::new(DataTypeContext::new(DataType::Int32, true)),
            2,
        );
        let list_data = ArrayData::builder(list_data_type)
            .len(5)
    ...
    fn get_all_types() -> Vec<DataType> {
        ...
        vec![
            ...
            Utf8,
            LargeUtf8,
            List(Box::new(DataTypeContext::new(DataType::Int8, true))),
            List(Box::new(DataTypeContext::new(DataType::Utf8, true))),
            FixedSizeList(Box::new(DataTypeContext::new(DataType::Int8, true)), 10),
            FixedSizeList(Box::new(DataTypeContext::new(DataType::Utf8, false)), 10),
            LargeList(Box::new(DataTypeContext::new(DataType::Int8, true))),
            LargeList(Box::new(DataTypeContext::new(DataType::Utf8, false))),
            Struct(vec![
