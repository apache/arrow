...
impl<'a> LargeList<'a> {
    ...
    pub fn create<'bldr: 'args, 'args: 'mut_bldr, 'mut_bldr>(
        _fbb: &'mut_bldr mut flatbuffers::FlatBufferBuilder<'bldr>,
        _args: &'args LargeListArgs) -> flatbuffers::WIPOffset<LargeList<'bldr>> {
...
impl<'a> LargeUtf8<'a> {
    ...
    pub fn create<'bldr: 'args, 'args: 'mut_bldr, 'mut_bldr>(
        _fbb: &'mut_bldr mut flatbuffers::FlatBufferBuilder<'bldr>,
        _args: &'args LargeUtf8Args) -> flatbuffers::WIPOffset<LargeUtf8<'bldr>> {
...
impl<'a> LargeBinary<'a> {
    ...
    pub fn create<'bldr: 'args, 'args: 'mut_bldr, 'mut_bldr>(
        _fbb: &'mut_bldr mut flatbuffers::FlatBufferBuilder<'bldr>,
        _args: &'args LargeBinaryArgs) -> flatbuffers::WIPOffset<LargeBinary<'bldr>> {
...
impl<'a> Duration<'a> {
  ...
  #[inline]
  pub fn unit(&self) -> TimeUnit {
    self._tab.get::<TimeUnit>(Duration::VT_UNIT, Some(TimeUnit::MILLISECOND)).unwrap()
  }
}
