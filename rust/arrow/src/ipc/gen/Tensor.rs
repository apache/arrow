...
impl<'a> Tensor<'a> {
  ...
  pub fn type_(&self) -> flatbuffers::Table<'a> {
    self._tab.get::<flatbuffers::ForwardsUOffset<flatbuffers::Table<'a>>>(Tensor::VT_TYPE_, None).unwrap()
  }
  /// The dimensions of the tensor, optionally named
  #[inline]
  pub fn shape(&self) -> flatbuffers::Vector<'a, flatbuffers::ForwardsUOffset<TensorDim<'a>>> {
    self._tab.get::<flatbuffers::ForwardsUOffset<flatbuffers::Vector<'a, flatbuffers::ForwardsUOffset<TensorDim>>>>(Tensor::VT_SHAPE, None).unwrap()
  }
...
impl flatbuffers::Verifiable for Tensor<'_> {
  ...
  fn run_verifier<'o, 'b>(
    ...
    use self::flatbuffers::Verifiable;
    v.visit_table(pos)?
     .visit_union::<Type, _>(&"type__type", Self::VT_TYPE__TYPE, &"type_", Self::VT_TYPE_, true, |key, v, pos| {
        match key {
