...
use crate::SparseTensor_generated::*;
use crate::Tensor_generated::*;
use std::mem;
...
impl<'a> BodyCompression<'a> {
    ...
    pub fn create<'bldr: 'args, 'args: 'mut_bldr, 'mut_bldr>(
        ...
        args: &'args BodyCompressionArgs) -> flatbuffers::WIPOffset<BodyCompression<'bldr>> {
  ...
  pub fn codec(&self) -> CompressionType {
    self._tab.get::<CompressionType>(BodyCompression::VT_CODEC, Some(CompressionType::LZ4_FRAME)).unwrap()
  }
  /// Indicates the way the record batch body was compressed
  #[inline]
  pub fn method(&self) -> BodyCompressionMethod {
    self._tab.get::<BodyCompressionMethod>(BodyCompression::VT_METHOD, Some(BodyCompressionMethod::BUFFER)).unwrap()
  }
}
...
impl<'a> RecordBatch<'a> {
  ...
  pub fn nodes(&self) -> Option<&'a [FieldNode]> {
    self._tab.get::<flatbuffers::ForwardsUOffset<flatbuffers::Vector<'a, FieldNode>>>(RecordBatch::VT_NODES, None).map(|v| v.safe_slice())
  }
  ...
  pub fn buffers(&self) -> Option<&'a [Buffer]> {
    self._tab.get::<flatbuffers::ForwardsUOffset<flatbuffers::Vector<'a, Buffer>>>(RecordBatch::VT_BUFFERS, None).map(|v| v.safe_slice())
  }
  /// Optional compression of the message body
  #[inline]
  pub fn compression(&self) -> Option<BodyCompression<'a>> {
    self._tab.get::<flatbuffers::ForwardsUOffset<BodyCompression>>(RecordBatch::VT_COMPRESSION, None)
  }
}
...
impl<'a> DictionaryBatch<'a> {
  ...
  pub fn data(&self) -> Option<RecordBatch<'a>> {
    self._tab.get::<flatbuffers::ForwardsUOffset<RecordBatch>>(DictionaryBatch::VT_DATA, None)
  }
...
impl<'a> Message<'a> {
  ...
  pub fn custom_metadata(&self) -> Option<flatbuffers::Vector<'a, flatbuffers::ForwardsUOffset<KeyValue<'a>>>> {
    self._tab.get::<flatbuffers::ForwardsUOffset<flatbuffers::Vector<'a, flatbuffers::ForwardsUOffset<KeyValue>>>>(Message::VT_CUSTOM_METADATA, None)
  }
  #[inline]
