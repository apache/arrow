...
impl<'a> Footer<'a> {
  ...
  pub fn schema(&self) -> Option<Schema<'a>> {
    self._tab.get::<flatbuffers::ForwardsUOffset<Schema>>(Footer::VT_SCHEMA, None)
  }
  #[inline]
  pub fn dictionaries(&self) -> Option<&'a [Block]> {
    self._tab.get::<flatbuffers::ForwardsUOffset<flatbuffers::Vector<'a, Block>>>(Footer::VT_DICTIONARIES, None).map(|v| v.safe_slice())
  }
  #[inline]
  pub fn recordBatches(&self) -> Option<&'a [Block]> {
    self._tab.get::<flatbuffers::ForwardsUOffset<flatbuffers::Vector<'a, Block>>>(Footer::VT_RECORDBATCHES, None).map(|v| v.safe_slice())
  }
  /// User-defined metadata
  #[inline]
  pub fn custom_metadata(&self) -> Option<flatbuffers::Vector<'a, flatbuffers::ForwardsUOffset<KeyValue<'a>>>> {
    self._tab.get::<flatbuffers::ForwardsUOffset<flatbuffers::Vector<'a, flatbuffers::ForwardsUOffset<KeyValue>>>>(Footer::VT_CUSTOM_METADATA, None)
  }
}
