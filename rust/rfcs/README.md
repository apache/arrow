# Rust Arrow RFCs
[Arrow RFCs]: #arrow-rfcs

Many changes, including bug fixes and documentation improvements can be
implemented and reviewed via the normal GitHub pull request workflow.

Some changes though are "substantial", and we ask that these be put through a
bit of a design process and produce a consensus among the Arrow community and
the team.

The "RFC" (request for comments) process is intended to provide a consistent and
controlled path for new features to enter the project, so that all stakeholders
can be confident about the direction the projects are evolving in.
...
Rust Arrow. What constitutes a "substantial" change is evolving based on
...
proposing to change, but may include the following.
  ...
  - Changes to the API for any of the projects
  - New implementations of the Arrow code
...
proposals, may be quickly rejected, which can be demotivating
...
In short, to get a major feature added to Arrow, one must first get the RFC
merged into the RFC repository as a markdown file. At that point the RFC is
"active" and may be implemented with the goal of eventual inclusion into Rust.

  - Fork the Arrow repository
  - Copy `0000-template.md` to `text/0000-my-feature.md` (where "my-feature" is
    descriptive) from the **rfcs** folder under Rust directory. Don't assign an
    RFC number yet; This is going to be the PR number and we'll rename the file
...
The team makes final decisions about RFCs after the benefits and drawbacks are
