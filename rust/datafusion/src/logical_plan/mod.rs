...
pub use expr::{
    ...
    octet_length, or, regexp_extract, regexp_match, repeat, reverse, right, round, rpad,
    rtrim, sha224, sha256, sha384, sha512, signum, sin, sqrt, substr, sum, tan, to_hex,
    trim, trunc, upper, when, Expr, ExprRewriter, ExpressionVisitor, Literal, Recursion,
};
