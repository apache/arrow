...
public class JdbcToArrowTestDatatypes {
	   ...
	   public JdbcToArrowTestDatatypes (Table data) {
	    	super();
	    ...
	    private static Table getTable (String ymlFilePath) {
	    	...
	    	try {
	    		table  = new ObjectMapper(new YAMLFactory()).readValue(
	    				JdbcToArrowTestDatatypes.class.getClassLoader().getResourceAsStream(ymlFilePath),
	                Table.class);
