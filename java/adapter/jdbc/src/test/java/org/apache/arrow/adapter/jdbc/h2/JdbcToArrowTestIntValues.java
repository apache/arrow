...
public class JdbcToArrowTestIntValues {
	   ...
	   // This is the constructor which will add data to @Parameter annotated variable
	    public JdbcToArrowTestIntValues (TestData data) {
	    	super();
	    ...
	    protected static Table getTable (String ymlFilePath) {
	    	...
	    	try {
	    		table = new ObjectMapper(new YAMLFactory()).readValue(
	    				JdbcToArrowTestIntValues.class.getClassLoader().getResourceAsStream(ymlFilePath),
	                Table.class);
