 ...
 */
public final class FlightSqlClientHandler implements AutoCloseable {

  private final FlightSqlClient sqlClient;
  private final Set<CallOption> options = new HashSet<>();

  FlightSqlClientHandler(final FlightSqlClient sqlClient,
  ...
  /**
   * Creates a new {@link FlightSqlClientHandler} from the provided {@code client} and {@code options}.
   *
   ...
   * @return a new {@link FlightSqlClientHandler}.
   */
  public static FlightSqlClientHandler createNewHandler(final FlightClient client,
                                                        final Collection<CallOption> options) {
    return new FlightSqlClientHandler(new FlightSqlClient(client), options);
  }
  ...
  /**
   * Builder for {@link FlightSqlClientHandler}.
   */
  public static final class Builder {
    ...
    /**
     * Builds a new {@link FlightSqlClientHandler} from the provided fields.
     *
     * @return a new client handler.
     * @throws SQLException on error.
     */
    public FlightSqlClientHandler build() throws SQLException {
      ...
      try {
        ...
        return FlightSqlClientHandler.createNewHandler(client, options);
