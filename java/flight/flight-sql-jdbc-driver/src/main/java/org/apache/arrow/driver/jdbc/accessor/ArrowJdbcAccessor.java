 ...
 * Base Jdbc Accessor.
 */
public abstract class ArrowJdbcAccessor implements Accessor {
  ...
  protected ArrowJdbcAccessorFactory.WasNullConsumer wasNullConsumer;

  protected ArrowJdbcAccessor(final IntSupplier currentRowSupplier,
                              ArrowJdbcAccessorFactory.WasNullConsumer wasNullConsumer) {
