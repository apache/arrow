 ...
 */
public abstract class AbstractArrowJdbcUnionVectorAccessor extends ArrowJdbcAccessor {
   ...
   */
  private final ArrowJdbcAccessor[] accessors = new ArrowJdbcAccessor[128];

  private final ArrowJdbcNullVectorAccessor nullAccessor =
      new ArrowJdbcNullVectorAccessor((boolean wasNull) -> {
      });

  protected AbstractArrowJdbcUnionVectorAccessor(IntSupplier currentRowSupplier,
                                                 ArrowJdbcAccessorFactory.WasNullConsumer setCursorWasNull) {
    super(currentRowSupplier, setCursorWasNull);
  }

  protected abstract ArrowJdbcAccessor createAccessorForVector(ValueVector vector);
   ...
   */
  protected ArrowJdbcAccessor getAccessor() {
