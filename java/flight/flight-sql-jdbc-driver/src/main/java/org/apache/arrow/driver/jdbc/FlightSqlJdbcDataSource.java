...
import static org.apache.arrow.driver.jdbc.utils.FlightSqlConnectionConfigImpl.ArrowFlightConnectionProperty;
...
/**
 * {@link DataSource} implementation for Arrow Flight SQL JDBC Driver.
 */
public class FlightSqlJdbcDataSource implements DataSource {
   ...
   */
  protected FlightSqlJdbcDataSource(final Properties properties,
  ...
  /**
   * Gets the {@link #config} for this {@link FlightSqlJdbcDataSource}.
   *
   * @return the {@link FlightSqlConnectionConfigImpl}.
   */
  protected final FlightSqlConnectionConfigImpl getConfig() {
    return config;
  }

  /**
   * Gets a copy of the {@link #properties} for this {@link FlightSqlJdbcDataSource} with
  ...
  /**
   * Creates a new {@link FlightSqlJdbcDataSource}.
   *
   * @param properties the properties.
   * @return a new data source.
   */
  public static FlightSqlJdbcDataSource createNewDataSource(final Properties properties) {
    return new FlightSqlJdbcDataSource(properties,
  ...
  @Override
  public FlightSqlConnection getConnection(final String username, final String password)
      throws SQLException {
    final Properties properties = getProperties(username, password);
    return new FlightSqlJdbcDriver().connect(config.url(), properties);
  }
