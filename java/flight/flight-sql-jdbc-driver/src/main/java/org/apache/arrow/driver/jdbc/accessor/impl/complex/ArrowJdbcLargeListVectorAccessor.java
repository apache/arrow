 ...
 */
public class ArrowJdbcLargeListVectorAccessor
    extends AbstractArrowJdbcListVectorAccessor {

  private final LargeListVector vector;

  public ArrowJdbcLargeListVectorAccessor(LargeListVector vector,
