 ...
 */
public class ArrowJdbcDecimalVectorAccessor extends ArrowJdbcAccessor {
  ...
  public ArrowJdbcDecimalVectorAccessor(DecimalVector vector, IntSupplier currentRowSupplier,
                                        ArrowJdbcAccessorFactory.WasNullConsumer setCursorWasNull) {
    super(currentRowSupplier, setCursorWasNull);
    this.getter = vector::getObject;
  }

  public ArrowJdbcDecimalVectorAccessor(Decimal256Vector vector,
