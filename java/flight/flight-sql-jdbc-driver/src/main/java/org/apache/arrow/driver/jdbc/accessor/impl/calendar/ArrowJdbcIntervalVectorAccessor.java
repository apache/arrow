 ...
 */
public class ArrowJdbcIntervalVectorAccessor extends ArrowJdbcAccessor {
   ...
   */
  public ArrowJdbcIntervalVectorAccessor(IntervalDayVector vector,
   ...
   * @param setCursorWasNull   the consumer to set if value was null.
   */
  public ArrowJdbcIntervalVectorAccessor(IntervalYearVector vector,
                                         IntSupplier currentRowSupplier,
                                         ArrowJdbcAccessorFactory.WasNullConsumer setCursorWasNull) {
    super(currentRowSupplier, setCursorWasNull);
    this.vector = vector;
