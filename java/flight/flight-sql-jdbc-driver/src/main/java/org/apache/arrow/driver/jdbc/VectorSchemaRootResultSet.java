 ...
 */
public class VectorSchemaRootResultSet extends AvaticaResultSet {

  private static final Logger LOGGER =
      LoggerFactory.getLogger(VectorSchemaRootResultSet.class);
  VectorSchemaRoot vectorSchemaRoot;

  VectorSchemaRootResultSet(final AvaticaStatement statement, final QueryState state,
   ...
   */
  public static VectorSchemaRootResultSet fromVectorSchemaRoot(
    ...
    final Meta.Signature signature = FlightSqlMetaImpl.newSignature(null);

    final AvaticaResultSetMetaData resultSetMetaData =
        new AvaticaResultSetMetaData(null, null, signature);
    final VectorSchemaRootResultSet
        resultSet =
        new VectorSchemaRootResultSet(null, state, signature, resultSetMetaData,
            timeZone, null);
  ...
  void execute(final VectorSchemaRoot vectorSchemaRoot) {
    ...
    execute2(new FlightSqlJdbcCursor(vectorSchemaRoot), this.signature.columns);
  }
