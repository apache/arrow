 ...
 */
public class ArrowJdbcVarCharVectorAccessor extends ArrowJdbcAccessor {
  ...
  public ArrowJdbcVarCharVectorAccessor(VarCharVector vector,
                                        IntSupplier currentRowSupplier,
                                        ArrowJdbcAccessorFactory.WasNullConsumer setCursorWasNull) {
    this(vector::get, currentRowSupplier, setCursorWasNull);
  }

  public ArrowJdbcVarCharVectorAccessor(LargeVarCharVector vector,
                                        IntSupplier currentRowSupplier,
                                        ArrowJdbcAccessorFactory.WasNullConsumer setCursorWasNull) {
    this(vector::get, currentRowSupplier, setCursorWasNull);
  }

  ArrowJdbcVarCharVectorAccessor(Getter getter,
                                 IntSupplier currentRowSupplier,
                                 ArrowJdbcAccessorFactory.WasNullConsumer setCursorWasNull) {
