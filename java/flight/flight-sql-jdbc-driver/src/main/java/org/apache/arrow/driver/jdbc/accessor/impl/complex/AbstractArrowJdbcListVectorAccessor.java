...
import org.apache.arrow.driver.jdbc.FieldVectorJdbcArray;
 ...
 */
public abstract class AbstractArrowJdbcListVectorAccessor extends ArrowJdbcAccessor {

  protected AbstractArrowJdbcListVectorAccessor(IntSupplier currentRowSupplier,
  ...
  public final Array getArray() {
    ...
    return new FieldVectorJdbcArray(dataVector, startOffset, valuesCount);
  }
}
