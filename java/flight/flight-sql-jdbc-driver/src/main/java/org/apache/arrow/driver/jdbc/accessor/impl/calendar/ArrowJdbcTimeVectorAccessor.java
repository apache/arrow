...
import org.apache.arrow.driver.jdbc.FlightSqlJdbcTime;
 ...
 */
public class ArrowJdbcTimeVectorAccessor extends ArrowJdbcAccessor {
   ...
   */
  public ArrowJdbcTimeVectorAccessor(TimeNanoVector vector, IntSupplier currentRowSupplier,
   ...
   * @param setCursorWasNull   the consumer to set if value was null.
   */
  public ArrowJdbcTimeVectorAccessor(TimeMicroVector vector, IntSupplier currentRowSupplier,
                                     ArrowJdbcAccessorFactory.WasNullConsumer setCursorWasNull) {
    super(currentRowSupplier, setCursorWasNull);
    this.holder = new Holder();
    this.getter = createGetter(vector);
   ...
   * @param currentRowSupplier the supplier to track the lines.
   */
  public ArrowJdbcTimeVectorAccessor(TimeMilliVector vector, IntSupplier currentRowSupplier,
                                     ArrowJdbcAccessorFactory.WasNullConsumer setCursorWasNull) {
    super(currentRowSupplier, setCursorWasNull);
    this.holder = new Holder();
    this.getter = createGetter(vector);
   ...
   * @param currentRowSupplier the supplier to track the lines.
   */
  public ArrowJdbcTimeVectorAccessor(TimeSecVector vector, IntSupplier currentRowSupplier,
                                     ArrowJdbcAccessorFactory.WasNullConsumer setCursorWasNull) {
    super(currentRowSupplier, setCursorWasNull);
    this.holder = new Holder();
    this.getter = createGetter(vector);
  ...
  public Time getTime(Calendar calendar) {
    ...
    return new FlightSqlJdbcTime(DateTimeUtils.applyCalendarOffset(milliseconds, calendar));
  }
