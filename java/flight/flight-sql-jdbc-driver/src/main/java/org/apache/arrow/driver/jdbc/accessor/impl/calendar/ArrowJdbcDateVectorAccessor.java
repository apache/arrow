 ...
 */
public class ArrowJdbcDateVectorAccessor extends ArrowJdbcAccessor {
   ...
   */
  public ArrowJdbcDateVectorAccessor(DateDayVector vector, IntSupplier currentRowSupplier,
   ...
   * @param currentRowSupplier the supplier to track the lines.
   */
  public ArrowJdbcDateVectorAccessor(DateMilliVector vector, IntSupplier currentRowSupplier,
                                     ArrowJdbcAccessorFactory.WasNullConsumer setCursorWasNull) {
    super(currentRowSupplier, setCursorWasNull);
    this.holder = new Holder();
    this.getter = createGetter(vector);
