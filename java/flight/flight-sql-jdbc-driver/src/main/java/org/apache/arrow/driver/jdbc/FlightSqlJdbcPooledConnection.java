...
/**
 * {@link PooledConnection} implementation for Arrow Flight SQL JDBC Driver.
 */
public class FlightSqlJdbcPooledConnection implements PooledConnection {
  ...
  FlightSqlJdbcPooledConnection(FlightSqlConnection connection) {
