 ...
 */
public class ArrowJdbcDenseUnionVectorAccessor
   ...
   */
  public ArrowJdbcDenseUnionVectorAccessor(DenseUnionVector vector,
  ...
  protected ArrowJdbcAccessor createAccessorForVector(ValueVector vector) {
    return ArrowJdbcAccessorFactory.createAccessor(vector,
