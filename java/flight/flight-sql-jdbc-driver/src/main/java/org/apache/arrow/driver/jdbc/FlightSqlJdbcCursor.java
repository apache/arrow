...
/**
 * Arrow Flight SQL JDBC Cursor class.
 */
public class FlightSqlJdbcCursor extends AbstractCursor {
  private static final Logger LOGGER = LoggerFactory.getLogger(FlightSqlJdbcCursor.class);
  private final VectorSchemaRoot root;
  private final int rowCount;
  private int currentRow = -1;

  public FlightSqlJdbcCursor(VectorSchemaRoot root) {
    this.root = root;
  ...
  private Accessor createAccessor(FieldVector vector) {
    return ArrowJdbcAccessorFactory.createAccessor(vector, this::getCurrentRow,
        (boolean wasNull) -> {
