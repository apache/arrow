...
/**
 * A SQL statement for querying data from a Flight SQL server.
 */
public class FlightSqlStatement extends AvaticaStatement implements FlightInfoStatement {

  FlightSqlStatement(final FlightSqlConnection connection,
