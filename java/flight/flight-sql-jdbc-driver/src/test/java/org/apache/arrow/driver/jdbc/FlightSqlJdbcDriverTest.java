 ...
 */
public class FlightSqlJdbcDriverTest {
  ...
  /**
   * Tests whether the {@link FlightSqlJdbcDriver} is registered in the
   * {@link DriverManager}.
   *
  ...
  public void testDriverIsRegisteredInDriverManager() throws Exception {
    assertTrue(DriverManager.getDriver("jdbc:arrow-flight://localhost:32010") instanceof FlightSqlJdbcDriver);
    assertTrue(DriverManager.getDriver("jdbc:arrow-flight-sql://localhost:32010") instanceof FlightSqlJdbcDriver);
  }

  /**
   * Tests whether the {@link FlightSqlJdbcDriver} fails when provided with an
  ...
  public void testShouldDeclineUrlWithUnsupportedPrefix() throws Exception {
    ...
    assertThrows(SQLException.class, () -> driver.connect("jdbc:mysql://localhost:32010",
            dataSource.getProperties("flight", "flight123"))
        .close());
  }

  /**
   * Tests whether the {@link FlightSqlJdbcDriver} can establish a successful
  ...
  public void testShouldConnectWhenProvidedWithValidUrl() throws Exception {
    // Get the Arrow Flight SQL JDBC driver by providing a URL with a valid prefix.
    final Driver driver = new FlightSqlJdbcDriver();
  ...
  public void testShouldThrowExceptionWhenAttemptingToConnectToUrlNoPort() {
    final Driver driver = new FlightSqlJdbcDriver();
    final String malformedUri = "jdbc:arrow-flight-sql://localhost";
  ...
  public void testShouldThrowExceptionWhenAttemptingToConnectToUrlNoHost() {
    final Driver driver = new FlightSqlJdbcDriver();
    final String malformedUri = "jdbc:arrow-flight-sql://32010:localhost";
    SQLException e = assertThrows(SQLException.class, () -> {
      Properties properties = dataSource.getProperties(dataSource.getConfig().getUser(),
          dataSource.getConfig().getPassword());
      Connection conn = driver.connect(malformedUri, properties);
  ...
  /**
   * Tests whether {@link FlightSqlJdbcDriver#getUrlsArgs} returns the
  ...
  public void testDriverUrlParsingMechanismShouldReturnTheDesiredArgsFromUrl() throws Exception {
    final FlightSqlJdbcDriver driver = new FlightSqlJdbcDriver();
