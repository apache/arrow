...
public class FlightSqlJdbcTimeTest {
  ...
  public void testPrintingMillisNoLeadingZeroes() {
    ...
    FlightSqlJdbcTime time = new FlightSqlJdbcTime(dateTime);
  ...
  public void testEquality() {
    ...
    LocalTime dateTime = LocalTime.of(hour, minute, second, (int) TimeUnit.MILLISECONDS.toNanos(1));
    FlightSqlJdbcTime time1 = new FlightSqlJdbcTime(dateTime);
    FlightSqlJdbcTime time2 = new FlightSqlJdbcTime(dateTime);
