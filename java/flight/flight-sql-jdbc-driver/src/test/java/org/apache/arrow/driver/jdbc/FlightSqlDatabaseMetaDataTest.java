...
/**
 * Class containing the tests from the {@link FlightSqlDatabaseMetaData}.
 */
@SuppressWarnings("DoubleBraceInitialization")
public class FlightSqlDatabaseMetaDataTest {
  ...
  public void testGetColumnSize() {
    Assert.assertEquals(Integer.valueOf(FlightSqlDatabaseMetaData.COLUMN_SIZE_BYTE),
        FlightSqlDatabaseMetaData.getColumnSize(new ArrowType.Int(Byte.SIZE, true)));
    Assert.assertEquals(Integer.valueOf(FlightSqlDatabaseMetaData.COLUMN_SIZE_SHORT),
        FlightSqlDatabaseMetaData.getColumnSize(new ArrowType.Int(Short.SIZE, true)));
    Assert.assertEquals(Integer.valueOf(FlightSqlDatabaseMetaData.COLUMN_SIZE_INT),
        FlightSqlDatabaseMetaData.getColumnSize(new ArrowType.Int(Integer.SIZE, true)));
    Assert.assertEquals(Integer.valueOf(FlightSqlDatabaseMetaData.COLUMN_SIZE_LONG),
        FlightSqlDatabaseMetaData.getColumnSize(new ArrowType.Int(Long.SIZE, true)));

    Assert.assertEquals(Integer.valueOf(FlightSqlDatabaseMetaData.COLUMN_SIZE_VARCHAR_AND_BINARY),
        FlightSqlDatabaseMetaData.getColumnSize(new ArrowType.Utf8()));
    Assert.assertEquals(Integer.valueOf(FlightSqlDatabaseMetaData.COLUMN_SIZE_VARCHAR_AND_BINARY),
        FlightSqlDatabaseMetaData.getColumnSize(new ArrowType.Binary()));

    Assert.assertEquals(Integer.valueOf(FlightSqlDatabaseMetaData.COLUMN_SIZE_TIMESTAMP_SECONDS),
        FlightSqlDatabaseMetaData.getColumnSize(new ArrowType.Timestamp(TimeUnit.SECOND, null)));
    Assert.assertEquals(Integer.valueOf(FlightSqlDatabaseMetaData.COLUMN_SIZE_TIMESTAMP_MILLISECONDS),
        FlightSqlDatabaseMetaData.getColumnSize(new ArrowType.Timestamp(TimeUnit.MILLISECOND, null)));
    Assert.assertEquals(Integer.valueOf(FlightSqlDatabaseMetaData.COLUMN_SIZE_TIMESTAMP_MICROSECONDS),
        FlightSqlDatabaseMetaData.getColumnSize(new ArrowType.Timestamp(TimeUnit.MICROSECOND, null)));
    Assert.assertEquals(Integer.valueOf(FlightSqlDatabaseMetaData.COLUMN_SIZE_TIMESTAMP_NANOSECONDS),
        FlightSqlDatabaseMetaData.getColumnSize(new ArrowType.Timestamp(TimeUnit.NANOSECOND, null)));

    Assert.assertEquals(Integer.valueOf(FlightSqlDatabaseMetaData.COLUMN_SIZE_TIME),
        FlightSqlDatabaseMetaData.getColumnSize(new ArrowType.Time(TimeUnit.SECOND, Integer.SIZE)));
    Assert.assertEquals(Integer.valueOf(FlightSqlDatabaseMetaData.COLUMN_SIZE_TIME_MILLISECONDS),
        FlightSqlDatabaseMetaData.getColumnSize(
            new ArrowType.Time(TimeUnit.MILLISECOND, Integer.SIZE)));
    Assert.assertEquals(Integer.valueOf(FlightSqlDatabaseMetaData.COLUMN_SIZE_TIME_MICROSECONDS),
        FlightSqlDatabaseMetaData.getColumnSize(
            new ArrowType.Time(TimeUnit.MICROSECOND, Integer.SIZE)));
    Assert.assertEquals(Integer.valueOf(FlightSqlDatabaseMetaData.COLUMN_SIZE_TIME_NANOSECONDS),
        FlightSqlDatabaseMetaData.getColumnSize(new ArrowType.Time(TimeUnit.NANOSECOND, Integer.SIZE)));

    Assert.assertEquals(Integer.valueOf(FlightSqlDatabaseMetaData.COLUMN_SIZE_DATE),
        FlightSqlDatabaseMetaData.getColumnSize(new ArrowType.Date(DateUnit.DAY)));

    Assert.assertNull(FlightSqlDatabaseMetaData.getColumnSize(new ArrowType.FloatingPoint(
        FloatingPointPrecision.DOUBLE)));
  }

  @Test
  public void testGetDecimalDigits() {
    Assert.assertEquals(Integer.valueOf(FlightSqlDatabaseMetaData.NO_DECIMAL_DIGITS),
        FlightSqlDatabaseMetaData.getDecimalDigits(new ArrowType.Int(Byte.SIZE, true)));

    Assert.assertEquals(Integer.valueOf(FlightSqlDatabaseMetaData.NO_DECIMAL_DIGITS),
        FlightSqlDatabaseMetaData.getDecimalDigits(new ArrowType.Timestamp(TimeUnit.SECOND, null)));
    Assert.assertEquals(Integer.valueOf(FlightSqlDatabaseMetaData.DECIMAL_DIGITS_TIME_MILLISECONDS),
        FlightSqlDatabaseMetaData.getDecimalDigits(
            new ArrowType.Timestamp(TimeUnit.MILLISECOND, null)));
    Assert.assertEquals(Integer.valueOf(FlightSqlDatabaseMetaData.DECIMAL_DIGITS_TIME_MICROSECONDS),
        FlightSqlDatabaseMetaData.getDecimalDigits(
            new ArrowType.Timestamp(TimeUnit.MICROSECOND, null)));
    Assert.assertEquals(Integer.valueOf(FlightSqlDatabaseMetaData.DECIMAL_DIGITS_TIME_NANOSECONDS),
        FlightSqlDatabaseMetaData.getDecimalDigits(new ArrowType.Timestamp(TimeUnit.NANOSECOND, null)));

    Assert.assertEquals(Integer.valueOf(FlightSqlDatabaseMetaData.NO_DECIMAL_DIGITS),
        FlightSqlDatabaseMetaData.getDecimalDigits(new ArrowType.Time(TimeUnit.SECOND, Integer.SIZE)));
    Assert.assertEquals(Integer.valueOf(FlightSqlDatabaseMetaData.DECIMAL_DIGITS_TIME_MILLISECONDS),
        FlightSqlDatabaseMetaData.getDecimalDigits(
            new ArrowType.Time(TimeUnit.MILLISECOND, Integer.SIZE)));
    Assert.assertEquals(Integer.valueOf(FlightSqlDatabaseMetaData.DECIMAL_DIGITS_TIME_MICROSECONDS),
    ...
    Assert.assertEquals(Integer.valueOf(FlightSqlDatabaseMetaData.NO_DECIMAL_DIGITS),
        FlightSqlDatabaseMetaData.getDecimalDigits(new ArrowType.Date(DateUnit.DAY)));

    Assert.assertNull(FlightSqlDatabaseMetaData.getDecimalDigits(new ArrowType.Utf8()));
  }

  @Test
  public void testSqlToRegexLike() {
    Assert.assertEquals(".*", FlightSqlDatabaseMetaData.sqlToRegexLike("%"));
    Assert.assertEquals(".", FlightSqlDatabaseMetaData.sqlToRegexLike("_"));
    Assert.assertEquals("\\*", FlightSqlDatabaseMetaData.sqlToRegexLike("*"));
    Assert.assertEquals("T\\*E.S.*T", FlightSqlDatabaseMetaData.sqlToRegexLike("T*E_S%T"));
  }
}
