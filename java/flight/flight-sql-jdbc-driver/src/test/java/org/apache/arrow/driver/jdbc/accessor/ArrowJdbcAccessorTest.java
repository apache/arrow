...
public class ArrowJdbcAccessorTest {

  static class MockedArrowJdbcAccessor extends ArrowJdbcAccessor {

    protected MockedArrowJdbcAccessor() {
  ...
  @Mock
  MockedArrowJdbcAccessor accessor;
