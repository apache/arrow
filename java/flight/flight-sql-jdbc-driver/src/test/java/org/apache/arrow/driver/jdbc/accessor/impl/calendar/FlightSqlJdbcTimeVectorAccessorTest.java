...
import static org.apache.arrow.driver.jdbc.accessor.impl.calendar.ArrowJdbcTimeVectorAccessor.getTimeUnitForVector;
...
public class FlightSqlJdbcTimeVectorAccessorTest {
  ...
  private final AccessorTestUtils.AccessorSupplier<ArrowJdbcTimeVectorAccessor>
  ...
  private final AccessorTestUtils.AccessorIterator<ArrowJdbcTimeVectorAccessor>
      accessorIterator =
  ...
  public FlightSqlJdbcTimeVectorAccessorTest(Supplier<BaseFixedWidthVector> vectorSupplier,
                                             String vectorType) {
  ...
  public void testShouldGetTimestampReturnNull() {
    vector.setNull(0);
    ArrowJdbcTimeVectorAccessor accessor = accessorSupplier.supply(vector, () -> 0);
  ...
  public void testShouldGetObjectClass() throws Exception {
    accessorIterator.assertAccessorGetter(vector, ArrowJdbcTimeVectorAccessor::getObjectClass,
        equalTo(Time.class));
  }
