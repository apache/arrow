...
/**
 * Tests for {@link FlightSqlJdbcDriver}.
 */
public class FlightSqlJdbcFactoryTest {
  ...
  private FlightSqlJdbcConnectionPoolDataSource dataSource;
  ...
  public void testShouldBeAbleToEstablishAConnectionSuccessfully() throws Exception {
    UnregisteredDriver driver = new FlightSqlJdbcDriver();
    Constructor<FlightSqlJdbcFactory> constructor = FlightSqlJdbcFactory.class.getConstructor();
    constructor.setAccessible(true);
    FlightSqlJdbcFactory factory = constructor.newInstance();
