...
import static org.apache.arrow.driver.jdbc.accessor.impl.calendar.ArrowJdbcTimeStampVectorAccessor.getTimeUnitForVector;
import static org.apache.arrow.driver.jdbc.accessor.impl.calendar.ArrowJdbcTimeStampVectorAccessor.getTimeZoneForVector;
...
public class FlightSqlJdbcTimeStampVectorAccessorTest {
  ...
  private final AccessorTestUtils.AccessorSupplier<ArrowJdbcTimeStampVectorAccessor>
      accessorSupplier =
          (vector, getCurrentRow) -> new ArrowJdbcTimeStampVectorAccessor(
              (TimeStampVector) vector, getCurrentRow, (boolean wasNull) -> {
          });

  private final AccessorTestUtils.AccessorIterator<ArrowJdbcTimeStampVectorAccessor>
      accessorIterator =
  ...
  public FlightSqlJdbcTimeStampVectorAccessorTest(Supplier<TimeStampVector> vectorSupplier,
                                                  String vectorType,
                                                  String timeZone) {
  ...
  public void testShouldGetTimestampReturnNull() {
    vector.setNull(0);
    ArrowJdbcTimeStampVectorAccessor accessor = accessorSupplier.supply(vector, () -> 0);
  ...
  public void testShouldGetObjectClass() throws Exception {
    accessorIterator.assertAccessorGetter(vector,
        ArrowJdbcTimeStampVectorAccessor::getObjectClass,
