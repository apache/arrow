...
public class TestAuth {
  ...
  public void invalidAuth() {
    ...
    assertThrows(StatusRuntimeException.class, ()->client.authenticateBasic(USERNAME, "WRONG"), PERMISSION_DENIED);

    assertThrows(StatusRuntimeException.class, ()->client.listFlights(Criteria.ALL), PERMISSION_DENIED);
  }
