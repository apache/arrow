...
public class TestFlightSql {
  ...
  private static final List<List<String>> EXPECTED_RESULTS_FOR_PARAMETER_BINDING =
  ...
  public static void setUp() throws Exception {
    ...
    server =
        FlightServer.builder(allocator, serverLocation, new FlightSqlExample(serverLocation))
            .build()
            .start();
