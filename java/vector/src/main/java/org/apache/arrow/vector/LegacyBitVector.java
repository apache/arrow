 ...
 * or '1'.
 */
public final class LegacyBitVector extends BaseDataValueVector implements FixedWidthVector {
  static final org.slf4j.Logger logger = org.slf4j.LoggerFactory.getLogger(LegacyBitVector.class);
  ...
  public LegacyBitVector(String name, BufferAllocator allocator) {
  ...
  public void copyFrom(int inIndex, int outIndex, LegacyBitVector from) {
    this.mutator.set(outIndex, from.accessor.get(inIndex));
  }

  public void copyFromSafe(int inIndex, int outIndex, LegacyBitVector from) {
  ...
  public TransferPair makeTransferPair(ValueVector to) {
    return new TransferImpl((LegacyBitVector) to);
  }


  public void transferTo(LegacyBitVector target) {
    target.clear();
  ...
  public void splitAndTransferTo(int startIndex, int length, LegacyBitVector target) {
    ...
    if (length > 0) {
      if (offset == 0) {
        ...
        // Copy data
        // When the first bit starts from the middle of a byte (offset != 0), copy data from src LegacyBitVector.
  ...
  private class TransferImpl implements TransferPair {
    ...
    public TransferImpl(String name, BufferAllocator allocator) {
      this.to = new LegacyBitVector(name, allocator);
    }

    public TransferImpl(LegacyBitVector to) {
      this.to = to;
    }

    @Override
    public LegacyBitVector getTo() {
      return to;
    }
    ...
    public void copyValueSafe(int fromIndex, int toIndex) {
      to.copyFromSafe(fromIndex, toIndex, LegacyBitVector.this);
    }
  }
  ...
  public class Mutator extends BaseMutator {
    ...
    public final void setValueCount(int valueCount) {
      ...
      LegacyBitVector.this.valueCount = valueCount;
