...
public final class TimeStampNanoVector extends TimeStampVector {
  ...
  *----------------------------------------------------------------*/
  ...
  /**
   * Same as {@link #set(int, NullableTimeStampNanoHolder)} except that it handles the case when
  ...
  /**
   * Same as {@link #set(int, TimeStampNanoHolder)} except that it handles the case when index is
  ...
  *----------------------------------------------------------------*/
  ...
  public TransferPair getTransferPair(String ref, BufferAllocator allocator) {
    TimeStampNanoVector to = new TimeStampNanoVector(ref, field.getFieldType(), allocator);
