...
public class VectorLoader {
  ...
  public void load(ArrowRecordBatch recordBatch) {
    ...
    CompressionCodec codec = recordBatch.getBodyCompression() == null ? NoCompressionCodec.INSTANCE
        : CompressionUtil.createCodec(recordBatch.getBodyCompression().getCodec());
