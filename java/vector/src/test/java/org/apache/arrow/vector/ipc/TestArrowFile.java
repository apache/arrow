...
public class TestArrowFile extends BaseFileTest {
  ...
  public void testWrite() throws IOException {
    ...
    try (
        ...
        NullableStructVector parent = NullableStructVector.empty("parent", vectorAllocator)) {
  ...
  public void testWriteRead() throws IOException {
    ...
    try (BufferAllocator originalVectorAllocator = allocator.newChildAllocator("original vectors", 0, Integer.MAX_VALUE);
         NullableStructVector parent = NullableStructVector.empty("parent", originalVectorAllocator)) {
      writeData(count, parent);
  ...
  public void testWriteReadMetadata() throws IOException {
    ...
    // write
    try (BufferAllocator originalVectorAllocator = allocator.newChildAllocator("original vectors", 0, Integer.MAX_VALUE);
         NullableStructVector vector = (NullableStructVector) field.createVector(originalVectorAllocator)) {
