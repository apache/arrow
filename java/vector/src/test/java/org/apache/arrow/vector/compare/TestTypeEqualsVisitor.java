...
public class TestTypeEqualsVisitor {
  ...
  public void testUnionTypeEquals() {
    try (final UnionVector right = new UnionVector("union", allocator, null, null);
         final UnionVector left1 = new UnionVector("union", allocator, null, null);
         final UnionVector left2 = new UnionVector("union", allocator, null, null)) {
