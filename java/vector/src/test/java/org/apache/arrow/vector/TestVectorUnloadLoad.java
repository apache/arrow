...
public class TestVectorUnloadLoad {
  ...
  public void testWithoutFieldNodes() throws Exception {
    ...
    NullableIntVector intVector = newVector(NullableIntVector.class, "int", new ArrowType.Int(32, true), original);

    NullableVarCharVector varCharVector = newNullableVarCharVector("varChar", original);
    ListVector listVector = new ListVector("list", original, null, null);
    ListVector innerListVector = (ListVector) listVector.addOrGetVector(new FieldType(true, MinorType.LIST.getType(), null)).getVector();
    ...
    NullableIntVector newIntVector = newVector(NullableIntVector.class, "newInt", new ArrowType.Int(32, true), original);
    NullableVarCharVector newVarCharVector = newNullableVarCharVector("varChar", original);
    ListVector newListVector = new ListVector("newListVector", newAllocator, null, null);
    ((ListVector) newListVector.addOrGetVector(new FieldType(true, MinorType.LIST.getType(), null)).getVector()).addOrGetVector(new FieldType(true, MinorType.INT.getType(), null));
