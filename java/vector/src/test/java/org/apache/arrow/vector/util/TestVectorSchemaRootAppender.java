  ...
  public void testVectorSchemaRootAppend() {
    ...
    try (IntVector targetChild1 = new IntVector("t1", allocator);
      ...
      try (IntVector expected1 = new IntVector("", allocator);
        ...
        ValueVectorDataPopulator.setVector(
            expected3, 0L, 10L, null, 30L, 40L, 50L, 60L, 70L, null, 90L);
  ...
  public void testRootWithDifferentChildCounts() {
    try (IntVector targetChild1 = new IntVector("t1", allocator);
      ...
      IllegalArgumentException exp =
          assertThrows(
              IllegalArgumentException.class, () -> VectorSchemaRootAppender.append(root1, root2));

      assertEquals(
          "Vector schema roots have different numbers of child vectors.", exp.getMessage());
    }
  }
