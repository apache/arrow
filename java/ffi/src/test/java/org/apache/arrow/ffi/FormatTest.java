...
public class FormatTest {
  ...
  public void testAsString() {
    ...
    assertEquals("+us:1,1,1",
            Format.asString(new ArrowType.Union(UnionMode.Sparse, new int[]{1, 1, 1})));
    assertEquals("+ud:1,1,1",
            Format.asString(new ArrowType.Union(UnionMode.Dense, new int[]{1, 1, 1})));
