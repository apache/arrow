...
public final class FFI {
   ...
   */
  public static Field importField(BufferAllocator allocator, ArrowSchema schema, FFIDictionaryProvider provider) {
    try {
   ...
   */
  public static Schema importSchema(BufferAllocator allocator, ArrowSchema schema, FFIDictionaryProvider provider) {
  ...
  public static FieldVector importVector(BufferAllocator allocator, ArrowArray array, ArrowSchema schema,
      FFIDictionaryProvider provider) {
