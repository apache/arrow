...
jint JNI_OnLoad(JavaVM *vm, void *reserved)
{
  ...
  private_data_class = 
      CreateGlobalClassReference(env, "Lorg/apache/arrow/ffi/jni/PrivateData;");
      
  private_data_close_method =
      GetMethodID(env, private_data_class, "close", "()V");
...
/*
 * Class:     org_apache_arrow_ffi_jni_JniWrapper
 * Method:    releaseSchema
 * Signature: (J)V
 */
JNIEXPORT void JNICALL Java_org_apache_arrow_ffi_jni_JniWrapper_releaseSchema(
 ...
 * Signature: (J)V
 */
JNIEXPORT void JNICALL Java_org_apache_arrow_ffi_jni_JniWrapper_releaseArray(
  JNIEnv *env, jobject, jlong address) {
  JNI_METHOD_START
 ...
 * Class:     org_apache_arrow_ffi_jni_JniWrapper
 * Method:    exportSchema
 * Signature: (JLorg/apache/arrow/ffi/jni/PrivateData;)V
 */
JNIEXPORT void JNICALL Java_org_apache_arrow_ffi_jni_JniWrapper_exportSchema(
 ...
 * Signature: (JLorg/apache/arrow/ffi/jni/PrivateData;)V
 */
JNIEXPORT void JNICALL Java_org_apache_arrow_ffi_jni_JniWrapper_exportArray(
    JNIEnv *env, jobject, jlong address, jobject private_data) {
  JNI_METHOD_START
  ArrowArray* array = reinterpret_cast<ArrowArray*>(address);
