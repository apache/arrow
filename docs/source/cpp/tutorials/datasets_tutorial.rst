...
.. seealso:: :doc:`/cpp/acero/overview` for execution that avoids manifesting the entire dataset in memory.
...
.. seealso:: :doc:`/cpp/acero/overview` for more information on Acero.
