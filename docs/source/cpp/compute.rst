...
* \(6) Extract a child value based on a field reference passed in the options (this field reference can be specified as an index or name or a sequence thereof).
  The validity bitmap of the result will be the
