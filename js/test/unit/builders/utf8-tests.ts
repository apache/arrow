...
describe('Utf8Builder', () => {
    runTestsWithEncoder(encodeAll(() => new Utf8(), 5));
    runTestsWithEncoder(encodeAll(() => new Utf8(), 25));
    runTestsWithEncoder(encodeAll(() => new Utf8(), void 0));
    runTestsWithEncoder(encodeEach(() => new Utf8(), 5));
    runTestsWithEncoder(encodeEach(() => new Utf8(), 25));
    runTestsWithEncoder(encodeEach(() => new Utf8(), void 0));
});

function runTestsWithEncoder(encode: (vals: (string | null)[], nullVals?: any[]) => Vector<Utf8>) {
