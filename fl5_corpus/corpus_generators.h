// corpus_generators.h -- EXTRACTED VERBATIM, do not hand-edit.
//
// Lines 87..707 of arrow/cpp/src/parquet/pfor_comparison_benchmark.cc, which is
// where the 43-column int32 corpus is defined. Copied rather than included
// because that file is a google-benchmark TU that pulls in all of Parquet; the
// generators themselves depend on nothing but the standard library.
//
// Regenerate with:
//   sed -n '87,707p' $ARROW/cpp/src/parquet/pfor_comparison_benchmark.cc
#pragma once
#include <algorithm>
#include <cmath>
#include <cstdint>
